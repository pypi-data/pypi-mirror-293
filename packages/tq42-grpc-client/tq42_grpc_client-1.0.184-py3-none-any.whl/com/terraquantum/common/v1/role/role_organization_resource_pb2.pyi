...
class RoleOrganizationResourceTypeProto(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    ORGANIZATION_RUN: _ClassVar[RoleOrganizationResourceTypeProto]
    ORGANIZATION_RUN_SIM: _ClassVar[RoleOrganizationResourceTypeProto]
    ORGANIZATION_RUN_QPU: _ClassVar[RoleOrganizationResourceTypeProto]
...
ORGANIZATION_RUN: RoleOrganizationResourceTypeProto
ORGANIZATION_RUN_SIM: RoleOrganizationResourceTypeProto
ORGANIZATION_RUN_QPU: RoleOrganizationResourceTypeProto
