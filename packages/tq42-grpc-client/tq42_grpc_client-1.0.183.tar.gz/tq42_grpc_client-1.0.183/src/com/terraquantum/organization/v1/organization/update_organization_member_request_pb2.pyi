...
class UpdateOrganizationMemberRequest(_message.Message):
    __slots__ = ("request_id", "organization_member_id", "first_name", "last_name", "permission")
    ...
    def __init__(self, request_id: _Optional[str] = ..., organization_member_id: _Optional[str] = ..., first_name: _Optional[str] = ..., last_name: _Optional[str] = ..., permission: _Optional[_Union[_organization_member_permission_request_pb2.OrganizationMemberPermissionRequest, _Mapping]] = ...) -> None: ...
