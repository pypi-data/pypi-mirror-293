...
class Fcntl:
    ...
    def flock(self, operation):
        ...
        overlapped = OVERLAPPED()  # Initialize OVERLAPPED structure

        if operation & LOCK_UN:
            UnlockFileEx(self.handle, 0, 0xFFFFFFFF, 0xFFFFFFFF, ctypes.byref(overlapped))
        else:
            flags = 0
            ...
            LockFileEx(self.handle, flags, 0, 0xFFFFFFFF, 0xFFFFFFFF, ctypes.byref(overlapped))
