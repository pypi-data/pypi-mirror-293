...
class MatrixExpression(SingleChildExpressionTreeMixin):
    ...
    def copy(self, child: ExpressionTree) -> MatrixExpression: ...
...
class SymmetricMatrixExpression(MatrixExpression):
    ...
    def copy(self, child: ExpressionTree) -> SymmetricMatrixExpression: ...
...
class VectorExpression(MatrixExpression):
    ...
    def copy(self, child: ExpressionTree) -> VectorExpression: ...
...
class RowVectorExpression(MatrixExpression):
    ...
    def copy(self, child: ExpressionTree) -> RowVectorExpression: ...
...
class PolynomialExpression(VectorExpression):
    ...
    def copy(self, child: ExpressionTree) -> PolynomialExpression: ...
    def diff(self, variables: VariableVectorExpression) -> RowVectorExpression: ...
    def eval(
        self, substitutions: dict[Symbol, tuple[float, ...]]
...
class MonomialVectorExpression(VectorExpression):
    ...
    def copy(self, child: ExpressionTree) -> MonomialVectorExpression: ...
    def filter(
...
class MonomialExpression(PolynomialExpression, MonomialVectorExpression):
    ...
    def copy(self, child: ExpressionTree) -> MonomialExpression: ...
...
class VariableVectorExpression(MonomialVectorExpression):
    ...
    def copy(self, child: ExpressionTree) -> VariableVectorExpression: ...
    def filter(
        self, predicator: FilterMixin.PREDICATOR_TYPE
