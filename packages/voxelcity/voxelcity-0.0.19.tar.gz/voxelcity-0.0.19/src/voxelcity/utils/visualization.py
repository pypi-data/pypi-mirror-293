...
def visualize_building_height_grid_on_map(building_height_grid, geojson_data, rectangle_vertices, meshsize):
    ...
    # Plot the results
    plot_grid(building_height_grid, origin, adjusted_meshsize, u_vec, v_vec, transformer, CRS.from_epsg(3857),
...
def visualize_canopy_height_grid_on_map(canopy_height_grid, rectangle_vertices, meshsize):
    ...
    # Plot the results
    plot_grid(canopy_height_grid, origin, adjusted_meshsize, u_vec, v_vec, transformer, CRS.from_epsg(3857),
