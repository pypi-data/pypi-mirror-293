...
def get_grid_land_cover(rectangle_vertices, meshsize, source = 'Urbanwatch', output_dir="output", visualization=True):
...
def get_grid_building_height(rectangle_vertices, meshsize, source = 'Microsoft Building Footprints', output_dir="output", visualization=True):
...
def get_grid_canopy_height(rectangle_vertices, meshsize, output_dir="output", visualization=True):
...
def get_grid_dem(rectangle_vertices, meshsize, output_dir="output", visualization=True):
