...
class ArtifactClient:
    ...
    def query_graph(self, graph_name: str, query: str) -> str:
        """Query the graph."""
        try:
            q_result = _safe_request(self.api_instance.query_graph, graph_name, QueryRequest(query=query))
    ...
    def graph_stats(self, graph_name: str):
