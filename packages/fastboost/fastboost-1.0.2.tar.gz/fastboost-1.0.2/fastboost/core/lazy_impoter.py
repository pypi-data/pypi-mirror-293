...
from fastboost.utils.decorators import cached_method_result, singleton, SingletonBaseNew, SingletonBaseCustomInit, singleton_no_lock
...
class FunboostLazyImpoter(SingletonBaseNew):
    ...
    def BoostersManager(self):
        from fastboost.core import booster
