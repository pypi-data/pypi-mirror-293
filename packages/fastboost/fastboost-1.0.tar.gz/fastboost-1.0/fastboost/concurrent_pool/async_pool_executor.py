...
from fastboost.concurrent_pool.base_pool_type import FunboostBaseConcurrentPool
...
if __name__ == '__main__':
    def test_async_pool_executor():
        from fastboost.concurrent_pool import CustomThreadPoolExecutor as ThreadPoolExecutor
