...
from fastboost.concurrent_pool import FlexibleThreadPool
from fastboost.concurrent_pool.async_helper import simple_run_in_executor
from fastboost.constant import FunctionKind
from fastboost.utils.class_utils import ClsHelper

from fastboost.utils.ctrl_c_end import ctrl_c_recv
from fastboost.core.loggers import flogger, develop_logger, logger_prompt

from functools import wraps

from fastboost.core.exceptions import BoostDecoParamsIsOldVersion
from fastboost.core.func_params_model import BoosterParams, FunctionResultStatusPersistanceConfig, PriorityConsumingControlConfig

from fastboost.factories.consumer_factory import get_consumer
from collections import defaultdict


from fastboost.core.msg_result_getter import AsyncResult, AioAsyncResult
...
class Booster:
    ...
    def multi_process_consume(self, process_num=1):
        """超高速多进程消费"""
        from fastboost.core.muliti_process_enhance import run_consumer_with_multi_process
    ...
    def multi_process_pub_params_list(self, params_list, process_num=16):
        ...
        if __name__ == '__main__':
            ...
            f.consume()
        """
        from fastboost.core.muliti_process_enhance import multi_process_pub_params_list
    ...
    def fabric_deploy(self, host, port, user, password,
        ...
        params.pop('self')
        from fastboost.core.fabric_deploy_helper import fabric_deploy
