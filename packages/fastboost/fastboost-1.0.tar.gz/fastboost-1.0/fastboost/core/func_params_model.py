...
from fastboost.concurrent_pool import FunboostBaseConcurrentPool, FlexibleThreadPool, ConcurrentPoolBuilder
from fastboost.constant import ConcurrentModeEnum, BrokerEnum
...
class FunctionResultStatusPersistanceConfig(BaseJsonAbleModel):
    ...
    def check_expire_seconds(cls, value):
        if value > 10 * 24 * 3600:
            from fastboost.core.loggers import flogger  # 这个文件不要提前导入日志,以免互相导入.
