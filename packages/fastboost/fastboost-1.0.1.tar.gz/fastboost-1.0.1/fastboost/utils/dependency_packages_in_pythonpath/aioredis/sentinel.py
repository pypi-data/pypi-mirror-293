...
from aioredis3.client import Redis
from aioredis3.connection import Connection, ConnectionPool, EncodableT, SSLConnection
...
from aioredis3.utils import str_if_bytes
...
class Sentinel:
    ...
    >>> from aioredis3.sentinel import Sentinel
