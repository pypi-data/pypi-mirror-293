...
from aioredis3.compat import Protocol, TypedDict
...
from aioredis3.exceptions import (
    ConnectionError,
    DataError,
    ExecAbortError,
    ModuleError,
...
from aioredis3.lock import Lock
from aioredis3.utils import safe_str, str_if_bytes
...
class PubSub:
    ...
    HEALTH_CHECK_MESSAGE = "aioredis3-py-health-check"
