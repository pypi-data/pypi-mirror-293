...
class ExampleMerchantValidationClass(BaseMerchantValidationClass):
    """
...
class ExamplePaymeMerchantAPIView(BaseMerchantAPIView):
    """
    ...
    """
    validation_class = ExampleMerchantValidationClass
