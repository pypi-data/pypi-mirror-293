...
class Node(APIClientBase):
    ...
    def get_vnc_token(self, virtual_machine_port: int):
        return self.get_request("/hypervisor/vncTokens", query_args={"virtualMachinePort": virtual_machine_port})

    def create_vnc_token(self, virtual_machine_port: int):
        return self.post_request("/hypervisor/vncTokens", query_args={"virtualMachinePort": virtual_machine_port})
