...
class ILogger(typing_extensions.Protocol):
    ...
    def error(self, message: builtins.str) -> None:
        '''
        :param message: -
        '''
        ...
    ...
    def info(self, message: builtins.str) -> None:
        '''
        :param message: -
        '''
        ...
    ...
    def warning(self, message: builtins.str) -> None:
        '''
        :param message: -
        '''
        ...
...
class _ILoggerProxy:
    ...
    def error(self, message: builtins.str) -> None:
        ...
        return typing.cast(None, jsii.invoke(self, "error", [message]))
    ...
    def info(self, message: builtins.str) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument message", value=message, expected_type=type_hints["message"])
        return typing.cast(None, jsii.invoke(self, "info", [message]))
    ...
    def warning(self, message: builtins.str) -> None:
        ...
        if __debug__:
            ...
            check_type(argname="argument message", value=message, expected_type=type_hints["message"])
        return typing.cast(None, jsii.invoke(self, "warning", [message]))
