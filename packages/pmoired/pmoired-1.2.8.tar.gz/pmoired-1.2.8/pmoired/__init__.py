...
class OI:
    ...
    def doFit(self, model=None, fitOnly=None, doNotFit='auto',
        ...
        if correlations:
            ...
            self.correlations = oicorr.corrSpectra(_tmp)
            # -- test
            # print('\033[41mDEBUG: setting all correlations to 0\033[0m')
            # for k in self.correlations['rho']:
            #    self.correlations['rho'][k] = 0.0
            #
            rhomax = 0.99
            print('\033[41mDEBUG: rho limited to %f\033[0m'%rhomax)
            for k in self.correlations['rho']:
               self.correlations['rho'][k] = min(self.correlations['rho'][k], rhomax)
