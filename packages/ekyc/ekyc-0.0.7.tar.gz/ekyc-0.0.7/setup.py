...
install_requires = [
    ...
    "deepface",
    "Flask",
    "paddlepaddle==2.6.1",  # Updated version
    "tensorflow==2.11.0",  # Updated version and removed -cpu suffix
    "protobuf==3.19.6",  # Updated version
]

# Remove the separate paddleocr and paddlepaddle additions for non-Windows platforms
# if not is_windows:
...
setup(
    name="ekyc",
    version="0.0.7",  # Corrected version number
    ...
    python_requires=">=3.9, <3.12",  # Update Python version requirement
