...
install_requires = [
    ...
    "numpy",
    "scikit-learn",
    "deepface",  # Updated to require the latest version 0.0.93
    "Flask",
    "paddlepaddle",  # Remove version constraint
    "tensorflow-intel",  # Remove version constraint
    "protobuf",  # Add this without version constraint
]
...
setup(
    name="ekyc",
    version="0.0.6",  # Update this line
