...
def create_data_list(datestart1, dateend1, family, pathin,namein, pathwork, flag_criteria, region):
    data_list = []
          ...
          if n_cpu==1:
           ...
           with dask.distributed.Client(processes=True, threads_per_worker=1, 
               ...
               delayed_funcs = [dask.delayed(create_timeserie_table)(data_['family'], 
                                                 ...
                                                 data_['filein'],
                                                 data_['region'],
                                                 data_['flag_criteria'])for data_ in data_list]
