...
def timeserie_plot(pathwork,
   ...
   for fonction in fonctions:
    for varno in varnos:
       ...
       nfichiers= 1
       vcoord  = vcoord
       famille = f'Family:{family} id_stn:{id_stn} vcoord:int({vcoord})'
       REGION1 = region
       varno   = varno 
    ...
    #   fonction= 'omp'
     ...
     #   ax3.text(.13, 0.24, REGION1        ,fontsize =12,color=couleurs[0],transform=ax3.transAxes)
        ax3.text(.28, 0.24,  vcoord_type_e ,fontsize =12,color=couleurs[0],transform=ax3.transAxes)
      ...
      #  ax3.text(.13, 0.015 +.30*filenumb   ,REGION1     ,fontsize =12,color=couleurs[filenumb-1],transform=ax3.transAxes)
        ax3.text(.28, 0.016 +.30*filenumb    ,vcoord_type_e       ,fontsize =12,color=couleurs[filenumb-1],transform=ax3.transAxes)
      ...
      #  ax3.text(.58, 0.016 +.30*filenumb, vcoord         ,fontsize =12,color=couleurs[filenumb-1],transform=ax3.transAxes)
       ...
       pyplot.savefig(f'{pathwork}/timeserie/timeserie_{fonction}_id_stn{id_stn}_vcoord{int(vcoord)}.png',format='png',dpi=100,bbox_inches='tight')
