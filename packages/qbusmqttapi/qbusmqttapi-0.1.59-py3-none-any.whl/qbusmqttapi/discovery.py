...
class QbusMqttControllerState:
    ...
    async def parse_state(self, payload: str | bytes) -> bool:
        ...
        activate_message = {}
        activate_message['id'] = self._id
        activate_message['type'] = "action"
        activate_message['properties'] = {}
        activate_message['properties']['authKey'] = "ubielite"
        
        activate_topic = 'cloudapp/QBUSMQTTGW/{self._id}/setState'
        
        activate_command = {}
        activate_command['topic'] = activate_topic
        activate_command['payload'] = activate_message
