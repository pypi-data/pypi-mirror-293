...
class QbusSwitch:
    ...
    # async def parse_state_messages(self) -> dict:
    #     state = {}
    #     stateOn = {}
    #     stateOn.id = self.id
    #     stateOn.type = "state"
    ...
    #     state.stateOn = stateOn
    #     state.stateOff = stateOff

    #     return state
    
    @property
    def state_on_message(self) -> dict:
        stateOn = {}
        stateOn.id = self.id
        stateOn.type = "state"
        stateOn.properties = {}
        stateOn.properties.value = True
        self.state_on_message = stateOn
...
class QbusMqttOutput:
    ...
    # async def parseOutput(self) -> dict:
    #     switchState = {}
    #     if self.type == 'onoff':
    #         switch = QbusSwitch(self.id)
    #         switchState = await switch.parse_state_messages()
            
            
            
    #         #set_off_topic = switchState.get("stateOn")
    #        # set_off_topic = switchState.get("stateOff")
            
    #         #stateMessage = json.dumps(switchState)
    #     self. _stateMessage = switchState
    #     return True
    
    @property
    def stateMessage(self) -> dict:
        if self.type == 'onoff':
            switch = QbusSwitch(self.id)
            switchState = switch.state_on_message
        self.state_message = switchState
        #self.parseOutput()
