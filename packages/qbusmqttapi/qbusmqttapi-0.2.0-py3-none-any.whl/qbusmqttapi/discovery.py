...
class QbusMqttOutput:
    ...
    def stateMessage(self) -> QbusSwitch | QbusDimmer | None:
        ...
        state: json = {}
        if self.type == 'onoff':
            state = QbusSwitch(self.id)
        if self.type == 'analog':
            state = QbusDimmer(self.id)
        return state
    
    @property
    def command_topic(self) -> str:
        return "cloudapp/QBUSMQTTGW/" + self._device_id + "/" + self.id + "/setState"
        
    @property
    def state_topic(self) -> str:
        return "cloudapp/QBUSMQTTGW/" + self._device_id + "/" + self.id + "/state"
...
class QbusDiscovery:
    ...
    def config_topic(self):
        ...
        return "cloudapp/QBUSMQTTGW/getConfig"
    ...
    def sub_config_topic(self):
        """Returns config topic"""
        return "cloudapp/QBUSMQTTGW/config/#"
