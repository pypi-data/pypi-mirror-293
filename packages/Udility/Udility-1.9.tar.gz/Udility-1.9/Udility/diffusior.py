    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": f"Generate quick instructions for creating a SVG illustration for the following user's prompt: '{text_description}'. Provide all necessary details to build a well-defined image for this query.",
                },
            ],
        )
