...
class SinglePlatformRepository(SinglePlatformRepositoryV0):
    ...
    def runtime_delete(self, implementation, version):
        """ Delete the sepecified runtim.

        Parameters
        ----------
        implementation : str
            The runtime implementation, e.g. 'cpython'
        version : str
            The full runtime version, e.g. '3.8.17+1'
        """
        path = self._runtime_url(
            self._urls.data.runtimes.delete, implementation, version)
