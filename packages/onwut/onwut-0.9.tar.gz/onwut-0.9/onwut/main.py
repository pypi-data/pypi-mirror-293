...
def fetch_data(search_string=None, start_date=None, end_date=None, source=None, db_path='onwut_data.db'):
...
if __name__ == "__main__":
    ...
    fetch_data(search_string="産業", start_date="2024-01", end_date="2024-12", source="経済産業省")
