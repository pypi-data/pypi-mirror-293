...
# results.summary(rf_df=rf_df, rf="rf", show_t=True, show_stars=True, layout="default", raw_ret=False,
#                alpha_models=[ff3], output_path=None)
...
result.summary(rf_df=rf_df, rf="rf", raw_ret=True, layout='reverse',
               alpha_models=[ff3], output_path="double_strategy_for_strategy_reverse.docx")