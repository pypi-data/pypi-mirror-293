...
def position(axis_id, interface, input_mode, amplitude):
    """Position control demo"""
    from .examples.position_control import main

    try:
        run_main_async(main(axis_id, interface, input_mode, amplitude))
...
@click.option("--interface", default="can0", help="CAN interface")
@click.option("--amplitude", default=40, help="Amplitude")
def velocity(axis_id, interface, amplitude):
...
@click.option("--interface", default="can0", help="CAN interface")
@click.option("--amplitude", default=40, help="Amplitude")
def watchdog(axis_id, interface, amplitude):
