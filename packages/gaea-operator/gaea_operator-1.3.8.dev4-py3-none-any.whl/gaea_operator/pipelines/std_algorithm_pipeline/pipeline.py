...
from gaea_operator.nodes import Package, Inference
    ...
    BaseTrain.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/acg_aiqp_algo/paddlecloud/ubuntu18.04:"
                    "cuda11.2-cudnn8.6-gaea-std-alg-3-std_unify-v4-ppseg-8")
        ],
    BaseEval.name():
        [
            Image(kind=Accelerator.NVIDIA,
    ...
    BaseTransform.name():
        [
            ...
            Image(kind=Accelerator.KUNLUN,
                  name="iregistry.baidu-int.com/windmill-public/transform:20240822_1724337412559-dev-1")
        ],
