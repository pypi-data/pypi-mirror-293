...
NAME_TO_IMAGES = {
    BaseTrain.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/train/paddlepaddle:20240822_1724337412503"),
    ...
    BaseTransformEval.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/inference/nvidia:20240822_1724337412497"),
            Image(kind=Accelerator.KUNLUN,
                  name="iregistry.baidu-int.com/windmill-public/inference/kunlun:20240822_1724337412630"),
            Image(kind=Accelerator.ASCEND,
                  name="iregistry.baidu-int.com/windmill-public/inference/ascend_arm64_model:v1.0.5")
        ],
    Package.name():
