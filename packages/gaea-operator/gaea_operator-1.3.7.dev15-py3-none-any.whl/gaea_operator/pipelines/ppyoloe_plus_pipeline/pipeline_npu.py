...
NAME_TO_IMAGES = {
    BaseTrain.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/train/paddlepaddle:20240828_1724834650661"),
    ...
    BaseTransform.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/transform:20240828_1724834650704"),
            Image(kind=Accelerator.KUNLUN,
                  name="iregistry.baidu-int.com/windmill-public/transform:20240828_1724834650704"),
            Image(kind=Accelerator.ASCEND,
    ...
    BaseTransformEval.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/inference/nvidia:20240828_1724834650512"),
            Image(kind=Accelerator.KUNLUN,
                  name="iregistry.baidu-int.com/windmill-public/inference/kunlun:20240828_1724834650653"),
            Image(kind=Accelerator.ASCEND,
                  name="iregistry.baidu-int.com/windmill-public/inference/ascend_arm64_model:v1.0.5")
        ],
    Package.name():
...
def pipeline(accelerator: str = "T4",
    ...
    if accelerator is None:
        accelerator = Accelerator.Atlas910
...
class Train(BaseTrain):
    ...
    def __init__(self, train_skip: int = -1, accelerator: str=Accelerator.Atlas910):
...
class Eval(BaseEval):
    ...
    def __init__(self,
                 eval_skip: int = -1,
                 accelerator: str = Accelerator.Atlas910,
...
class Transform(BaseTransform):
    ...
    def __init__(self,
                 ...
                 algorithm: str = "",
                 category: str = "",
                 accelerator: str = Accelerator.Atlas310,
                 pre_nodes: Dict[str, ContainerStep] = None):
