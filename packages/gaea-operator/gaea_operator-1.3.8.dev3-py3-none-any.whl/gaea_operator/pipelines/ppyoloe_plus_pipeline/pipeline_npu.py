...
NAME_TO_IMAGES = {
    BaseTrain.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/train/paddlepaddle:20240821_1724233119521"),
    ...
    BaseTransform.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/transform:20240821_1724233119294"),
            Image(kind=Accelerator.KUNLUN,
                  name="iregistry.baidu-int.com/windmill-public/transform:20240821_1724233119294"),
            Image(kind=Accelerator.ASCEND,
    ...
    BaseTransformEval.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/inference/nvidia:20240821_1724233119358"),
            Image(kind=Accelerator.KUNLUN,
                  name="iregistry.baidu-int.com/windmill-public/inference/kunlun:20240821_1724233119321"),
            Image(kind=Accelerator.ASCEND,
                  name="iregistry.baidu-int.com/windmill-public/inference/ascend_arm64_model:v1.0.5")
        ],
    Package.name():
