...
class Base:
    ...
    redis_client = connect_to_redis(db_cli.load_redis_addr())
...
class C108(Corps):
    ...
    def get_recent_date(self) -> str:
        """
        mymongo의 동명함수와 다르게 반환값이 yyyy-mm-dd 형식의 문자열 또는 'None' 문자열임
        datetime은 json으로 저장할수 없어서...
        :return:
        """
