...
def build_amazon_dsp_sdk_create_campaigns_request(  # pylint: disable=name-too-long
    *,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/dsp/v1/campaigns"

    # Construct headers
    _headers["Amazon-Ads-AccountId"] = _SERIALIZER.header("amazon_ads_account_id", amazon_ads_account_id, "str")
    _headers["Amazon-Advertising-API-ClientId"] = _SERIALIZER.header(
        "amazon_advertising_api_client_id", amazon_advertising_api_client_id, "str"
    )
    _headers["Amazon-Advertising-API-Scope"] = _SERIALIZER.header(
        "amazon_advertising_api_scope", amazon_advertising_api_scope, "str"
    )
...
def build_amazon_dsp_sdk_partially_update_camaigns_request(  # pylint: disable=name-too-long
    *,
    amazon_ads_account_id: str,
    amazon_advertising_api_client_id: str,
    amazon_advertising_api_scope: str,
...
def build_amazon_dsp_sdk_list_campaigns_request(  # pylint: disable=name-too-long
    *,
    amazon_ads_account_id: str,
    amazon_advertising_api_client_id: str,
    amazon_advertising_api_scope: str,
...
def build_amazon_dsp_sdk_create_ad_groups_request(  # pylint: disable=name-too-long
    *,
    amazon_ads_account_id: str,
    amazon_advertising_api_client_id: str,
    amazon_advertising_api_scope: str,
...
def build_amazon_dsp_sdk_partially_update_ad_groups_request(  # pylint: disable=name-too-long
    *,
    amazon_ads_account_id: str,
    amazon_advertising_api_client_id: str,
    amazon_advertising_api_scope: str,
...
def build_amazon_dsp_sdk_list_ad_groups_request(  # pylint: disable=name-too-long
    *,
    amazon_ads_account_id: str,
    amazon_advertising_api_client_id: str,
    amazon_advertising_api_scope: str,
...
def build_amazon_dsp_sdk_create_targets_request(  # pylint: disable=name-too-long
    *,
    amazon_ads_account_id: str,
    amazon_advertising_api_client_id: str,
    amazon_advertising_api_scope: str,
...
def build_amazon_dsp_sdk_delete_targets_request(  # pylint: disable=name-too-long
    *,
    amazon_ads_account_id: str,
    amazon_advertising_api_client_id: str,
    amazon_advertising_api_scope: str,
    **kwargs: Any
    ...
    # Construct URL
    _url = "/dsp/v1/targets/deleteByObject"
...
def build_amazon_dsp_sdk_list_targets_request(  # pylint: disable=name-too-long
    *,
    amazon_ads_account_id: str,
    amazon_advertising_api_client_id: str,
    amazon_advertising_api_scope: str,
...
def build_amazon_dsp_sdk_add_conversion_tracking_products_request(  # pylint: disable=name-too-long
    campaign_id: str,
    *,
    amazon_ads_account_id: str,
    amazon_advertising_api_client_id: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/dsp/v1/campaigns/{campaignId}/conversionTracking/products"
    path_format_arguments = {
        "campaignId": _SERIALIZER.url("campaign_id", campaign_id, "str"),
    }
...
def build_amazon_dsp_sdk_get_conversion_tracking_products_request(  # pylint: disable=name-too-long
    campaign_id: str,
    *,
    amazon_ads_account_id: str,
    amazon_advertising_api_client_id: str,
    ...
    **kwargs: Any
    ...
    if max_results is not None:
        _params["maxResults"] = _SERIALIZER.query("max_results", max_results, "int", maximum=10000, minimum=1)
    if next_token is not None:
        _params["nextToken"] = _SERIALIZER.query("next_token", next_token, "str")
...
def build_amazon_dsp_sdk_remove_conversion_tracking_products_request(  # pylint: disable=name-too-long
    campaign_id: str,
    *,
    amazon_ads_account_id: str,
    amazon_advertising_api_client_id: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/dsp/v1/campaigns/{campaignId}/conversionTracking/products/delete"
    path_format_arguments = {
        "campaignId": _SERIALIZER.url("campaign_id", campaign_id, "str"),
    }
...
class AmazonDspSdkOperationsMixin(AmazonDspSdkMixinABC):
    ...
    @overload
    def partially_update_ad_groups(
        self,
        body: JSON,
        *,
        amazon_ads_account_id: str,
    ...
    @overload
    def add_conversion_tracking_products(
        self,
        campaign_id: str,
        body: List[JSON],
        *,
    ...
    @distributed_trace
    def get_conversion_tracking_products(
        self,
        campaign_id: str,
        *,
        amazon_ads_account_id: str,
    ...
    @overload
    def remove_conversion_tracking_products(
        self,
        campaign_id: str,
        body: List[JSON],
        *,
