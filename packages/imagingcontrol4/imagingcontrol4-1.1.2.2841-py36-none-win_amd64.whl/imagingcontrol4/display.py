...
class Display:
    ...
    def set_render_position(
        self, pos: DisplayRenderPosition, left: int = 0, top: int = 0, right: int = 0, bottom: int = 0
    ):
        """
        ...
        Args:
            ...
            top (int, optional): The y coordinate of the top edge of the image inside the display window. Defaults to 0.
                ...
                This value is ignored unless *pos* is set to :py:attr:`.DisplayRenderPosition.CUSTOM`.
            right (int, optional): The x coordinate of the right edge of the image inside the display window.
                Defaults to 0. Can be greater than the size of the display to only show parts of the image.
                This value is ignored unless *pos* is set to :py:attr:`.DisplayRenderPosition.CUSTOM`.
            bottom (int, optional): The y coordinate of the bottom edge of the image inside the display window.
                Defaults to 0. Can be greater than the size of the display to only show parts of the image.
                This value is ignored unless *pos* is set to :py:attr:`.DisplayRenderPosition.CUSTOM`.
        ...
        Raises:
            IC4Exception: An error occurred. Check :attr:`.IC4Exception.code` and :attr:`.IC4Exception.message`
                          for details.
        """
        if not Library.core.ic4_display_set_render_position(self._handle, pos, left, top, right, bottom):
