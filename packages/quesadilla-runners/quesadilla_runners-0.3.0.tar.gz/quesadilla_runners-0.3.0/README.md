...
[![latest release](https://gitlab.com/arcanery/python/quesadilla/quesadilla-runners/-/badges/release.svg)](https://gitlab.com/arcanery/python/quesadilla/quesadilla-runners/-/releases)

# quesadilla-runners

Runner libraries for `quesadilla`, an elegant background task queue for the more civilized age.
