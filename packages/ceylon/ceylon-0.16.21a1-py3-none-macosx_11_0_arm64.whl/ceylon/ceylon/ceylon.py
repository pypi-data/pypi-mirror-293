...
class WorkerAgentConfig:
    ...
    admin_port: "int"
    admin_ip: "str"
    def __init__(self, *, name: "str", work_space_id: "str", admin_peer: "str", role: "str", admin_port: "int", admin_ip: "str"):
        self.name = name
    ...
    def __str__(self):
        return "WorkerAgentConfig(name={}, work_space_id={}, admin_peer={}, role={}, admin_port={}, admin_ip={})".format(self.name, self.work_space_id, self.admin_peer, self.role, self.admin_port, self.admin_ip)
