...
def run_ocr(test_image, det, det_weights, rec, rec_weights):
    init_args = {'det': 'configs/textdet/dbnetpp/dbnetpp_resnet50-dcnv2_fpnc_1200e_icdar2015.py',
                 'det_weights': 'detection_KT_v1.0.0_240726_release.pth',
                 'rec': '/home/najm/mmocr/mmocr_launcher/satrn_shallow_5e_st_mj.py',
                 'rec_weights': 'recognition_KT_v1.0.0_240726_release.pth', 'kie': None, 'kie_weights': None,
                 'device': None}
    call_args = {'inputs': 'demo/dummy-table.jpg', 'out_dir': 'results/', 'batch_size': 1, 'show': False,
                 'print_result': False, 'save_pred': False, 'save_vis': False}
...
if __name__ == '__main__':
    ...
    rec = '/home/najm/mmocr/mmocr_launcher/satrn_shallow_5e_st_mj.py'
    det_weights = 'detection_KT_v1.0.0_240726_release.pth'
    rec_weights = 'recognition_KT_v1.0.0_240726_release.pth'
