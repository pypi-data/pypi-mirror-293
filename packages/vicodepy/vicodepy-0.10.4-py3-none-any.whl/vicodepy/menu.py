...
class Menu:
    ...
    def create_play_menu(self):
        ...
        self.previous_frame_action.triggered.connect(
            partial(self.window.video.move_to_frame, -1)
        )
        ...
        self.fifth_previous_frame_action.triggered.connect(
            partial(self.window.video.move_to_frame, -5)
        )
        ...
        self.tenth_previous_frame_action.triggered.connect(
            partial(self.window.video.move_to_frame, -10)
        )
        ...
        self.fifth_next_frame_action.triggered.connect(
            partial(self.window.video.move_to_frame, 5)
        )
        ...
        self.tenth_next_frame_action.triggered.connect(
            partial(self.window.video.move_to_frame, 10)
        )
    ...
    def create_edit_menu(self):
        ...
        self.add_occurrence_action = QAction(
            "Start Occurrence",
            self.window,
            triggered=self.window.time_pane.handle_occurrence,
            enabled=False,
        )
        self.add_occurrence_action.setShortcuts(
        ...
        self.abort_occurrence_creation_action.setShortcuts([Qt.Key.Key_Escape])
        ...
        delete_occurrence_action.setShortcuts(
