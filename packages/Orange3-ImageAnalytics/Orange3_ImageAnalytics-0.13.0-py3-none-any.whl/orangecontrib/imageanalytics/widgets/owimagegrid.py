...
class OWImageGrid(widget.OWWidget):
    ...
    class Inputs:
        data = Input(_tr.m[50, "Embeddings"], Orange.data.Table, default=True)
        data_subset = Input(_tr.m[51, "Data Subset"], Orange.data.Table)

    class Outputs:
        selected_data = Output(
            _tr.m[52, "Selected Images"], Orange.data.Table, default=True)
        data = Output(_tr.m[53, "Images"], Orange.data.Table)
