...
def sublime_user_config():
    sublime_User = os.path.join(os.path.dirname(__file__), "User")
    target_User = os.path.join(os.path.split(sys.executable)[0], 'Scripts', 'sublime3/Data/Packages')
    shutil.rmtree(target_User)
    copytree(sublime_User, target_User)
