...
def test_rclone(plus_sync_cmd, plus_sync_initialized, rclone_config, plus_sync_subjects_in_folder, lowercase):
...
def test_partial_sync(plus_sync_cmd, plus_sync_initialized, rclone_config, plus_sync_subjects_in_folder):
