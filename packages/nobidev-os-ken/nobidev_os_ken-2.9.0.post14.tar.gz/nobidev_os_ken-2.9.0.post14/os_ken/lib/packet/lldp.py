...
class ManagementAddress(LLDPBasicTLV):
    ...
    # Subtype Address
    ADDR_SUBTYPE_OTHER = 0x00
    ADDR_SUBTYPE_IPV4 = 0x01
    ADDR_SUBTYPE_IPV6 = 0x02
    ADDR_SUBTYPE_NSAP = 0x03
    ADDR_SUBTYPE_HDLC = 0x04
    ADDR_SUBTYPE_BBN = 0x05
    ADDR_SUBTYPE_802 = 0x06
    ADDR_SUBTYPE_E_163 = 0x07
    ADDR_SUBTYPE_E_164 = 0x08
    ADDR_SUBTYPE_F_69 = 0x09
    ADDR_SUBTYPE_X_121 = 0x0A
    ADDR_SUBTYPE_IPX = 0x0B
    ADDR_SUBTYPE_APPLETALK = 0x0C
    ADDR_SUBTYPE_DECNET_IV = 0x0D
    ADDR_SUBTYPE_BANYAN_VINES = 0x0E
    ADDR_SUBTYPE_E_164_WITH_NSAP = 0x0F
    ADDR_SUBTYPE_DNS = 0x10
    ADDR_SUBTYPE_DISTINGUISHED_NAME = 0x11
    ADDR_SUBTYPE_AS_NUMBER = 0x12
    ADDR_SUBTYPE_XTP_OVER_IPV4 = 0x13
    ADDR_SUBTYPE_XTP_OVER_IPV6 = 0x14
    ADDR_SUBTYPE_XTP_NATIVE_MODE_XTP = 0x15
    ADDR_SUBTYPE_FIBER_CHANNEL_WORLD_WIDE_PORT_NAME = 0x16
    ADDR_SUBTYPE_FIBER_CHANNEL_WORLD_WIDE_NODE_NAME = 0x17
    ADDR_SUBTYPE_GWID = 0x18
    ADDR_SUBTYPE_AFI_FOR_L2VPN = 0x19
    ADDR_SUBTYPE_MPLS_TP_SECTION_ENDPOINT_ID = 0x1A
    ADDR_SUBTYPE_MPLS_TP_LSP_ENDPOINT_ID = 0x1B
    ADDR_SUBTYPE_MPLS_TP_PSEUDOWIRE_ENDPOINT_ID = 0x1C
    ADDR_SUBTYPE_MT_IP_MULTI_TOPOLOGY_IPV4 = 0x1D
    ADDR_SUBTYPE_MT_IP_MULTI_TOPOLOGY_IPV6 = 0x1E

    # Subtype Interface
    IFACE_SUBTYPE_UNKNOWN = 0x01
    IFACE_SUBTYPE_IF_INDEX = 0x02
    IFACE_SUBTYPE_SYSTEM_PORT_NUMBER = 0x03
