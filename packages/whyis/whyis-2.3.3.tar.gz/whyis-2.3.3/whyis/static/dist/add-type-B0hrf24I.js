import { V as r, p as u, d as n, n as c } from "./main-CjHXTkiG.js";
const p = r.component("add-type", {
  ...
  methods: {
    ...
    processAutocompleteMenu(i) {
      ...
      if (t.length >= 1)
        return t[0].style["z-index"] = 12, status = !0;
    },
    ...
    async getTypeList(i) {
      ...
      return t = s.data.concat(e.data).sort((a, l) => a.score < l.score ? 1 : -1), this.groupBy(t, "node");
    },
