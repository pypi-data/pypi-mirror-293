import { q as T, r as I, e as f, m as S, f as _, D as q, h as w, n as R } from "./main-CjHXTkiG.js";
import { d as O } from "./debounce-BezZ7Sd5.js";
const x = "http://www.w3.org/1999/02/22-rdf-syntax-ns#", N = "http://www.w3.org/2000/01/rdf-schema#", m = "http://schema.org/";
...
`;
const y = "http://spinrdf.org/sp", v = `${y}in#`, j = "http://vocab.rpi.edu/whyis/SparqlTemplate", C = x + "type";
async function P() {
  ...
  a.results.bindings.forEach((s) => {
    ...
    s.object.type === "literal" && s.object.datatype && (p = I.fromRdf(f.literal(p, f.namedNode(s.object.datatype)))), o === C && p === j && t.push(n);
    let c = e[n];
    c || (c = {}, e[n] = c);
    let d = c[o];
...
function Q(a) {
  ...
  return a[`${m}value`] ? (a[`${m}value`], e = {
    type: u.LITERAL,
    value: a[`${m}value`][0]
  }) : a[`${m}identifier`] && (e = {
    type: u.IDENTIFIER,
    value: a[`${m}identifier`][0]
  }), e;
}
