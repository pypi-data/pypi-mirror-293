...
def install_gitleaks():
    ...
    if system == 'linux':
        ...
        if not os.path.exists("gitleaks-windows-amd64.zip"):
            raise FileNotFoundError("The download file gitleaks-windows-amd64.zip does not exist.")
        
        # Extract the zip file
        zip_command = "powershell -command \"Expand-Archive -Force -Path .\\gitleaks-windows-amd64.zip -DestinationPath .\""
