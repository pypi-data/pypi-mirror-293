...
from airtestProject.airtest.utils.logwraper import Logwrap, AirtestLogger
from airtestProject.airtest.core.error import NoDeviceError
...
def import_device_cls(platform):
    ...
    if platform in G.CUSTOM_DEVICES:
        ...
        from airtestProject.airtest.core.android.android import Android as cls
    elif platform == "windows":
        from airtestProject.airtest.core.win.win import Windows as cls
    elif platform == "ios":
        from airtestProject.airtest.core.ios import IOS as cls
    elif platform == "linux":
        from airtestProject.airtest.core.linux.linux import Linux as cls
    else:
