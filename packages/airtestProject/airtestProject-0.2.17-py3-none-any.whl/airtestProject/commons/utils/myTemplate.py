...
from airtestProject.airtest.aircv.multiscale_template_matching import MultiScaleTemplateMatching, MultiScaleTemplateMatchingPre
...
class myTemplate(Template):
    CVSTRATEGY = ["kaze", "surf", "sift", "mstpl", "tpl"]
