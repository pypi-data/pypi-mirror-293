...
class myAirTest(OperateABC):
    ...
    def check_value(self, val, ocrPlus=False, threshold=0.7):
        """
        ...
        if isinstance(val, str):
            ...
            return myTemplate(val, threshold=threshold) if os.path.isfile(val) else OcrTemplate(val, language=self.language, ocrPlus=ocrPlus)
        return val
