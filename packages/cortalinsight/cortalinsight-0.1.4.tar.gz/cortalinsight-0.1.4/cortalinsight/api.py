...
from .utils import print_tabular, format_time, validate_coco_format, flatten_directory, subsample_video_to_frames
...
class CortalInsightClient:
    ...
    def upload_metadata_file(self, dataset_id, file_path):
        """
