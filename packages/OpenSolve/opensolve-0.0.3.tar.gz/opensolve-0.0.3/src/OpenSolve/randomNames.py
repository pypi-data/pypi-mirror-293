# a random name generator lovingly lifted from Docker's random container namer
import random
...
def randName():
    ...
    return f'{left[random.randrange(len(left))]}_{right[random.randrange(len(right))]}'
