...
class BinaryOpNode(Node):
    ...
    def forward(self, left, right):
        self.outputs["result"] = self._OP(left, right)
...
class SendEmailNode(Node):
    ...
    def forward(self, email_address: EmailStr, subject: str, content: str):
        print(
            f"Email sent to {email_address} with subject {subject} and content {content}"
        )
