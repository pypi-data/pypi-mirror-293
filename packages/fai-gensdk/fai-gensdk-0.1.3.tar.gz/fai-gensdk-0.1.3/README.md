...
image_path = 'C:/Users/Saliou Kane/Downloads/blue_sofa_chair.png'
...
width = 1024
height = 768
isbgremove = True # if True, the background will be removed

# Fuse the image
fuzed_image = image_gen.fuzer.fuzer(image_path, prompt, refprompt, mode, intensity, width, height, isbgremove)
