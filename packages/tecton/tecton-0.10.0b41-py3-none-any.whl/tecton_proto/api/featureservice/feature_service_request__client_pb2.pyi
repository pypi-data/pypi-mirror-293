...
class RequestOptions(_message.Message):
    __slots__ = ["high_watermark_override", "read_from_cache", "write_to_cache"]
    ...
    write_to_cache: bool
    def __init__(self, read_from_cache: bool = ..., write_to_cache: bool = ..., high_watermark_override: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ...) -> None: ...
