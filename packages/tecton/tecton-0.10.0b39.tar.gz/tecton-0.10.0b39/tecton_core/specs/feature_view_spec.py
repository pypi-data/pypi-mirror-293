...
# TODO(FE-2293): Update this to be the 0.9 -> 1.0 upgrade guide once the upgrade guide is created
MIGRATE_TO_FEATURES_GUIDE_LINK = "https://docs.tecton.ai/docs/beta/sdk-reference/features/migrate-to-features"
