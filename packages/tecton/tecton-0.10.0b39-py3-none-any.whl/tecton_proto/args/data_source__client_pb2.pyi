...
class FileDataSourceArgs(_message.Message):
    __slots__ = ["common_args", "convert_to_glue_format", "file_format", "schema_override", "schema_uri", "timestamp_format", "uri"]
    COMMON_ARGS_FIELD_NUMBER: ClassVar[int]
    ...
    uri: str
    def __init__(self, uri: Optional[str] = ..., file_format: Optional[str] = ..., convert_to_glue_format: bool = ..., schema_uri: Optional[str] = ..., timestamp_format: Optional[str] = ..., schema_override: Optional[Union[_spark_schema__client_pb2.SparkSchema, Mapping]] = ..., common_args: Optional[Union[BatchDataSourceCommonArgs, Mapping]] = ...) -> None: ...
