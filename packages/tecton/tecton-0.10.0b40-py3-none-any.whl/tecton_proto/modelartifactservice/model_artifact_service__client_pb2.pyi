...
class ModelArtifactInfo(_message.Message):
    __slots__ = ["created_at", "created_by", "description", "environments", "file_hashes", "id", "input_schema", "model_file_path", "name", "output_schema", "status", "storage_path", "tags", "type", "updated_at"]
    class FileHashesEntry(_message.Message):
        __slots__ = ["key", "value"]
        KEY_FIELD_NUMBER: ClassVar[int]
        VALUE_FIELD_NUMBER: ClassVar[int]
