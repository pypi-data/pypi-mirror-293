...
class MaterializedFeatureView(FeatureView):
    ...
    def _convert_data_sources_to_explicitly_filtered_objects(
        ...
        default_to_unfiltered_sources: bool,
    ) -> Sequence[Union[data_source_filter.DataSourceFilter]]:
        new_sources = []
        for source in sources:
            ...
            if isinstance(source, (FeatureReference, FeatureView, configs.RequestSource)):
                ...
                if default_to_unfiltered_sources:
                    new_sources.append(source.unfiltered())
                else:
                    new_sources.append(source.filtered())
            else:
...
class BatchFeatureView(MaterializedFeatureView):
    ...
    def __init__(
        ...
        *,
        ...
        wrapped_sources = self._convert_data_sources_to_explicitly_filtered_objects(
            sources, repo_config.get_batch_feature_view_defaults().default_to_unfiltered_sources
        )
...
class StreamFeatureView(MaterializedFeatureView):
    ...
    def __init__(
        ...
        *,
        ...
        wrapped_sources = self._convert_data_sources_to_explicitly_filtered_objects(
            [source], repo_config.get_stream_feature_view_defaults().default_to_unfiltered_sources
        )
...
def _source_to_pipeline_node(
    ...
    elif isinstance(source, data_source_filter.UnfilteredSource):
        node = pipeline_pb2.DataSourceNode(
