...
class EventBridgeClient(AioBaseClient):
    ...
    async def activate_event_source(self, *, Name: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    async def deactivate_event_source(self, *, Name: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    async def delete_event_bus(self, *, Name: str) -> EmptyResponseMetadataTypeDef:
        """
