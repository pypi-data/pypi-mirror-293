...
"""
    ...
    def _request(
        ...
        r = self.session.request(method=method, headers=headers, url=url, json=json_body, data=data, timeout=timeout)
...
from the command line from '{os.getcwd()}'. If you are still having trouble, please contact Chalk support.""",
    ...
    def _create_dataset_job(
        ...
        recompute_features: Union[bool, List[FeatureReference]],
        sample_features: Optional[List[FeatureReference]],
        lower_bound: Optional[datetime],
        upper_bound: Optional[datetime],
        store_plan_stages: bool,
        explain: bool,
        tags: Optional[List[str]],
        required_resolver_tags: Optional[List[str]],
        planner_options: Optional[Mapping[str, Any]],
        run_asynchronously: bool,
        spine_sql_query: str | None,
