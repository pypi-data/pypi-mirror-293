...
class IOContext:
    ...
    def __init__(
        ...
        function_call_ids: typing.List[str],
        finalized_function: FinalizedFunction,
        deserialized_args: typing.List[typing.Any],
        is_batched: bool,
    ): ...
    @classmethod
    async def create(
...
class _ContainerIOManager:
    ...
    _input_concurrency: typing.Optional[int]
    _semaphore: typing.Optional[asyncio.locks.Semaphore]
    ...
    async def get_serialized_function(
        self,
    ) -> typing.Tuple[typing.Optional[typing.Any], typing.Callable[..., typing.Any]]: ...
    ...
    def serialize_exception(self, exc: BaseException) -> typing.Optional[bytes]: ...
...
class ContainerIOManager:
    ...
    class __get_serialized_function_spec(typing_extensions.Protocol):
        def __call__(self) -> typing.Tuple[typing.Optional[typing.Any], typing.Callable[..., typing.Any]]: ...
        async def aio(
            self, *args, **kwargs
        ) -> typing.Tuple[typing.Optional[typing.Any], typing.Callable[..., typing.Any]]: ...
