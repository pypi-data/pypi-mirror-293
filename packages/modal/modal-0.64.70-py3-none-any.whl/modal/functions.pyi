...
class _Function(typing.Generic[P, R], modal.object._Object):
    ...
    async def spawn(self, *args: P.args, **kwargs: P.kwargs) -> typing.Optional[_FunctionCall[R]]: ...
...
class Function(typing.Generic[P, R], modal.object.Object):
    _info: typing.Optional[modal._utils.function_utils.FunctionInfo]
    ...
    class ___call_function_spec(typing_extensions.Protocol[R_INNER]):
        def __call__(self, args, kwargs) -> R_INNER: ...
        async def aio(self, *args, **kwargs) -> R_INNER: ...

    _call_function: ___call_function_spec[R]
    ...
    class __remote_spec(typing_extensions.Protocol[R_INNER, P_INNER]):
    ...
    class __spawn_spec(typing_extensions.Protocol[R_INNER, P_INNER]):
...
class _FunctionCall(typing.Generic[R], modal.object._Object):
    def _invocation(self): ...
    async def get(self, timeout: typing.Optional[float] = None) -> R: ...
    ...
    @staticmethod
    async def from_id(function_call_id: str, client: typing.Optional[modal.client._Client] = None) -> _FunctionCall: ...

class FunctionCall(typing.Generic[R], modal.object.Object):
    def __init__(self, *args, **kwargs): ...
    def _invocation(self): ...

    class __get_spec(typing_extensions.Protocol[R_INNER]):
        def __call__(self, timeout: typing.Optional[float] = None) -> R_INNER: ...
        async def aio(self, *args, **kwargs) -> R_INNER: ...
