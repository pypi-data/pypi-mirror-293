...
class ImportFile_Controller:
    ...
    def OpenDataFile(self):
        """
        Opens a file dialog to load a data file (*.mat, *.txt).
    ...
    def OpenNameFile(self):
        """
        Opens a file dialog to load a name file (*.txt).
    ...
    def OpenFlutFile(self):
        """
        Opens a file dialog to load a flut file (*.flut).
    ...
    def OpenFiltersFile(self):
        """
        Opens a file dialog to load a filters file (*.json) if both data and flut files are loaded.
