...
class ConnGraph_Infos(metaclass=DataSingleton):
    ...
    def BetweennessCentralityBinary(self):

        betweenessDivided = nx.betweenness_centrality(self.nxGraphBinary, normalized=False)

        betweenessCentrality = {}
        for name, value in betweenessDivided.items():
            betweenessCentrality[name] = value * 2
    ...
    def GetLocalMeasures(self, localMeasure):
        ...
        match localMeasure:
            ...
            case "betweenness centrality (binary)":
                return self.BetweennessCentralityBinary()
