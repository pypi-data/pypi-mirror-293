# Allows to generate the package distribution 
# python setup.py bdist_wheel sdist

# Allows to Upload the package (dist/ folder) on PyPI (or TestPyPI)
# twine upload dist/* 
# twine upload --repository testpypi dist/*

# Allows to automate the writing of the api token during a upload. 
# A file .pypirc should be created in the user directory.
"""
[distutils]
index-servers =
    testpypi
