...
class AnalyzeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="AnalyzeText_720d0acdec93_error",
        handler=None,
        kind=None,
        language=None,
        languageCol=None,
        ...
        outputCol="AnalyzeText_720d0acdec93_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="AnalyzeText_720d0acdec93_error")
        self._setDefault(outputCol="AnalyzeText_720d0acdec93_output")
