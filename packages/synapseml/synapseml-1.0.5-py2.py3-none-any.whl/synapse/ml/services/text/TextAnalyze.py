...
class TextAnalyze(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextAnalyze_63f435ec1378_error",
        ...
        outputCol="TextAnalyze_63f435ec1378_output",
        ...
        self._setDefault(errorCol="TextAnalyze_63f435ec1378_error")
        ...
        self._setDefault(outputCol="TextAnalyze_63f435ec1378_output")
