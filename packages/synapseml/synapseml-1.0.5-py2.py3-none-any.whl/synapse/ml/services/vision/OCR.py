...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OCR_c83cf2af5eea_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_c83cf2af5eea_output",
        ...
        self._setDefault(errorCol="OCR_c83cf2af5eea_error")
        self._setDefault(outputCol="OCR_c83cf2af5eea_output")
