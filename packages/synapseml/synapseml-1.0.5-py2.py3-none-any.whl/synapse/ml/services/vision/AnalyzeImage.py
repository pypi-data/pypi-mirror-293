...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_62eb8758fefd_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_62eb8758fefd_output",
        ...
        self._setDefault(errorCol="AnalyzeImage_62eb8758fefd_error")
        self._setDefault(outputCol="AnalyzeImage_62eb8758fefd_output")
