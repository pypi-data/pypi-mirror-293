...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GenerateThumbnails_d0c17a2d2c53_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_d0c17a2d2c53_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_d0c17a2d2c53_error")
        self._setDefault(outputCol="GenerateThumbnails_d0c17a2d2c53_output")
