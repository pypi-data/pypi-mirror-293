...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Detect_9c42e9de73f3_error",
        handler=None,
        outputCol="Detect_9c42e9de73f3_output",
        ...
        self._setDefault(errorCol="Detect_9c42e9de73f3_error")
        self._setDefault(outputCol="Detect_9c42e9de73f3_output")
