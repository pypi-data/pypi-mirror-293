...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Translate_ff488f57ad26_error",
        fromLanguage=None,
        ...
        outputCol="Translate_ff488f57ad26_output",
        ...
        self._setDefault(errorCol="Translate_ff488f57ad26_error")
        self._setDefault(outputCol="Translate_ff488f57ad26_output")
