...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Transliterate_ea75817d70d4_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_ea75817d70d4_output",
        ...
        self._setDefault(errorCol="Transliterate_ea75817d70d4_error")
        self._setDefault(outputCol="Transliterate_ea75817d70d4_output")
