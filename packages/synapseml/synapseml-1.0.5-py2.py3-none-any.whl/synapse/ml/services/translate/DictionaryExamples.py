...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DictionaryExamples_5feac112b2ab_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_5feac112b2ab_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_5feac112b2ab_error")
        self._setDefault(outputCol="DictionaryExamples_5feac112b2ab_output")
