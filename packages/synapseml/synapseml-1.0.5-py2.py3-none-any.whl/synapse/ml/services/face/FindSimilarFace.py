...
class FindSimilarFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="FindSimilarFace_4ab581936db7_error",
        faceId=None,
        faceIdCol=None,
        faceIds=None,
        faceIdsCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="FindSimilarFace_4ab581936db7_output",
        ...
        self._setDefault(errorCol="FindSimilarFace_4ab581936db7_error")
        self._setDefault(outputCol="FindSimilarFace_4ab581936db7_output")
