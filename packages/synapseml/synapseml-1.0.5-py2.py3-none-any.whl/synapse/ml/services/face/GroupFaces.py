...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GroupFaces_61b43ba6d004_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_61b43ba6d004_output",
        ...
        self._setDefault(errorCol="GroupFaces_61b43ba6d004_error")
        self._setDefault(outputCol="GroupFaces_61b43ba6d004_output")
