...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="VerifyFaces_a67cd59f74c7_error",
        faceId=None,
        faceIdCol=None,
        faceId1=None,
        faceId1Col=None,
        ...
        outputCol="VerifyFaces_a67cd59f74c7_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="VerifyFaces_a67cd59f74c7_error")
        self._setDefault(outputCol="VerifyFaces_a67cd59f74c7_output")
