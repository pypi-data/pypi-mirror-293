...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="ListCustomModels_a3b04767e5d2_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_a3b04767e5d2_output",
        ...
        self._setDefault(errorCol="ListCustomModels_a3b04767e5d2_error")
        self._setDefault(outputCol="ListCustomModels_a3b04767e5d2_output")
