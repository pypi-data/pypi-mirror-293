...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GetCustomModel_90bc62183902_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_90bc62183902_output",
        ...
        self._setDefault(errorCol="GetCustomModel_90bc62183902_error")
        self._setDefault(outputCol="GetCustomModel_90bc62183902_output")
