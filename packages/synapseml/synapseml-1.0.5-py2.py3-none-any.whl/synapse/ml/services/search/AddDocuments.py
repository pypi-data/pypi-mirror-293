...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AddDocuments_864e318de6a8_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_864e318de6a8_output",
        serviceName=None,
        ...
        self._setDefault(errorCol="AddDocuments_864e318de6a8_error")
        self._setDefault(outputCol="AddDocuments_864e318de6a8_output")
