...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_b2bd10850ae1_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_b2bd10850ae1_output",
        ...
        self._setDefault(errorCol="CheckPointInPolygon_b2bd10850ae1_error")
        self._setDefault(outputCol="CheckPointInPolygon_b2bd10850ae1_output")
