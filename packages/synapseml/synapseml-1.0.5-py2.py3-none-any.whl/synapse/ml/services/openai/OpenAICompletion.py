...
class OpenAICompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAICompletion_f0d79d1b9900_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAICompletion_f0d79d1b9900_output",
        ...
        self._setDefault(errorCol="OpenAICompletion_f0d79d1b9900_error")
        self._setDefault(outputCol="OpenAICompletion_f0d79d1b9900_output")
