...
class OpenAIPrompt(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIPrompt_f2199e22eb8c_error",
        ...
        maxTokens=None,
        maxTokensCol=None,
        messagesCol="OpenAIPrompt_f2199e22eb8c_messages",
        n=None,
        nCol=None,
        outputCol="OpenAIPrompt_f2199e22eb8c_output",
        postProcessing="",
        ...
        self._setDefault(errorCol="OpenAIPrompt_f2199e22eb8c_error")
        self._setDefault(messagesCol="OpenAIPrompt_f2199e22eb8c_messages")
        self._setDefault(outputCol="OpenAIPrompt_f2199e22eb8c_output")
