...
class OpenAIEmbedding(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        dimensions=None,
        dimensionsCol=None,
        errorCol="OpenAIEmbedding_9fddd22d6f04_error",
        handler=None,
        outputCol="OpenAIEmbedding_9fddd22d6f04_output",
        ...
        self._setDefault(errorCol="OpenAIEmbedding_9fddd22d6f04_error")
        self._setDefault(outputCol="OpenAIEmbedding_9fddd22d6f04_output")
