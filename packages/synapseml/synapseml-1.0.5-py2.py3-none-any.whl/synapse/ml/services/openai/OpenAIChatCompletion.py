...
class OpenAIChatCompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIChatCompletion_9cdd35174b2f_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIChatCompletion_9cdd35174b2f_output",
        ...
        self._setDefault(errorCol="OpenAIChatCompletion_9cdd35174b2f_error")
        self._setDefault(outputCol="OpenAIChatCompletion_9cdd35174b2f_output")
