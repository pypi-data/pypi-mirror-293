...
class SpeechToText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="SpeechToText_0d51047a6042_error",
        format=None,
        formatCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="SpeechToText_0d51047a6042_output",
        profanity=None,
        profanityCol=None,
        ...
        self._setDefault(errorCol="SpeechToText_0d51047a6042_error")
        self._setDefault(outputCol="SpeechToText_0d51047a6042_output")
