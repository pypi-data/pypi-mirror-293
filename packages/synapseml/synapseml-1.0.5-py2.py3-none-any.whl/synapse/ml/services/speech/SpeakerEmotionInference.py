...
class SpeakerEmotionInference(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="SpeakerEmotionInference_492551bdeb47_error",
        handler=None,
        locale=None,
        localeCol=None,
        outputCol="SpeakerEmotionInference_492551bdeb47_output",
        ...
        self._setDefault(errorCol="SpeakerEmotionInference_492551bdeb47_error")
        self._setDefault(outputCol="SpeakerEmotionInference_492551bdeb47_output")
