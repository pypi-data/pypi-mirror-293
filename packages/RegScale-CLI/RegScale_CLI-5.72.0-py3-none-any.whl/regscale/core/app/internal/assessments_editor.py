...
def upload_data(path: Path) -> None:
    ...
    if os.path.isfile(os.path.join(path, ALL_ASSESSMENTS_WB)):
        ...
        df1 = pd.read_excel(os.path.join(path, OLD_ASSESSMENTS_WB), sheet_name=0, index_col="Id")

        df2 = pd.read_excel(os.path.join(path, ALL_ASSESSMENTS_WB), sheet_name=0, index_col="Id")
