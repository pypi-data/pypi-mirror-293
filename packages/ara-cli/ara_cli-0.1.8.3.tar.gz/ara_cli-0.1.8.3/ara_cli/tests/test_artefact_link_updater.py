...
from ara_cli.artefact_renamer import ArtefactRenamer  # Adjust this import path according to your setup
from ara_cli.artefact_link_updater import ArtefactLinkUpdater  # Adjust this import path according to your setup
