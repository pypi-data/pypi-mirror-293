...
from zdppy_mysql.exceptions import ParamError


def get_add_sql(table, columns: List[str]):
    """
    获取添加数据的字符串
    :param table:
    :param columns:
    ...
    # 准备参数
    column_str = ", ".join([f"`{v}`" for v in columns])
...
def get_sql_delete_by_id(table):
    """
    获取添加数据的字符串
    :param table:
    :return:
...
def get_sql_delete_by_ids(table, ids_length: int):
    """
    获取添加数据的字符串
    :param table:
    :return:
...
def get_sql_update_by_id(table, columns: List[str]):
    """
    获取添加数据的字符串
    :param table:
    :param columns:
...
def get_sql_update_by_ids(table, columns: List[str], ids_length: int):
    """
    获取添加数据的字符串
    :param table:
    :param columns:
...
def get_sql_find_by_id(table, columns: List[str]):
    """
    获取添加数据的字符串
    :param table:
    :param columns:
...
def get_sql_find_by_ids(table, columns: List[str], ids_length: int):
    """
    获取添加数据的字符串
    :param table:
    :param columns:
...
def get_sql_find_column_in(table, columns: List[str], column, values_length: int):
    """
    获取添加数据的字符串
    :param table:
    :param columns:
...
def get_sql_find_by_page(table, columns: List[str],
                         page: int = 1,
                         size: int = 20,
...
def get_create_table_sql(
    ...
    if open_common:
        columns.append(
            "create_time datetime not null default current_timestamp")  # 创建时机
        columns.append(
            "update_time timestamp not null on update current_timestamp default current_timestamp")  # 更新时间
