...
async def drain_chain(
    ...
    w3 = AsyncWeb3(AsyncWeb3.AsyncHTTPProvider(config.rpc_urls[chain]))
    ...
    # TODO: we are currently skipping this because drain_eth does not correctly calculate L1 gas fees
