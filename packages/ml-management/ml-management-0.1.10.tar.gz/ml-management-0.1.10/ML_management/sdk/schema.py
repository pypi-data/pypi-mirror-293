...
class DatasetLoaderVersion(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('name', 'version', 'source_path', 'tags', 'description', 'status', 'status_message', 'creation_timestamp', 'last_updated_timestamp', 'dataset_loader_method_schemas', 'dataset_loader_method_schema_names', 'run', 'dataset_loader', 'data_json_schema', 'list_deployed_jobs', 'pagination_deployed_jobs')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
...
class ExecutionJob(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('name', 'periodic_type', 'status', 'registration_timestamp', 'start_timestamp', 'end_timestamp', 'exception', 'params', 'run', 'experiment', 'list_init_role_model_version', 'list_dataset_loader_versions', 'executor_version', 'build_job', 'list_result_model_version', 'available_metrics', 'metric_history')
    name = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='name')
...
class ModelParams(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('model_version_choice', 'list_model_method_params', 'description', 'new_model_name', 'prepare_new_model_inference')
    model_version_choice = sgqlc.types.Field(sgqlc.types.non_null('ModelVersionChoiseParams'), graphql_name='modelVersionChoice')
...
class ModelVersionChoiseParams(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('name', 'version', 'choice_criteria', 'metric_name', 'optimal_min')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
