...
KMAP = json.loads(os.getenv("KMAP"))
ALOHA_MAP = json.loads(os.getenv("ALOHA_MAP"))
DECODE_KMAP = json.loads(os.getenv("DECODE_KMAP"))
DECODE_ALOHA_MAP = json.loads(os.getenv("DECODE_ALOHA_MAP"))
