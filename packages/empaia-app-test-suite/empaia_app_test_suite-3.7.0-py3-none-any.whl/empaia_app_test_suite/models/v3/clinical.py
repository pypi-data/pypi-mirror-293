...
class PutCase(RestrictedBaseModel):
    ...
    indication: Optional[str] = Field(
        default=None,
        examples=["ICCR_LUNG_CANCERS"],
        description="Indication assigned to the case.",
    )

    procedure: Optional[str] = Field(
        default=None,
        examples=["FINE_NEEDLE_BIOPSY"],
        description="Procedure assigned to the case.",
    )
...
class CaseQuery(RestrictedBaseModel):
    ...
    slides: Optional[Annotated[List[UUID4], Field(min_length=1)]] = Field(
        default=None,
        examples=[
            [
                "b10648a7-340d-43fc-a2d9-4d91cc86f33f",
