...
# Core model - Used in AppService


class ClassCore(RestrictedBaseModel):
...
class PostClassList(RestrictedBaseModel):
    items: List[PostClass] = Field(description="List of classes")


PostClasses = Union[PostClass, PostClassList]
