...
class StableDiffusion3(nn.Module):
    ...
    def forward(self, image, timestep=None, return_flat_dict=False):
        ...
        out = self.transformer(latent, timestep=self.noise_scheduler.timesteps[timestep].unsqueeze(0), pooled_projections=pooled_projections, encoder_hidden_states=encoder_hidden_states)
