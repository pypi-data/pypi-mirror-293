...
class PositionHandler(Extension):
    ...
    def requestMITOrders(self, pid, symbolCode) -> None: ...
    def requestOCOOrders(self, pid, symbolCode) -> None: ...
    def requestOrders(self, pid, symbolCode) -> None: ...
    def requestBalance(self, pid, symbolCode) -> None: ...
    def requestMITBalance(self, pid, symbolCode) -> None: ...
    def requestOCOBalance(self, pid, symbolCode) -> None: ...
