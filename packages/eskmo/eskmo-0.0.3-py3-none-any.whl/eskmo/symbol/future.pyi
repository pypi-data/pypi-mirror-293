...
class FutureInfoHandler(Extension):
    ...
    futureDict: Incomplete
    pendingFutureDict: Incomplete
    futureIdxDict: Incomplete
...
class FutureInfo(SubscribableInfo):
    ...
    def setPnLDetails(self, pnl: dict): ...
    def setPnLSummary(self, pnl: dict): ...
    ...
    def publishPnLDetails(self) -> None: ...
    def publishPnLSummary(self) -> None: ...
