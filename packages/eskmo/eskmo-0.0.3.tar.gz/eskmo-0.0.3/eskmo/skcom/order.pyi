...
class OrderEventHandler(APIEventHandler):
    ...
    def afterDecreaseQtyBySeqNo(self, data, ret) -> None: ...
    def decreaseQtyBySeqNo(self, data: dict, quiet: bool = False): ...
    def afterModifyOrderPriceBySeqNo(self, data, ret) -> None: ...
    def modifyOrderPriceBySeqNo(self, data: dict, quiet: bool = False): ...
    ...
    def afterSendOrderCall(self, startTime, fromPid, orderDict: dict, isSuccessCalled, status, callbackId): ...
    def afterSendFutureOrder(self, data, ret) -> None: ...
    def afterSendOrder(self, data, ret) -> None: ...
    @staticmethod
    def getBreakDownVolumeList(qty, breakUnit): ...
    def sendFutureOrder(self, data) -> None: ...
    ...
    def OnProxyOrder(self, serialNumber, runnerName, nCode, bstrMessage) -> None: ...
