...
class Route53RecoveryReadinessClient(AioBaseClient):
    ...
    async def delete_cell(self, *, CellName: str) -> EmptyResponseMetadataTypeDef:
        """
        Delete a cell.
    ...
    async def delete_resource_set(self, *, ResourceSetName: str) -> EmptyResponseMetadataTypeDef:
        """
