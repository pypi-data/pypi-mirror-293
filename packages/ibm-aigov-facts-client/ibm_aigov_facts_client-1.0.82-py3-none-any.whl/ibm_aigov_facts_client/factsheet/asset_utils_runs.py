...
class NotebookExperimentRunsUtilities:
    ...
    def _get_cpd_image_val(self):
        ...
        if "hotfix483" in cpd_image_val or (self._is_cp4d and self._cp4d_version >= "5.0.3") or (not self._is_cp4d): #conditions cpd hotfix 483, 485, 503 and above, sas supported
            return True
        return False
