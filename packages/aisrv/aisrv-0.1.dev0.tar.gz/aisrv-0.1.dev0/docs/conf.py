...
copyright = u'Copyright (c) 2023 Jérémie DECOCK (www.jdhp.org)'

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
project_version = __import__('aiapi').__version__.split('.')
...
latex_documents = [
    (master_doc, 'aiapi.tex', 'AI-API Documentation',
     authors, 'manual'),
]
...
man_pages = [
    (master_doc, 'aiapi', 'AI-API Documentation',
     [authors], 1)
]
