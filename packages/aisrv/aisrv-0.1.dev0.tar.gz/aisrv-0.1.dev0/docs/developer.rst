...
.. warning::
   ...
   `aiapi` package. If you just want to write code that uses it
...
In your terminal, change to the directory where you cloned `aiapi`.
...
This virtual environment contains all the AI-API dependencies and a few useful
...
.. _available on GitHub: https://gitlab.com/jdhp-dev/ai-api
...
.. _TODO.md: https://gitlab.com/jdhp-dev/ai-api/blob/master/TODO.md
