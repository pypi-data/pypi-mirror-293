...
from data_analyser.model.handler import get_render_map
from data_analyser.report.presentation.core import (
    HTML,
    Collapse,
    Container,
    Dropdown,
...
from data_analyser.report.presentation.core import Image as ImageWidget
from data_analyser.report.presentation.core import Sample, ToggleButton, Variable
from data_analyser.report.presentation.core.renderable import Renderable
from data_analyser.report.presentation.core.root import Root
from data_analyser.report.structure.correlations import get_correlation_items
from data_analyser.report.structure.overview import get_dataset_items
from data_analyser.utils.dataframe import slugify
...
def get_report_structure(config: Settings, summary: BaseDescription) -> Root:
    ...
    footer = HTML(
        content='Report generated by <a href="https://github.com/anthropoleo">Anthropoleo</a>.'
    )
