...
from data_analyser.model import BaseAnalysis, BaseDescription
from data_analyser.model.alerts import get_alerts
from data_analyser.model.correlations import (
    calculate_correlation,
    get_active_correlations,
)
from data_analyser.model.dataframe import check_dataframe, preprocess
from data_analyser.model.description import TimeIndexAnalysis
from data_analyser.model.duplicates import get_duplicates
from data_analyser.model.missing import get_missing_active, get_missing_diagram
from data_analyser.model.pairwise import get_scatter_plot, get_scatter_tasks
from data_analyser.model.sample import get_custom_sample, get_sample
from data_analyser.model.summarizer import BaseSummarizer
from data_analyser.model.summary import get_series_descriptions
from data_analyser.model.table import get_table_stats
from data_analyser.model.timeseries_index import get_time_index_description
from data_analyser.utils.progress_bar import progress
from data_analyser.version import __version__
...
def describe(
    ...
    with tqdm(
        ...
        package = {
            "data_analyser_version": __version__,
            "data_analyser_config": config.json(),
        }
        pbar.update()
