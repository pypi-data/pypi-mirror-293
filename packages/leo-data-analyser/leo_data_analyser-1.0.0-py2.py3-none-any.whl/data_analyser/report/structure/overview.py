...
from data_analyser.report.formatters import (
    fmt,
    fmt_bytesize,
    fmt_number,
    fmt_numeric,
...
from data_analyser.report.presentation.core import Alerts, Container
from data_analyser.report.presentation.core import Image as ImageWidget
from data_analyser.report.presentation.core import Table
from data_analyser.report.presentation.core.renderable import Renderable
from data_analyser.visualisation.plot import plot_overview_timeseries
...
def get_dataset_reproduction(config: Settings, summary: BaseDescription) -> Renderable:
    ...
    version = "V1"  # Setting version directly as "V1"
    config_file = summary.package["data_analyser_config"]
