...
from data_analyser.config import Correlation, Settings
from data_analyser.model import BaseDescription
from data_analyser.model.alerts import Alert
from data_analyser.profile_report import ProfileReport
...
def compare(
    ...
    if isinstance(reports[0], ProfileReport):
        ...
        configs_str = [
            json.loads(r.package["data_analyser_config"]) for r in reports  # type: ignore
        ]
        all_configs = []
