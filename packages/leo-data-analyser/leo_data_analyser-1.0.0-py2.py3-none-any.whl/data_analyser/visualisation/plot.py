...
from data_analyser.utils.common import convert_timestamp_to_datetime
from data_analyser.visualisation.context import manage_matplotlib_context
from data_analyser.visualisation.utils import plot_360_n0sc0pe
...
def _plot_word_cloud(
    ...
    figsize: tuple = (6, 4),
    word_color: str = "#ff5733"  # Default color set to orange
) -> plt.Figure:
    def single_color_func(*args, **kwargs):
        return word_color  # All words will be this color
    ...
    for i, series_data in enumerate(series):
        ...
        wordcloud = WordCloud(
            ...
            height=200,
            scale=2,
            color_func=single_color_func,  # Apply the single color function
