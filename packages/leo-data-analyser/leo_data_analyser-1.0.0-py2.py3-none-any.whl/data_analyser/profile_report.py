...
from data_analyser.config import Config, Settings, SparkSettings
from data_analyser.expectations_report import ExpectationsReport
from data_analyser.model import BaseDescription
from data_analyser.model.alerts import AlertType
from data_analyser.model.describe import describe as describe_df
from data_analyser.model.sample import Sample
from data_analyser.model.summarizer import (
    BaseSummarizer,
    PandasProfilingSummarizer,
    format_summary,
    redact_summary,
)
from data_analyser.model.typeset import ProfilingTypeSet
from data_analyser.report import get_report_structure
from data_analyser.report.presentation.core import Root
from data_analyser.report.presentation.flavours.html.templates import (
    create_html_assets,
)
from data_analyser.serialize_report import SerializeReport
from data_analyser.utils.dataframe import hash_dataframe
from data_analyser.utils.logger import ProfilingLogger
from data_analyser.utils.paths import get_config
...
class ProfileReport(SerializeReport, ExpectationsReport):
    ...
    def _render_html(self) -> str:
        from data_analyser.report.presentation.flavours import HTMLReport
        ...
        with tqdm(
            ...
            html = HTMLReport(copy.deepcopy(report)).render(
                ...
                version=self.description_set.package["data_analyser_version"],
            )
    ...
    def _render_widgets(self) -> Any:
        from data_analyser.report.presentation.flavours import WidgetReport
    ...
    def to_notebook_iframe(self) -> None:
        ...
        from data_analyser.report.presentation.flavours.widget.notebook import (
            get_notebook_iframe,
        )
    ...
    def compare(
        ...
        Alias for:
        ```
        data_analyser.compare([report1, report2], config=config)
        ```
        See `data_analyser.compare` for details.
        ...
        """
        from data_analyser.compare_reports import compare
