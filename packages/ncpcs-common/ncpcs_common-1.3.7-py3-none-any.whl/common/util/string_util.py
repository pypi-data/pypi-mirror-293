...
def cut_by_time(text, admission_time=None, avg_len=DEFAULT_DOCUMENT_AVG_LEN):
    ...
    for start_index, end_index, seg in seg_list:
        ...
        if timeline:
            ...
            if results and (results[-1][1] - results[-1][0]) < avg_len:
...
# for start_index, end_index, timeline in cut_by_time(content, '2020-12-01 00:00:00', avg_len=50):
#     if timeline:
