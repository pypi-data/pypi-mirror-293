...
class AsyncDatabases(AsyncService):

    def __init__(self, client: AsyncClient):
        super(AsyncDatabases, self).__init__(client)

    async def list(self, queries=None, search=None):
        """List databases"""
    ...
    async def create(self, database_id, name, enabled=None):
        """Create database"""
    ...
    async def update(self, database_id, name, enabled=None):
        """Update database"""
    ...
    async def delete(self, database_id):
        """Delete database"""
    ...
    async def list_collections(self, database_id, queries=None, search=None):
        """List collections"""
    ...
    async def get_collection(self, database_id, collection_id):
        """Get collection"""
    ...
    async def delete_collection(self, database_id, collection_id):
        """Delete collection"""
    ...
    async def list_attributes(self, database_id, collection_id, queries=None):
        """List attributes"""
    ...
    async def create_boolean_attribute(
        self, database_id, collection_id, key, required, default=None, array=None
    ):
    ...
    async def update_boolean_attribute(
        self, database_id, collection_id, key, required, default
    ):
    ...
    async def update_datetime_attribute(
        self, database_id, collection_id, key, required, default
    ):
    ...
    async def update_email_attribute(
        self, database_id, collection_id, key, required, default
    ):
    ...
    async def update_enum_attribute(
        self, database_id, collection_id, key, elements, required, default
    ):
    ...
    async def update_float_attribute(
        self, database_id, collection_id, key, required, min, max, default
    ):
    ...
    async def update_integer_attribute(
        self, database_id, collection_id, key, required, min, max, default
    ):
    ...
    async def create_relationship_attribute(
        ...
        if related_collection_id is None:
            raise AppwriteException(
                'Missing required parameter: "related_collection_id"'
            )
    ...
    async def update_string_attribute(
        self, database_id, collection_id, key, required, default
    ):
    ...
    async def update_url_attribute(
        self, database_id, collection_id, key, required, default
    ):
    ...
    async def get_attribute(self, database_id, collection_id, key):
        """Get attribute"""
    ...
    async def delete_attribute(self, database_id, collection_id, key):
        """Delete attribute"""
    ...
    async def update_relationship_attribute(
        self, database_id, collection_id, key, on_delete=None
    ):
    ...
    async def list_documents(self, database_id, collection_id, queries=None):
        """List documents"""
    ...
    async def create_document(
        self, database_id, collection_id, document_id, data, permissions=None
    ):
        """Create document"""
    ...
    async def get_document(self, database_id, collection_id, document_id, queries=None):
        """Get document"""
    ...
    async def update_document(
        self, database_id, collection_id, document_id, data=None, permissions=None
    ):
        """Update document"""
    ...
    async def delete_document(self, database_id, collection_id, document_id):
        """Delete document"""
    ...
    async def list_indexes(self, database_id, collection_id, queries=None):
        """List indexes"""
    ...
    async def create_index(
        self, database_id, collection_id, key, type, attributes, orders=None
    ):
        """Create index"""
    ...
    async def get_index(self, database_id, collection_id, key):
        """Get index"""
    ...
    async def delete_index(self, database_id, collection_id, key):
        """Delete index"""
