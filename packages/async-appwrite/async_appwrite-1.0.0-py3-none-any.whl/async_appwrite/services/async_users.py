...
class AsyncUsers(AsyncService):

    def __init__(self, client: AsyncClient):
        super(AsyncUsers, self).__init__(client)
    ...
    async def create(self, user_id, email=None, phone=None, password=None, name=None):
        """Create user"""
    ...
    async def create_argon2_user(self, user_id, email, password, name=None):
    ...
    async def create_bcrypt_user(self, user_id, email, password, name=None):
    ...
    async def list_identities(self, queries=None, search=None):
        """List Identities"""
    ...
    async def create_md5_user(self, user_id, email, password, name=None):
    ...
    async def create_ph_pass_user(self, user_id, email, password, name=None):
    ...
    async def create_scrypt_modified_user(
        self,
        user_id,
        email,
        password,
        ...
        if password_salt_separator is None:
            raise AppwriteException(
                'Missing required parameter: "password_salt_separator"'
            )
    ...
    async def create_sha_user(
        self, user_id, email, password, password_version=None, name=None
    ):
    ...
    async def create_jwt(self, user_id, session_id=None, duration=None):
        """Create user JWT"""
    ...
    async def update_labels(self, user_id, labels):
        """Update user labels"""
    ...
    async def list_logs(self, user_id, queries=None):
        """List user logs"""
    ...
    async def update_mfa(self, user_id, mfa):
        """Update MFA"""
    ...
    async def delete_mfa_authenticator(self, user_id, type):
    ...
    async def list_mfa_factors(self, user_id):
        """List Factors"""
    ...
    async def get_mfa_recovery_codes(self, user_id):
    ...
    async def update_mfa_recovery_codes(self, user_id):
    ...
    async def create_mfa_recovery_codes(self, user_id):
    ...
    async def update_phone(self, user_id, number):
        """Update phone"""
    ...
    async def update_prefs(self, user_id, prefs):
    ...
    async def list_targets(self, user_id, queries=None):
        """List User Targets"""
    ...
    async def create_target(
        self, user_id, target_id, provider_type, identifier, provider_id=None, name=None
    ):
        """Create User Target"""
    ...
    async def get_target(self, user_id, target_id):
        """Get User Target"""
    ...
    async def update_target(
        self, user_id, target_id, identifier=None, provider_id=None, name=None
    ):
        """Update User target"""
    ...
    async def delete_target(self, user_id, target_id):
        """Delete user target"""
    ...
    async def create_token(self, user_id, length=None, expire=None):
        """Create token"""
    ...
    async def update_email_verification(self, user_id, email_verification):
    ...
    async def update_phone_verification(self, user_id, phone_verification):
