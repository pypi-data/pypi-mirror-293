...
class AsyncFunctions(AsyncService):
    ...
    def __init__(self, client: AsyncClient):
        super(AsyncFunctions, self).__init__(client)
    ...
    async def list_specifications(self):
    ...
    async def delete(self, function_id):
        """Delete function"""
    ...
    async def list_deployments(self, function_id, queries=None, search=None):
        """List deployments"""
    ...
    async def create_deployment(
        ...
        return self.client.chunked_upload(
            api_path,
            {
    ...
    async def get_deployment(self, function_id, deployment_id):
        """Get deployment"""
    ...
    async def update_deployment(self, function_id, deployment_id):
        """Update deployment"""
    ...
    async def delete_deployment(self, function_id, deployment_id):
        """Delete deployment"""
    ...
    async def create_build(self, function_id, deployment_id, build_id=None):
        """Rebuild deployment"""
    ...
    async def update_deployment_build(self, function_id, deployment_id):
        """Cancel deployment"""
    ...
    async def get_deployment_download(self, function_id, deployment_id):
        """Download deployment"""
    ...
    async def list_executions(self, function_id, queries=None, search=None):
        """List executions"""
    ...
    async def get_execution(self, function_id, execution_id):
        """Get execution"""
    ...
    async def delete_execution(self, function_id, execution_id):
        """Delete execution"""
    ...
    async def list_variables(self, function_id):
        """List variables"""
    ...
    async def create_variable(self, function_id, key, value):
        """Create variable"""
    ...
    async def get_variable(self, function_id, variable_id):
        """Get variable"""
    ...
    async def update_variable(self, function_id, variable_id, key, value=None):
        """Update variable"""
    ...
    async def delete_variable(self, function_id, variable_id):
        """Delete variable"""
