...
class InstructionManager:
    ...
    def add_instructions(self,all_true:bool=False)->None:
        ...
        if len(self.instructions)==0:
            ...
            last_instructions = {'instruction_display':instruction_display,'instructions_bools':instruction_bools,"instructions_text_values":instructions_text_values,"text":instructions_text}
        else:
    ...
    def update_instructions(self,instruction_number:int,**kwargs)->None:
        ...
        self.instructions[instruction_number]={'instruction_display':instruction_display,'instructions_bools':instruction_bools,"instructions_text_values":instructions_text_values,"text":instructions_text}
