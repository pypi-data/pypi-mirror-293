...
class Embedding(ABC):
    ...
    def create_embedding(self, texts: Union[str, List[str]]) -> List[List[float]]:
        """
        ...
        return self._create_embedding(texts=texts)
    ...
    async def acreate_embedding(
        ...
        return await run_async(lambda: self.create_embedding(texts=texts))
