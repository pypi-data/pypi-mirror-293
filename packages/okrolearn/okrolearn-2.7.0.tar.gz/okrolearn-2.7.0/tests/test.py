...
losses = network.train(inputs, targets, epochs=5, lr_scheduler=LearningRateScheduler(0.1), optimizer=optimizer, batch_size=10, loss_function=loss_function)
