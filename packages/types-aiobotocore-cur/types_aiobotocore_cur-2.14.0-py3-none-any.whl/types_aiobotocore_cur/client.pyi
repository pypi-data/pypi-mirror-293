...
class CostandUsageReportServiceClient(AioBaseClient):
    ...
    async def tag_resource(self, *, ReportName: str, Tags: Sequence[TagTypeDef]) -> Dict[str, Any]:
        """
    ...
    async def untag_resource(self, *, ReportName: str, TagKeys: Sequence[str]) -> Dict[str, Any]:
        """
