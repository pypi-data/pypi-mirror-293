...
def change_edge_between_task_nodes(node1,node2):
    ...
    property2 = f'{{last_block: "{node2["last_block"]}", level: "{node1["level"]}", name: "{node2["name"]}", parent_task: "{node2["parent_task"]}", task_id: "{node2["task_id"]}", status: "{node2["status"]}", block_identifier: "{node2["block_identifier"]}"}}'
