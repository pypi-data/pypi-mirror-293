...
class IERC4626HyperdriveDeployerCoordinatorDeployHyperdriveContractFunction(
    ...
    def __call__(self, deploymentId: bytes, name: str, deployConfig: PoolDeployConfig, extraData: bytes, salt: bytes) -> IERC4626HyperdriveDeployerCoordinatorDeployHyperdriveContractFunction:  # type: ignore
        clone = super().__call__(
...
class IERC4626HyperdriveDeployerCoordinatorDeployTargetContractFunction(
    ...
    def __call__(self, deploymentId: bytes, deployConfig: PoolDeployConfig, extraData: bytes, targetIndex: int, salt: bytes) -> IERC4626HyperdriveDeployerCoordinatorDeployTargetContractFunction:  # type: ignore
        clone = super().__call__(
            dataclass_to_tuple(deploymentId),
            dataclass_to_tuple(deployConfig),
            dataclass_to_tuple(extraData),
...
class IERC4626HyperdriveDeployerCoordinatorInitializeContractFunction(
    ...
    def __call__(self, deploymentId: bytes, lp: str, contribution: int, apr: int, options: Options) -> IERC4626HyperdriveDeployerCoordinatorInitializeContractFunction:  # type: ignore
        clone = super().__call__(
            dataclass_to_tuple(deploymentId),
...
# pylint: disable=line-too-long
ierc4626hyperdrivedeployercoordinator_bytecode = HexStr("0x")
...
class IERC4626HyperdriveDeployerCoordinatorContract(Contract):
    ...
    bytecode: bytes | None = try_bytecode_hexbytes(
        ierc4626hyperdrivedeployercoordinator_bytecode,
