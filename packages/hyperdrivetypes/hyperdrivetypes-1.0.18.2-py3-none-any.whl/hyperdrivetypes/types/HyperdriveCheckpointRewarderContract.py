...
class HyperdriveCheckpointRewarderContractFunctions(ContractFunctions):
    ...
    def __init__(
        ...
        self.claimCheckpointReward = HyperdriveCheckpointRewarderClaimCheckpointRewardContractFunction.factory(
            ...
            address=address,
            decode_tuples=decode_tuples,
            function_identifier="claimCheckpointReward",
        )
        ...
        self.subrewarder = (
            HyperdriveCheckpointRewarderSubrewarderContractFunction.factory(
                ...
                address=address,
                decode_tuples=decode_tuples,
                function_identifier="subrewarder",
            )
        )
        self.updateAdmin = (
        ...
        self.updateSubrewarder = HyperdriveCheckpointRewarderUpdateSubrewarderContractFunction.factory(
            ...
            address=address,
            decode_tuples=decode_tuples,
            function_identifier="updateSubrewarder",
        )
        self.version = (
...
class HyperdriveCheckpointRewarderAdminUpdatedContractEvent(ContractEvent):
    ...
    def get_logs(  # type: ignore
        self: "HyperdriveCheckpointRewarderAdminUpdatedContractEvent",
    ...
    @classmethod
    def get_logs(  # type: ignore
        cls: Type["HyperdriveCheckpointRewarderAdminUpdatedContractEvent"],
        argument_filters: dict[str, Any] | None = None,
        fromBlock: BlockIdentifier | None = None,
        toBlock: BlockIdentifier | None = None,
        block_hash: HexBytes | None = None,
...
class HyperdriveCheckpointRewarderCheckpointRewardClaimedContractEvent(
    ...
    def get_logs(  # type: ignore
        self: "HyperdriveCheckpointRewarderCheckpointRewardClaimedContractEvent",
        argument_filters: dict[str, Any] | None = None,
        fromBlock: BlockIdentifier | None = None,
        toBlock: BlockIdentifier | None = None,
        block_hash: HexBytes | None = None,
...
class HyperdriveCheckpointRewarderSubrewarderUpdatedContractEvent(
    ...
    def get_logs(  # type: ignore
        self: "HyperdriveCheckpointRewarderSubrewarderUpdatedContractEvent",
        argument_filters: dict[str, Any] | None = None,
        fromBlock: BlockIdentifier | None = None,
        toBlock: BlockIdentifier | None = None,
        block_hash: HexBytes | None = None,
...
class HyperdriveCheckpointRewarderContractEvents(ContractEvents):
    ...
    def __init__(
        ...
        self.AdminUpdated = cast(
            HyperdriveCheckpointRewarderAdminUpdatedContractEvent,
...
class HyperdriveCheckpointRewarderUnauthorizedContractError:
    ...
    @classmethod
    def decode_error_data(  # type: ignore
        cls: Type["HyperdriveCheckpointRewarderUnauthorizedContractError"],
        data: HexBytes,
    ) -> tuple[Any, ...]:
        """Decodes error data returns from a smart contract."""
        error_abi = cast(
...
# pylint: disable=line-too-long
hyperdrivecheckpointrewarder_bytecode = HexStr(
    ""
)
...
class HyperdriveCheckpointRewarderContract(Contract):
    ...
    bytecode: bytes | None = try_bytecode_hexbytes(
        hyperdrivecheckpointrewarder_bytecode, "hyperdrivecheckpointrewarder"
    )
