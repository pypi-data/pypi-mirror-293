...
class MockSafeCastUnsafeCastToInt128ContractError:
    ...
    @classmethod
    def decode_error_data(  # type: ignore
        cls: Type["MockSafeCastUnsafeCastToInt128ContractError"],
        data: HexBytes,
    ) -> tuple[Any, ...]:
        """Decodes error data returns from a smart contract."""
        error_abi = cast(
...
class MockSafeCastUnsafeCastToInt256ContractError:
    ...
    @classmethod
    def decode_error_data(  # type: ignore
        cls: Type["MockSafeCastUnsafeCastToInt256ContractError"],
        data: HexBytes,
    ) -> tuple[Any, ...]:
        """Decodes error data returns from a smart contract."""
        error_abi = cast(
...
class MockSafeCastUnsafeCastToUint112ContractError:
    ...
    @classmethod
    def decode_error_data(  # type: ignore
        cls: Type["MockSafeCastUnsafeCastToUint112ContractError"],
        data: HexBytes,
    ) -> tuple[Any, ...]:
        """Decodes error data returns from a smart contract."""
        error_abi = cast(
...
class MockSafeCastUnsafeCastToUint128ContractError:
    ...
    @classmethod
    def decode_error_data(  # type: ignore
        cls: Type["MockSafeCastUnsafeCastToUint128ContractError"],
        data: HexBytes,
    ) -> tuple[Any, ...]:
        """Decodes error data returns from a smart contract."""
        error_abi = cast(
...
class MockSafeCastUnsafeCastToUint256ContractError:
    ...
    @classmethod
    def decode_error_data(  # type: ignore
        cls: Type["MockSafeCastUnsafeCastToUint256ContractError"],
        data: HexBytes,
    ) -> tuple[Any, ...]:
        """Decodes error data returns from a smart contract."""
        error_abi = cast(
...
# pylint: disable=line-too-long
mocksafecast_bytecode = HexStr(
    ""
)
...
class MockSafeCastContract(Contract):
    ...
    bytecode: bytes | None = try_bytecode_hexbytes(
        mocksafecast_bytecode, "mocksafecast"
    )
