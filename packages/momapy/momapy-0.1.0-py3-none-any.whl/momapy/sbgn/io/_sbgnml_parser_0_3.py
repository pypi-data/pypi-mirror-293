...
class Map(Sbgnbase):
    ...
    :ivar language: <p xmlns=""> Language of the map: one of three
        ...
        This attribute is deprecated in favor of the version attribute.
        </p>
    :ivar version: <p xmlns=""> Version of the map: one of three
        sublanguages defined by SBGN. Different languages have different
        restrictions on the usage of sub-elements (that are not encoded
        in this schema but must be validated with an external validator)
        </p>
...
class Sbgn(Sbgnbase):
    ...
    Each document can contain multiple map elements. </p>
    """
    class Meta:
        name = "sbgn"
        namespace = "http://sbgn.org/libsbgn/0.3"
