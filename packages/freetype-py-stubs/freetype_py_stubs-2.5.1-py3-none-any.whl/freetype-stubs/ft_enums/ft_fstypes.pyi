...
FT_FSTYPES: dict[str, int]

ft_fstype_installable_embedding = FT_FSTYPE_INSTALLABLE_EMBEDDING = 0x0000
ft_fstype_restricted_license_embedding = FT_FSTYPE_RESTRICTED_LICENSE_EMBEDDING = 0x0002
ft_fstype_preview_and_print_embedding = FT_FSTYPE_PREVIEW_AND_PRINT_EMBEDDING = 0x0004
ft_fstype_editable_embedding = FT_FSTYPE_EDITABLE_EMBEDDING = 0x0008
ft_fstype_no_subsetting = FT_FSTYPE_NO_SUBSETTING = 0x0100
ft_fstype_bitmap_embedding_only = FT_FSTYPE_BITMAP_EMBEDDING_ONLY = 0x0200
