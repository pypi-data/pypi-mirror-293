...
FT_CURVE_TAGS: dict[str, int]

FT_Curve_Tag_On     = FT_CURVE_TAG_ON     = 1
FT_Curve_Tag_Conic  = FT_CURVE_TAG_CONIC  = 0
FT_Curve_Tag_Cubic  = FT_CURVE_TAG_CUBIC  = 2

def FT_CURVE_TAG(flag: int) -> int:
    ...
