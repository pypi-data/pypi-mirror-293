...
def _FT_ENC_TAG(a: str, b: str, c: str, d: str) -> _FtEncTag:
    ...

FT_ENCODING_NONE: _FtEncTag
FT_ENCODING_MS_SYMBOL: _FtEncTag
FT_ENCODING_UNICODE: _FtEncTag
FT_ENCODING_SJIS: _FtEncTag
FT_ENCODING_PRC: _FtEncTag
FT_ENCODING_BIG5: _FtEncTag
FT_ENCODING_WANSUNG: _FtEncTag
FT_ENCODING_JOHAB: _FtEncTag
FT_ENCODING_ADOBE_STANDARD: _FtEncTag
FT_ENCODING_ADOBE_EXPERT: _FtEncTag
FT_ENCODING_ADOBE_CUSTOM: _FtEncTag
FT_ENCODING_ADOBE_LATIN1: _FtEncTag
FT_ENCODING_OLD_LATIN2: _FtEncTag
FT_ENCODING_APPLE_ROMAN: _FtEncTag

FT_ENCODINGS: dict[str, _FtEncTag]
