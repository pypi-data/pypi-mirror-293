...
from sqlalchemy import MetaData, create_engine, types, text
...
def migrate(database_recipient, database_recipient_schema='public', sqlAlchemy_schema=None, create_triggers=False, init_data=False, generate_api=False):
    try:
...
def create_trigger_functionality_need_permission(database_recipient, database_recipient_schema):
    try:
        database_recipient.execute(f"""
        ...
        print("ERROR: Migrate database -> create_trigger_functionality_need_permission: " + str(e))
...
def create_postgres_trigger_permission(database_recipient, database_recipient_schema):
    try:
        ...
        print("ERROR: Migrate database -> create_postgres_trigger_permission: " + str(e))


def create_postgres_trigger_permission_admin(database_recipient, database_recipient_schema):
    try:
        database_recipient.execute(f"""
        ...
        print(
            "ERROR: Migrate database -> create_postgres_trigger_permission_admin: " + str(e))


def create_postgres_trigger_funtionality_need_permission(database_recipient, database_recipient_schema):
    try:
        database_recipient.execute(f"""
        ...
        print("ERROR: Migrate database -> create_postgres_trigger_funtionality_need_permission: " + str(e))
