...
def generate(
    ...
    try:
        ...
        user_file_name = St.text_to_snake(c.API_USER)
        role_file_name = St.text_to_snake(c.API_ROLE)
        funtionality_file_name = St.text_to_snake(c.API_FUNTIONALITY)
        conn_file_name = St.text_to_snake(c.API_CONNECTION)
        login_file_name = St.text_to_snake(c.API_LOGIN)
        ...
        if file_name in [
            ...
            replace_list = [
                ...
                (c.API_ROLE_CLASS_KEY, St.text_to_pascal(c.API_ROLE)),
                (c.API_SCOPE_CLASS_KEY, St.text_to_pascal(c.API_SCOPE)),
                (c.API_CONNECTION_CLASS_KEY, St.text_to_pascal(c.API_CONNECTION)),
                (c.API_LOGIN_CLASS_KEY, St.text_to_pascal(c.API_LOGIN)),
                (
                    c.API_AUDIT_REQUEST_NOT_LOGGED_CLASS_KEY,
                    St.text_to_pascal(c.API_AUDIT_REQUEST_NOT_LOGGED),
                ),
                (
                    c.API_FUNTIONALITY_PERMISSION_KEY,
                    St.text_to_snake(c.API_FUNTIONALITY_PERMISSION),
                ),
                (c.API_ROLE_PERMISSION_KEY, St.text_to_snake(c.API_ROLE_PERMISSION)),
                (c.API_ROLE_SCOPE_KEY, St.text_to_snake(c.API_ROLE_SCOPE)),
                (c.API_PERMISSION_KEY, St.text_to_snake(c.API_PERMISSION)),
                (c.API_USER_SCOPE_KEY, St.text_to_snake(c.API_USER_SCOPE)),
                (c.API_CONNECTION_KEY, St.text_to_snake(c.API_CONNECTION)),
                (c.API_LOGIN_KEY, St.text_to_snake(c.API_LOGIN)),
                (
                    c.API_AUDIT_REQUEST_NOT_LOGGED_KEY,
                    St.text_to_snake(c.API_AUDIT_REQUEST_NOT_LOGGED),
                ),
            ]
