...
class TokenValidation:
    ...
    def user_email(self) -> str:
        ...
        try:
            self.email = self.kuznechik.decrypt(self.email)

        except ValueError as e:
            raise TokenError(detail=str(e.args), status_code=400) from e
    ...
    def short_name_student(self) -> str:
        ...
        try:
            self.token_short_name_student = self.kuznechik.decrypt(self.token_short_name_student)
