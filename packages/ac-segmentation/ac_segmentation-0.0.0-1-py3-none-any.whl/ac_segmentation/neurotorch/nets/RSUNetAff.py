...
import ac_segmentation.neurotorch.nets.layers as layers
from ac_segmentation.neurotorch.nets.netcollector import NetCollector
...
class RSUNetAff(nn.Module):
    """ Full model """

    def __init__(self, D_in=1, output_spec=OrderedDict(aff=3),
...
NetCollector().add_module(RSUNetAff(), "RSUNetAff")
