...
from silverriver.utils.remote_browser import connect_to_local_session

T = TypeVar('T', bound=pydantic.BaseModel)
BASE_URL = "http://crux.silverstream.ai:31337"
...
class HTTPCruxClient(httpx.Client):
    ...
    def env_setup(self, start_url: str) -> SetupOutput:
        ...
        page = connect_to_local_session(**setup_out.exec_context_params)
