...
from sqlalchemy.testing.provision import prepare_for_drop_tables
from sqlalchemy.testing.provision import set_default_schema_on_connection
from sqlalchemy.testing.provision import temp_table_keyword_args


@create_db.for_db("greenplum")
...
@temp_table_keyword_args.for_db("greenplum")
def _postgresql_temp_table_keyword_args(cfg, eng):
    return {"prefixes": ["TEMPORARY"]}


@set_default_schema_on_connection.for_db("greenplum")
...
@drop_all_schema_objects_pre_tables.for_db("greenplum")
...
@drop_all_schema_objects_post_tables.for_db("greenplum")
