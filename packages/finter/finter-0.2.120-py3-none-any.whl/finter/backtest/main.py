...
class Simulator:
    def __init__(self, start, end):
        ...
        self.data_handler = DataHandler(start, end_dt_int, cache_timeout=300)
    ...
    def run(
        ...
        print(initial_cash, buy_fee_tax, sell_fee_tax, slippage)

        default_benchmark = defaults.get("default_benchmark")
...
if __name__ == "__main__":
    ...
    res = s.run(
        "kr_stock", s.data_handler.load("alpha.krx.krx.stock.ldh0127.div_new_1")
    )
    res.summary
