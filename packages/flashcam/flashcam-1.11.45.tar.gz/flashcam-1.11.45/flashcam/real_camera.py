...
class Camera(BaseCamera):
    ...
    def frames( ):
        ...
        for i in range(1, MAX_WIDGETS):
            mywidgets.append( widget(i,pos=(widg_tail, widg_bias + (i - 1)* widg_skip ), typ = "dial", radius=widg_radi) )
        mywidgets.append( widget(MAX_WIDGETS ,pos=(widg_trail, widg_bias + (i - 1)* widg_skip ), typ = "sub", radius=widg_radi) )
