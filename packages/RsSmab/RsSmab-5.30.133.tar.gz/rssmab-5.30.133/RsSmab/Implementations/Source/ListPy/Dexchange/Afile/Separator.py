...
class SeparatorCls:
	...
	def get_decimal(self) -> enums.DecimalSeparator:
		...
		Snippet: value: enums.DecimalSeparator = driver.source.listPy.dexchange.afile.separator.get_decimal() \n
	...
	def set_decimal(self, decimal: enums.DecimalSeparator) -> None:
		"""SCPI: [SOURce<HW>]:LIST:DEXChange:AFILe:SEParator:DECimal \n
		Snippet: driver.source.listPy.dexchange.afile.separator.set_decimal(decimal = enums.DecimalSeparator.COMMa) \n
		Sets '.' (decimal point) or ',' (comma) as the decimal separator used in the ASCII data with floating-point numerals. \n
