...
class SchemasClient(AioBaseClient):
    ...
    async def delete_discoverer(self, *, DiscovererId: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    async def delete_registry(self, *, RegistryName: str) -> EmptyResponseMetadataTypeDef:
        """
        Deletes a Registry.
    ...
    async def delete_schema(
        self, *, RegistryName: str, SchemaName: str
    ) -> EmptyResponseMetadataTypeDef:
        """
