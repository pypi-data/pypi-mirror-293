...
class BTCTransactionCollector:
    """
    A class for collecting and analyzing Bitcoin transactions using Blockchair's database dumps.

    This class provides functionality to download, process, and analyze Bitcoin transaction data
    ...
    def __init__(self, output_file: str = 'bitcoin_transactions.csv', 
                 checkpoint_file: str = 'checkpoint.json',
                 api_url: str = None):
        """
        Initialize the BTCTransactionCollector.
