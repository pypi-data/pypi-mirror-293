...
setuptools.setup(
    name='pollination-abnt-nbr-15575-daylight',                                    # will be used for package name unless it is overwritten using __queenbee__ info.
    ...
    keywords='honeybee, radiance, abnt, nbr, 15575, daylight, illuminance',  # will be used as keywords
