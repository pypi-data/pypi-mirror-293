...
def create_component_from_func(
    ...
    Args:
        ...
        base_image (str, optional): The base image to use. Defaults to "hiroregistry/cogflow:latest".
...
def cogcomponent(
    ...
    Args:
        ...
        base_image (str, optional): Base Docker image for the component. Defaults to "hiroregistry/cogflow:latest".
...
def log_artifact(local_path: str, artifact_path: Optional[str] = None):
    ...
    """
    return MlflowPlugin().log_artifact(local_path=local_path, artifact_path=artifact_path)
