...
def cogcomponent(
    output_component_file=None, base_image=None, packages_to_install=None
):
    """
    Decorator to create a Kubeflow component from a function.
    ...
    def decorator(func):
        component = KubeflowPlugin().create_component_from_func(
            func=func,
            output_component_file=output_component_file,
            base_image=base_image,
            packages_to_install=packages_to_install
