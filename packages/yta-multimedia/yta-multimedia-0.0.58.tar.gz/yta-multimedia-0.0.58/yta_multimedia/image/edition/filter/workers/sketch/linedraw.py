from yta_multimedia.image.edition.filter.workers.sketch.filters import *
from  yta_multimedia.image.edition.filter.workers.sketch.strokesort import *
from  yta_multimedia.image.edition.filter.workers.sketch.util import *
from random import *
from PIL import Image, ImageDraw, ImageOps

import  yta_multimedia.image.edition.filter.workers.sketch.perlin as perlin
...
def apply_line_sketch_to_image(image_filename: str, output_filename: str):
    # TODO: If this is for internal use we don't need 'output_filename'
    if not image_filename:
        raise Exception('No "image_filename" provided.')
