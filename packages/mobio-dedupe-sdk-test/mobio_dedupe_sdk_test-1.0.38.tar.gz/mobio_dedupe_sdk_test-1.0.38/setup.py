...
class Requirements(object):
    ...
    def get():
        ...
        requirements = ['m-singleton', 'asv', 'black', 'coverage[toml]', 'coveralls', 'flake8', 'mock', 'mypy',
                        ...
                        'pycodestyle==2.9.1', 'pycparser==2.21', 'pyflakes==2.5.0', 'pyhacrf-datamade==0.2.8',
...
version_dev='1.0.38'  # Giữ nguyên định dạng không được format file có khoảng trống theo Pycharm (version_dev = '1.0.9' là file run.sh sẽ không bắt được current_version)
...
setup(
    ...
    version='1.0.38',  # Required, Phần này cũng không được format file.
