...
class TestDownload(unittest.TestCase):
    ...
    def test_download_and_save_multinode(self, mock_get, mock_home):
        ...
        with tempfile.TemporaryDirectory() as tmp_directory:
            ...
            download_and_save_multinode('developer.cloud.io', Path(tmp_directory), True, False)
    ...
    def test_download_and_save_multinode_failed_file_exists(self, mock_home):
        with tempfile.TemporaryDirectory() as tmp_directory:
            ...
            self.assertRaises(
                AosProvError,
                download_and_save_multinode, 'developer.cloud.io', Path(tmp_directory), False, False,
            )
