...
class GptDriver:
    ...
    def __init__(self,
        ...
        self._http_handler = MiddleLayerRequestsHandler()
    ...
    def _create_gpt_driver_session(self):
        ...
        gpt_driver_session_response = self._http_handler.post(
            f"create",
            json={
    ...
    def stop_session(self, status: Literal["failed", "success"]):
        ...
        self._http_handler.delete(f"{self._appium_session_config.server_url}/sessions/{self._appium_session_config.id}")
