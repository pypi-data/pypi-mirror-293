...
class ACMClient(AioBaseClient):
    ...
    async def delete_certificate(self, *, CertificateArn: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    async def renew_certificate(self, *, CertificateArn: str) -> EmptyResponseMetadataTypeDef:
        """
