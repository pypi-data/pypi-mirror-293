...
def get_args() -> Namespace:
    parser: ArgumentParser = ArgumentParser(
        "AirTk CLI Interface",
        description="Run adversarial training experiments.",
    )
    parser.add_argument(
        "training_method",
        type=str,
    ...
    parser.add_argument("--learning-rate", "-lr", type=float, default=0.9)
...
def main() -> None:
    ...
    if args.training_method == "adt":
        ...
        FeatureScatterTraining(
            args.dataset,
            10 if args.dataset in {"cifar10", "mnist"} else 100,
            epochs=args.epochs,
            lr=args.learning_rate,
            model_dir=args.out_dir,
        )()
        ...
        YopoTraining(
            args.dataset, model_dir=args.out_dir, epochs=args.epochs
        )()
