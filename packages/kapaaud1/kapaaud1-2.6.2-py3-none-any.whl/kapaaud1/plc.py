...
IF "shou3".DONE THEN
    ...
    ELSIF "cc视觉".u_data[0] = 'sj_plc_wz' THEN
        "发送"(buf := 'plc_tx_wz',
             num := 2);
    ELSIF "cc视觉".u_data[0] = 'sj_plc_bd_x' THEN
        //"aa语音".new_str := CONCAT_STRING(IN1:='bd_x',IN2:= "cc视觉".u_data[1]);
        "发送"(buf := CONCAT_STRING(IN1:='bd_x',IN2:= "cc视觉".u_data[1]),
             num := 4);
    ELSIF "cc视觉".u_data[0] = 'sj_plc_bd_y' THEN
        "发送"(buf := CONCAT_STRING(IN1 := 'bd_y', IN2 := "cc视觉".u_data[1]),
             num := 4);
    END_IF;
END_IF;
———————————————————————
IF "shou4".DONE THEN
    ...
    ELSIF "dd机器人".u_data[0] = 'jqr_plc_sz' THEN
        "发送"(buf := 'plc_sj_sz',
             num := 3);
    ELSIF "dd机器人".u_data[0] = 'jqr_plc_sz_again' THEN
        IF "jishu_sz" < 2 THEN
            "发送"(buf := 'qsz_02',
                 num := 4);
