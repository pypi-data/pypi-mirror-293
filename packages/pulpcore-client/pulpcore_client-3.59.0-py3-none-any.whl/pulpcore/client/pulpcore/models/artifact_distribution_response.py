...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, pulp_href=None, base_path=None, base_url=None, pulp_created=None, hidden=False, content_guard=None, pulp_last_updated=None, name=None, no_content_change_since=None, local_vars_configuration=None):  # noqa: E501
