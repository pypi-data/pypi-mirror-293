...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, pulp_href=None, pulp_created=None, hidden=False, pulp_labels=None, base_url=None, base_path=None, name=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
