...
setup_config = {
    ...
    "python_requires" : '>=3.8',
    "install_requires": ['roboto==0.7.0', 'pytest', 'mcap', 'genson', 'pandas','Pillow', 'mcap', 'mcap-protobuf-support', 'foxglove_schemas_protobuf', 'rosbags', 'mcap-ros2-support', 'rosbags-image'],
}
