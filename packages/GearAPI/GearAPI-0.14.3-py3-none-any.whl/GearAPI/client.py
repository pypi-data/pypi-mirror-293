...
"""
import pandas as pd
from exceptions import DeviceListFilteringError
from typing import Union,List
from resource import events_resource, inventory_resource, measurements_resource
...
class Client:
    ...
    # def stream_measurements(self,id:str)->None:
    #     df = self.devices_list
    #     if df.loc[df['id'] == id,'resource_endpoint'].values != 'measurement/measurements':
    #         raise ValueError('Device is not a measurement device')

    #     self.measurements.stream_measurements(id)
