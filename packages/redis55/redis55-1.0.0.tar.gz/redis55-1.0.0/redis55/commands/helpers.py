...
import redis55
from redis55.typing import KeysT, KeyT
...
def get_protocol_version(client):
    if isinstance(client, redis55.Redis) or isinstance(client, redis55.asyncio.Redis):
        return client.connection_pool.connection_kwargs.get("protocol")
    elif isinstance(client, redis55.cluster.AbstractRedisCluster):
