...
from redis55.asyncio.lock import Lock
from redis55.asyncio.retry import Retry
from redis55.client import (
    EMPTY_RESPONSE,
    NEVER_DECODE,
    AbstractRedis,
    CaseInsensitiveDict,
)
from redis55.commands import (
    AsyncCoreCommands,
    AsyncRedisModuleCommands,
    AsyncSentinelCommands,
    list_or_args,
)
from redis55.compat import Protocol, TypedDict
from redis55.credentials import CredentialProvider
...
from redis55.typing import ChannelT, EncodableT, KeyT
...
if TYPE_CHECKING:
    from redis55.commands.core import Script
...
class Redis(
    ...
    Connection object to talk to redis5.
    """
    ...
    def __init__(
        ...
        *,
        ...
        lib_name: Optional[str] = "redis5-py",
    ...
    def load_external_module(self, funcname, func):
        ...
        ex: Assume that one has a custom redis5 module named foomod that
        creates command named 'foo.dothing' and 'foo.anotherthing' in redis5.
...
class PubSub:
    ...
    HEALTH_CHECK_MESSAGE = "redis5-py-health-check"
    ...
    async def run(
        ...
        *,
        ...
        This is the equivalent of :py:meth:`redis5.PubSub.run_in_thread` in
        redis5-py, but it is a coroutine. To launch it as a separate task, use
        ``asyncio.create_task``:
