...
from redis55._parsers import _AsyncHiredisParser, _AsyncRESP2Parser
from redis55.asyncio.client import Monitor
from redis55.asyncio.connection import parse_url
...
async def create_redis(request):
    """Wrapper around redis55.create_redis."""
...
def redis_url(request):
    return request.config.getoption("--redis55-url")
