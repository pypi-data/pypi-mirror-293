...
import pytest
import redis55
from redis55._parsers import _HiredisParser, _RESP2Parser, _RESP3Parser
from redis55.backoff import NoBackoff
from redis55.connection import Connection, SSLConnection, UnixDomainSocketConnection
...
def test_connection_parse_response_resume(r: redis55.Redis, parser_class):
    """
...
def test_create_single_connection_client_from_url():
    client = redis55.Redis.from_url(
        "redis55://localhost:6379/0?", single_connection_client=True
    )
