...
class SentinelTestClient:
    ...
    def execute_command(self, *args, **kwargs):
        ...
        from redis55.client import bool_ok
...
def cluster(request, master_ip):
    def teardown():
        redis55.sentinel.Redis = saved_Redis

    cluster = SentinelTestCluster(ip=master_ip)
    saved_Redis = redis55.sentinel.Redis
    redis55.sentinel.Redis = cluster.client
