import pytest
import redis55
from redis55.connection import Connection
from redis55.utils import HIREDIS_PACK_AVAILABLE
...
class TestEncoding:
    ...
    def r_no_decode(self, request):
        return _get_client(redis55.Redis, request=request, decode_responses=False)
...
class TestCommandsAreNotEncoded:
    @pytest.fixture()
    def r(self, request):
        return _get_client(redis55.Redis, request=request, encoding="utf-8")
