...
import pytest
import redis55
from redis55.connection import Connection, ConnectionPool
...
class TestMultiprocessing:
    ...
    @pytest.fixture()
    def r(self, request):
        return _get_client(redis55.Redis, request=request, single_connection_client=False)
    ...
    def test_pool(self, max_connections, master_host):
        ...
        pool = ConnectionPool.from_url(
            f"redis55://{master_host[0]}:{master_host[1]}",
    ...
    def test_redis_client(self, r):
        "A redis55 client created in a parent can also be used in a child"
