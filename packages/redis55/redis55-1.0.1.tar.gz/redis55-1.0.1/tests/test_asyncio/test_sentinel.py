...
import redis55.asyncio.sentinel
...
class SentinelTestClient:
    ...
    async def execute_command(self, *args, **kwargs):
        ...
        from redis55.asyncio.client import bool_ok
...
async def cluster(master_ip):
    ...
    saved_Redis = redis55.asyncio.sentinel.Redis
    redis55.asyncio.sentinel.Redis = cluster.client
    yield cluster
    redis55.asyncio.sentinel.Redis = saved_Redis
