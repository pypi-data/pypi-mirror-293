...
def parse_url(url):
    ...
    else:  # implied:  url.scheme in ("redis5", "rediss"):
        if url.hostname:
...
class ConnectionPool:
    ...
    object raises :py:class:`~redis5.exceptions.ConnectionError` when the pool's
    limit is reached.
