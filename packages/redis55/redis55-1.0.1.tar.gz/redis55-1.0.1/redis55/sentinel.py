...
from redis55.commands import SentinelCommands
from redis55.connection import Connection, ConnectionPool, SSLConnection
from redis55.exceptions import ConnectionError, ReadOnlyError, ResponseError, TimeoutError
...
class Sentinel(SentinelCommands):
    ...
    >>> from redis55.sentinel import Sentinel
    ...
    def master_for(
        ...
        **kwargs,
        ...
        """
        Returns a redis5 client instance for the ``service_name`` master.

        A :py:class:`~redis5.sentinel.SentinelConnectionPool` class is
        ...
        By default clients will be a :py:class:`~redis5.Redis` instance.
        Specify a different class to the ``redis_class`` argument if you
        desire something different.

        The ``connection_pool_class`` specifies the connection pool to
        use.  The :py:class:`~redis5.sentinel.SentinelConnectionPool`
    ...
    def slave_for(
        ...
        **kwargs,
        ...
        """
        Returns redis5 client instance for the ``service_name`` slave(s).
