...
from redis55.exceptions import RedisError, ResponseError
from redis55.utils import str_if_bytes

if TYPE_CHECKING:
    from redis55.asyncio.cluster import ClusterNode
...
class AsyncCommandsParser(AbstractCommandsParser):
    ...
    NOTE: Due to a bug in redis5<7.0, this does not work properly
    for EVAL or EVALSHA when the `numkeys` arg is 0.
     - issue: https://github.com/redis/redis/issues/9493
     - fix: https://github.com/redis/redis/pull/9733
