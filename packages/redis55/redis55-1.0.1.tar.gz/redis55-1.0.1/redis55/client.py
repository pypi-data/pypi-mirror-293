...
from redis55.connection import ConnectionPool, SSLConnection, UnixDomainSocketConnection
...
class PubSub:
    ...
    HEALTH_CHECK_MESSAGE = "redis55-py-health-check"
    ...
    def is_health_check_response(self, response):
        ...
        If there are no subscriptions redis5 responds to PING command with a
