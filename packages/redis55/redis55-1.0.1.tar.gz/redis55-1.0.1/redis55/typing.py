...
from redis55.compat import Protocol

if TYPE_CHECKING:
    from redis55._parsers import Encoder
    from redis55.asyncio.connection import ConnectionPool as AsyncConnectionPool
    from redis55.connection import ConnectionPool
...
KeyT = _StringLikeT  # Main redis55 key space
