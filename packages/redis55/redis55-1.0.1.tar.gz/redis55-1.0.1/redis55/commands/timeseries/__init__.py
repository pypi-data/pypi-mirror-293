import redis55
from redis55._parsers.helpers import bool_ok
...
class TimeSeries(TimeSeriesCommands):
    """
    This class subclasses redis5-py's `Redis` and implements RedisTimeSeries's
    ...
    def pipeline(self, transaction=True, shard_hint=None):
        ...
        """
        if isinstance(self.client, redis55.RedisCluster):
            p = ClusterPipeline(
...
class ClusterPipeline(TimeSeriesCommands, redis55.cluster.ClusterPipeline):
    """Cluster pipeline for the module."""


class Pipeline(TimeSeriesCommands, redis55.client.Pipeline):
