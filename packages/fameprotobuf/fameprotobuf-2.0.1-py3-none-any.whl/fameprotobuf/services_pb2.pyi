...
class Output(_message.Message):
    ...
    class AgentType(_message.Message):
        ...
        class Field(_message.Message):
            __slots__ = ("field_id", "field_name", "index_name")
            FIELD_ID_FIELD_NUMBER: _ClassVar[int]
            FIELD_NAME_FIELD_NUMBER: _ClassVar[int]
            INDEX_NAME_FIELD_NUMBER: _ClassVar[int]
            field_id: int
            field_name: str
            index_name: _containers.RepeatedScalarFieldContainer[str]
            def __init__(self, field_id: _Optional[int] = ..., field_name: _Optional[str] = ..., index_name: _Optional[_Iterable[str]] = ...) -> None: ...
