...
def with_firebase_token():
    ...
    _webview_process = subprocess.Popen(["python3", "-c", """
import webview
...
def _login(workspace):
    ...
    if is_refreshed:
        ...
        # for flask server to get google token
        # we need to set it as global variable
        global google_token
