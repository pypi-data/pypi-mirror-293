...
class Mailer:
    def __init__(self, recipient_emails, sender_email, sender_password):
        ...
        return(
            ...
            <html>
              <body>
                ...
                <p>This report includes the revenue data for the {business_unit} business unit for the specified month. The data will also be uploaded to NetSuite for <strong>{period}</strong>. </p>
    ...
    def send_failure_notification(self, missing_mappings, period, business_unit):
        subject = f'{business_unit} NetSuite Pipeline Failure Notification - {period}'
    ...
    def send_success_notification(self, period, business_unit):
        subject = f'{business_unit} NetSuite Pipeline Success Notification - {period}'
