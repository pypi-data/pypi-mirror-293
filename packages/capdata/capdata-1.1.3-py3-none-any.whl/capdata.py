...
def get_std_bond_list(market: List[str], ccy: List[str], bond_mkt_type: List[str], bond_inst_type: List[str],
                      credit_rating: List[str]):
    return data.refer.get_bond_list(market, ccy, bond_mkt_type, bond_inst_type, credit_rating, True)
