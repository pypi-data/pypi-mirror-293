...
class SpotterClient:
    def __init__(self, spotter_api_token, spotter_endpoint, spotter_organization, spotter_project, minimal_fail_level):
    ...
    def on_playbook_start_callback(self):
        # TODO: read actual enironment - this should happen once per scan anyway
    ...
    def set_options(self, task_keys=None, var_options=None, direct=None):
        ...
        try:
            self.client = SpotterClient(
                spotter_api_token, spotter_endpoint, spotter_organization, spotter_project, minimal_fail_level
            )
