...
#   timestamp: 2024-08-21T12:47:51+00:00
#   version: graph_update branch
...
class ErrorDetails1(RootModel[str]):
    root: Annotated[
        str,
        Field(
            description="Error details", min_length=1, title="Error Details"
        ),
    ]
...
class DocumentProcessingDetails(BaseModel):
    ...
    error_details: Annotated[
        Optional[ErrorDetails1],
        Field(None, description="Error details", title="Error Details"),
    ]
...
class DocumentOut(BaseModel):
    ...
    processing_details: Annotated[
        Optional[DocumentProcessingDetails],
        Field(None, description="Processing details"),
    ]
    tags: Annotated[
