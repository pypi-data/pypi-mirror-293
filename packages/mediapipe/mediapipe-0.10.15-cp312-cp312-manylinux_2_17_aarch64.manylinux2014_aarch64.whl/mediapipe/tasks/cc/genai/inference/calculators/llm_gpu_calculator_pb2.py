...
_LLMGPUCALCULATOROPTIONS = DESCRIPTOR.message_types_by_name['LlmGpuCalculatorOptions']
_LLMGPUCALCULATOROPTIONS_GPUMODELINFO = _LLMGPUCALCULATOROPTIONS.nested_types_by_name['GpuModelInfo']
LlmGpuCalculatorOptions = _reflection.GeneratedProtocolMessageType('LlmGpuCalculatorOptions', (_message.Message,), {

  'GpuModelInfo' : _reflection.GeneratedProtocolMessageType('GpuModelInfo', (_message.Message,), {
    'DESCRIPTOR' : _LLMGPUCALCULATOROPTIONS_GPUMODELINFO,
    '__module__' : 'mediapipe.tasks.cc.genai.inference.calculators.llm_gpu_calculator_pb2'
    # @@protoc_insertion_point(class_scope:odml.infra.proto.LlmGpuCalculatorOptions.GpuModelInfo)
    })
  ,
  'DESCRIPTOR' : _LLMGPUCALCULATOROPTIONS,
  '__module__' : 'mediapipe.tasks.cc.genai.inference.calculators.llm_gpu_calculator_pb2'
  # @@protoc_insertion_point(class_scope:odml.infra.proto.LlmGpuCalculatorOptions)
  })
_sym_db.RegisterMessage(LlmGpuCalculatorOptions)
_sym_db.RegisterMessage(LlmGpuCalculatorOptions.GpuModelInfo)

if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'\n\033com.google.odml.infra.protoB\034LlmGpuCalculatorOptionsProto'
  _LLMGPUCALCULATOROPTIONS._serialized_start=282
  _LLMGPUCALCULATOROPTIONS._serialized_end=943
  _LLMGPUCALCULATOROPTIONS_GPUMODELINFO._serialized_start=650
  _LLMGPUCALCULATOROPTIONS_GPUMODELINFO._serialized_end=871
