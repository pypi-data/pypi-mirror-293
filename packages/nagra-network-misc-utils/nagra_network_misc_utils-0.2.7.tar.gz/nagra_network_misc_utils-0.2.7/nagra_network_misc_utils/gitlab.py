...
def getenv(name, *alternative_names) -> Optional[str]:
...
CI_SERVER_URL = getenv("CI_SERVER_URL")
CI_API_URL = getenv("CI_API_V4_URL") or DEFAULT_SERVER
CI_MERGE_REQUEST_PROJECT_ID = getenv("CI_MERGE_REQUEST_PROJECT_ID")
