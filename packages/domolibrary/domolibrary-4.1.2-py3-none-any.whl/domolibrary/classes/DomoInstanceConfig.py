...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 78
@patch_to(DomoInstanceConfig, cls_method=True)
async def get_applications(
    ...
    return [dmapp.DomoApplication._from_json(job, auth = auth) for job in res.response]

# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 81
@patch_to(DomoInstanceConfig)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 89
@patch_to(DomoInstanceConfig)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 91
@patch_to(DomoInstanceConfig)
...
# %% ../../nbs/classes/50_DomoInstanceConfig.ipynb 93
@patch_to(DomoInstanceConfig)
async def regenerate_access_token(
    ...
    access_tokens = (await self.get_access_tokens(session = session, debug_api = debug_api, debug_num_stacks_to_drop = debug_num_stacks_to_drop+1)) or []
    ...
    if match_token:
        await match_token.revoke(session = session , debug_num_stacks_to_drop = debug_num_stacks_to_drop + 1 , debug_api = debug_api)
