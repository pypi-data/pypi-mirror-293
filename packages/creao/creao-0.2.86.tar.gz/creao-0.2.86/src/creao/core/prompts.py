...
Answer format - Generate a json with the following fields, and don't include latex math symbol in the questions.
...
Answer format should be a valid json with the following fields:
