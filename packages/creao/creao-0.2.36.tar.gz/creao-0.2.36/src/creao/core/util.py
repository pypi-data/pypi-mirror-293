...
def submit_pipeline_job(pipeline_name:str, pipe_yaml:str, run_config_template:str, dataset:Dataset):
    """
    ...
    if upload_response.status_code == 200:
        ...
        print("Upload failed with status code:", upload_response.status_code, upload_response.text)
