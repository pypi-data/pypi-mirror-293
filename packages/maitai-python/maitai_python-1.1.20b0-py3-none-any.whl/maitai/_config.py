...
def _get_instance_metadata(url, headers=None, timeout=2):
    try:
...
def _determine_maitai_host():
    ...
    if _get_instance_metadata("http://169.254.169.254/latest/meta-data/placement/region") == "us-west-2":
        return "https://api.aws.us-west-2.trymaitai.ai"
    
    gcp_zone = _get_instance_metadata("http://metadata.google.internal/computeMetadata/v1/instance/zone",
