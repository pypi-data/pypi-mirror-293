...
if (loop_ht == 1): diret2 = diret2 + '/' + dir_loop
#--------------------------------------------------
if os.path.isdir(diret2): 0 == 0
else: os.mkdir(diret2)
#---------------------
...
for i in range(len(files0)):
    ...
    for j in range(len(files1)):
        number += 1 
        shutil.copyfile(dir_files + '/' + dir_o + '/' + files0[i] + '/' + files1[j],  diret2 + '/POSCAR_' + str(number))
    #-------------------------------------------------------
