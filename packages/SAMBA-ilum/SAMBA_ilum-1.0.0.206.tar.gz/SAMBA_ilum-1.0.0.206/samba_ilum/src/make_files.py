...
numero_formatado = f"{numero_aleatorio:.12f}"
file_temp = 'Structures_' + str(numero_formatado)
#------------------------------------------------
shutil.copytree(dir_files + '/Structures', dir_files + '/Structures_Backup')
#---------------------------------------------------------------------------
os.rename(dir_files + '/Structures', dir_files + '/' + file_temp)
os.mkdir(dir_files + '/Structures')

#-------------------------------------------------------------------
correspondence = open(dir_out + '/correspondence.txt', 'w')
#-------------------------------------------------------------------
files = list_files(dir_files + '/' + file_temp)
#----------------------------------------------------

for i in range(len(files)):
    #-------------------------------------------
    Lattice0 = dir_files + '/' + file_temp + '/'
        ...
        if (task[j][:5] != 'bader'):
           ...
           if (dipol != 'none'):
              ...
              if (dipol != 'center_mass'):
                 ...
                 print(center_of_mass[0], center_of_mass[1], center_of_mass[2])
                 #-------------------------------------------------------------
...
os.rename(dir_files + '/' + file_temp, dir_files + '/Structures')
shutil.rmtree(dir_files + '/Structures_Backup')
