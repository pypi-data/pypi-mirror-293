...
for s in range(len(files)):
    #---------------------------- 
    porc = ((s+1)/len(files))*100
    porc = int(porc)
    print(f'Analisando {porc}%') 
    #---------------------------
    cont = 0
    #-------
...
#===================================================================================
# Verificando a existância do diretório de salvamento final das Heteroestruturas ===
#===================================================================================
diret3 = dir_files + '/' + 'output_Structures'
#---------------------------------------------
if os.path.isdir(diret3): 0 == 0
else: os.mkdir(diret3)
#---------------------
if (loop_ht == 1):
   diret3 = diret3 + '/' + dir_loop
   #-------------------------------
   if os.path.isdir(diret3): 0 == 0
   else: os.mkdir(diret3)
#------------------------
...
for i in range(len(files0)):
    ...
    for j in range(len(files1)):
        number += 1 
        shutil.copyfile(dir_files + '/' + dir_o + '/' + files0[i] + '/' + files1[j],  diret3 + '/' + 'POSCAR_' + str(number))
    #-------------------------------------------------------
...
#------------------------------------------
files = os.listdir(dir_files + '/' + dir_o)
