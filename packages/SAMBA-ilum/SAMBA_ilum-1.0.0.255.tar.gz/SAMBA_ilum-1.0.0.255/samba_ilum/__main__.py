...
if (tarefa == 1):
   ...
   if (loop_ht == 1):
      ...
      #---------------------------------------------------------------------
      for nloop in range(len(bilayer_materials)):
          Lattice1 = bilayer_materials[nloop][0]
          Lattice2 = bilayer_materials[nloop][1]
          Lattice3 = ''
          #---------------
          nloop = nloop +1
          ...
          #---------------------------------------------------------------------------------------------------
          try:
              if (fast_mode == 0): exec(open(dir_codes + '/HeteroStructure_Generator_0.py').read())
              if (fast_mode == 1): exec(open(dir_codes + '/HeteroStructure_Generator_1.py').read())
              ...
