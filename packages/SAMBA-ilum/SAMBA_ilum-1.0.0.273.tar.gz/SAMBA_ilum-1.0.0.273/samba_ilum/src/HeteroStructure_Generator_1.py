...
for i in range(len(files)):
    ...
    if (n_Lattice == 3):
       new_name = diret2 + n_ion + '_' + str(mismatch_12) + '_' + angle_12 + '_'  + str(mismatch_13) + '_' + angle_13 + '_'+ str(VTemp1[-1]) + '+' + number
...
#------------------------------------------------------------------------
if os.path.exists(diret2 + 'check_list_ht.txt'): 0 == 0
else:
   check_list = open(diret2 + 'check_list_ht.txt', 'w')
   check_list.close()
#----------------------------------------------------------------------
check_list = open(diret2 + 'check_list_ht.txt', 'a')
