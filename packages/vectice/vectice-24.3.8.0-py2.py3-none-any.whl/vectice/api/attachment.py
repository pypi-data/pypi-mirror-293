...
class AttachmentApi(RestApi):
    ...
    def download_attachment(
        ...
        type = "modelversion" if isinstance(version, ModelVersionRepresentation) else "datasetversion"
        url = self._build_attachment_url(version=version.id, file_type=type)
        ...
        try:
            ...
            self._handle_http_error(e, version, attachment)
