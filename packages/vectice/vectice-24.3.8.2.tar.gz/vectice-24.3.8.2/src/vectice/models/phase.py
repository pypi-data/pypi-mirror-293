...
class Phase:
    ...
    def list_iterations(
        ...
        return self._phase_service.list_iterations(
            phase=self, only_mine=only_mine, statuses=statuses, size=number_of_items
        )
    ...
    def create_iteration(self, name: str | None = None, description: str | None = None) -> Iteration:
        ...
        """
        if name is not None:
            self._client.assert_feature_flag_or_raise("rename-iteration-from-the-api")
        if description is not None:
            self._client.assert_feature_flag_or_raise("iteration-description")
