...
class Project:
    ...
    def list_phases(self) -> list[Phase]:
        ...
        Returns:
            list[Phase]: A list of `Phase` instances corresponding
    ...
    def list_models(self, number_of_models: int = 30) -> list[ModelRepresentation]:
        ...
        Parameters:
            number_of_models: The number of models to retrieve. Defaults to 30.

        Returns:
            list[ModelRepresentation]: A list of `ModelRepresentation` instances corresponding
            to the models in the current project.
        """
        ...
        model_outputs = self._client.get_model_list(project_id=self.id, size=number_of_models)
        model_representations = [ModelRepresentation(model, self._client) for model in model_outputs.list]
        return model_representations

    def list_datasets(self, number_of_datasets: int = 30) -> list[DatasetRepresentation]:
        ...
        Parameters:
            number_of_datasets: The number of datasets to retrieve. Defaults to 30.

        Returns:
            list[DatasetRepresentation]: A list of `DatasetRepresentation` instances corresponding
            to the datasets in the current project.
        """
        if number_of_datasets > 100:
            _logger.warning(
        ...
        dataset_outputs = self._client.get_dataset_list(project_id=self.id, size=number_of_datasets)
