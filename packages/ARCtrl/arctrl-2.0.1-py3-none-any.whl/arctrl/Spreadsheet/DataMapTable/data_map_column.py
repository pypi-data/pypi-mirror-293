...
def to_fs_columns(dc: Array[DataContext]) -> FSharpList[FSharpList[FsCell]]:
    ...
    class ObjectExpr1131:
        ...
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow1130(x: str, y: str) -> bool:
                return x == y
    ...
    comment_keys: FSharpList[str] = to_list(distinct(collect(mapping_1, dc), ObjectExpr1131()))
    ...
    def _arrow1146(__unit: None=None, dc: Any=dc) -> IEnumerable_1[FSharpList[FsCell]]:
        def _arrow1145(__unit: None=None) -> IEnumerable_1[FSharpList[FsCell]]:
            def _arrow1144(dc_4: DataContext) -> FSharpList[FsCell]:
                dc_3: DataContext = dc_4
                def _arrow1143(__unit: None=None) -> IEnumerable_1[FsCell]:
                    def _arrow1136(__unit: None=None) -> FSharpList[FsCell]:
                    ...
                    def _arrow1142(__unit: None=None) -> IEnumerable_1[FsCell]:
                        def _arrow1141(__unit: None=None) -> IEnumerable_1[FsCell]:
                            def _arrow1140(__unit: None=None) -> IEnumerable_1[FsCell]:
                                def _arrow1139(__unit: None=None) -> IEnumerable_1[FsCell]:
                                    def _arrow1138(__unit: None=None) -> IEnumerable_1[FsCell]:
                                        def _arrow1137(__unit: None=None) -> IEnumerable_1[FsCell]:
                                        ...
                                        return append(create_text(DataContext__get_GeneratedBy(dc_3)), delay(_arrow1137))

                                    return append(create_text(DataContext__get_Description(dc_3)), delay(_arrow1138))

                                return append(create_term(DataContext__get_ObjectType(dc_3)), delay(_arrow1139))

                            return append(create_term(DataContext__get_Unit(dc_3)), delay(_arrow1140))

                        return append(create_term(DataContext__get_Explication(dc_3)), delay(_arrow1141))

                    return append(_arrow1136(), delay(_arrow1142))

                return to_list(delay(_arrow1143))

            return map_1(_arrow1144, dc)

        return append(singleton_1(headers), delay(_arrow1145))

    return transpose(to_list(delay(_arrow1146)))
