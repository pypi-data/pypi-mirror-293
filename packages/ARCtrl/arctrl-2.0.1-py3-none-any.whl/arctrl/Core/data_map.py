...
def DataMap__GetExplicationColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow586(dc: DataContext, this: Any=this) -> OntologyAnnotation | None:
        return DataContext__get_Explication(dc)

    return DataMapAux_getOntologyColumn(_arrow586, this.data_contexts_0040108)


def DataMap__SetExplicationColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow587(dc: DataContext, oa: OntologyAnnotation | None=None, this: Any=this, cells: Any=cells) -> None:
        DataContext__set_Explication_279AAFF2(dc, oa)

    DataMapAux_setOntologyColumn(_arrow587, cells, this.data_contexts_0040108)


def DataMap__GetUnitColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow588(dc: DataContext, this: Any=this) -> OntologyAnnotation | None:
        return DataContext__get_Unit(dc)

    return DataMapAux_getOntologyColumn(_arrow588, this.data_contexts_0040108)


def DataMap__SetUnitColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow589(dc: DataContext, oa: OntologyAnnotation | None=None, this: Any=this, cells: Any=cells) -> None:
        DataContext__set_Unit_279AAFF2(dc, oa)

    DataMapAux_setOntologyColumn(_arrow589, cells, this.data_contexts_0040108)


def DataMap__GetObjectTypeColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow590(dc: DataContext, this: Any=this) -> OntologyAnnotation | None:
        return DataContext__get_ObjectType(dc)

    return DataMapAux_getOntologyColumn(_arrow590, this.data_contexts_0040108)


def DataMap__SetDataTypeColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow591(dc: DataContext, oa: OntologyAnnotation | None=None, this: Any=this, cells: Any=cells) -> None:
        DataContext__set_ObjectType_279AAFF2(dc, oa)

    DataMapAux_setOntologyColumn(_arrow591, cells, this.data_contexts_0040108)


def DataMap__GetLabelColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow592(dc: DataContext, this: Any=this) -> str | None:
        return dc.Name

    return DataMapAux_getStringColumn(_arrow592, this.data_contexts_0040108)


def DataMap__SetLabelColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow593(dc: DataContext, s: str | None=None, this: Any=this, cells: Any=cells) -> None:
        dc.Name = s

    DataMapAux_setStringColumn(_arrow593, cells, this.data_contexts_0040108)


def DataMap__GetDescriptionColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow594(dc: DataContext, this: Any=this) -> str | None:
        return DataContext__get_Description(dc)

    return DataMapAux_getStringColumn(_arrow594, this.data_contexts_0040108)


def DataMap__SetDescriptionColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow595(dc: DataContext, s: str | None=None, this: Any=this, cells: Any=cells) -> None:
        DataContext__set_Description_6DFDD678(dc, s)

    DataMapAux_setStringColumn(_arrow595, cells, this.data_contexts_0040108)
...
def DataMap_getDataContext_Z58338566(row: int, SkipValidation: Any | None=None) -> Callable[[DataMap], DataContext]:
    def _arrow596(dm: DataMap, row: Any=row, SkipValidation: Any=SkipValidation) -> DataContext:
