...
class IOType(Union):
    ...
    def as_input(self, __unit: None=None) -> str:
        ...
        def string_create(x: Any | None=None) -> str:
            def _arrow550(__unit: None=None, x: Any=x) -> str:
                copy_of_struct: __A = x
                return to_string(copy_of_struct)

            return ("Input [" + _arrow550()) + "]"
    ...
    def as_output(self, __unit: None=None) -> str:
        this: IOType = self
        def string_create(x: Any | None=None) -> str:
            def _arrow551(__unit: None=None, x: Any=x) -> str:
                copy_of_struct: __A = x
                return to_string(copy_of_struct)

            return ("Output [" + _arrow551()) + "]"
...
IOType_reflection = _expr555

def _expr556() -> TypeInfo:
...
CompositeHeader_reflection = _expr556
