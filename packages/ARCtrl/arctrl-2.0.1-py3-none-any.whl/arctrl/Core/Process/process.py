...
def Process_getInputCharacteristicValues_763471FF(p: Process) -> FSharpList[MaterialAttributeValue]:
    ...
    if match_value is None:
        ...
        return List_distinct(collect(mapping, match_value), ObjectExpr512())
...
def Process_getOutputCharacteristicValues_763471FF(p: Process) -> FSharpList[MaterialAttributeValue]:
    ...
    if match_value is None:
        ...
        return List_distinct(collect(mapping, match_value), ObjectExpr513())
...
def Process_getCharacteristicValues_763471FF(p: Process) -> FSharpList[MaterialAttributeValue]:
    ...
    return List_distinct(append(Process_getInputCharacteristicValues_763471FF(p), Process_getOutputCharacteristicValues_763471FF(p)), ObjectExpr514())
...
def Process_getCharacteristics_763471FF(p: Process) -> FSharpList[MaterialAttribute]:
    ...
    return List_distinct(choose(chooser, Process_getCharacteristicValues_763471FF(p)), ObjectExpr515())
...
def Process_getFactorValues_763471FF(p: Process) -> FSharpList[FactorValue]:
    ...
    return List_distinct(collect(mapping, default_arg(p.Outputs, empty())), ObjectExpr516())
...
def Process_getFactors_763471FF(p: Process) -> FSharpList[Factor]:
    ...
    return List_distinct(choose(chooser, Process_getFactorValues_763471FF(p)), ObjectExpr517())
...
def Process_getSources_763471FF(p: Process) -> FSharpList[Source]:
    ...
    return List_distinct(choose(chooser, default_arg(p.Inputs, empty())), ObjectExpr518())
...
def Process_getData_763471FF(p: Process) -> FSharpList[Data]:
    ...
    return List_distinct(append(choose(chooser, default_arg(p.Inputs, empty())), choose(chooser_1, default_arg(p.Outputs, empty()))), ObjectExpr519())
...
def Process_getSamples_763471FF(p: Process) -> FSharpList[Sample]:
    ...
    return List_distinct(append(choose(chooser, default_arg(p.Inputs, empty())), choose(chooser_1, default_arg(p.Outputs, empty()))), ObjectExpr520())
...
def Process_getMaterials_763471FF(p: Process) -> FSharpList[Material]:
    ...
    return List_distinct(append(choose(chooser, default_arg(p.Inputs, empty())), choose(chooser_1, default_arg(p.Outputs, empty()))), ObjectExpr521())
