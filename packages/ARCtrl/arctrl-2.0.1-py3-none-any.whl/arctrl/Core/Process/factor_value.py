...
class FactorValue(Record):
    ...
    def PrintCompact(self, __unit: None=None) -> str:
        ...
        def _arrow483(__unit: None=None) -> str:
            value_2: str = value
            return value_2

        def _arrow484(__unit: None=None) -> str:
            category_2: str = category
            return (category_2 + ":") + "No Value"

        def _arrow485(__unit: None=None) -> str:
            category_1: str = category
            value_1: str = value
            return (category_1 + ":") + value_1

        return ("" if (value is None) else _arrow483()) if (category is None) else (_arrow484() if (value is None) else _arrow485())
...
FactorValue_reflection = _expr486
...
def FactorValue__SetCategory_ZDED3A0F(this: FactorValue, c: OntologyAnnotation) -> FactorValue:
    def _arrow487(__unit: None=None, this: Any=this, c: Any=c) -> Factor | None:
    ...
    return FactorValue(this.ID, _arrow487(), this.Value, this.Unit)
