...
class ArcTable:
    ...
    def init(name: str) -> ArcTable:
        ...
        return ArcTable(name, [], Dictionary([], ObjectExpr617()))
    ...
    def create_from_headers(name: str, headers: Array[CompositeHeader]) -> ArcTable:
        ...
        return ArcTable.create(name, headers, Dictionary([], ObjectExpr620()))
    ...
    def validate(raise_exception: bool | None=None) -> Callable[[ArcTable], bool]:
        def _arrow621(table: ArcTable) -> bool:
    ...
    def Columns(self, __unit: None=None) -> Array[CompositeColumn]:
        this: ArcTable = self
        def _arrow623(__unit: None=None) -> IEnumerable_1[CompositeColumn]:
            def _arrow622(i: int) -> CompositeColumn:
                return this.GetColumn(i)

            return map(_arrow622, range_big_int(0, 1, this.ColumnCount - 1))

        return to_array(delay(_arrow623))
    ...
    def Copy(self, __unit: None=None) -> ArcTable:
        ...
        return ArcTable.create(this.Name, list(this.Headers), Dictionary(this.Values, ObjectExpr624()))
    ...
    def try_get_cell_at(column: int, row: int) -> Callable[[ArcTable], CompositeCell | None]:
        def _arrow625(table: ArcTable) -> CompositeCell | None:
    ...
    def get_cell_at(column: int, row: int) -> Callable[[ArcTable], CompositeCell]:
        def _arrow626(table: ArcTable) -> CompositeCell:
    ...
    def iter_columns(action: Callable[[CompositeColumn], None]) -> Callable[[ArcTable], ArcTable]:
        def _arrow627(table: ArcTable) -> ArcTable:
    ...
    def iteri_columns(action: Callable[[int, CompositeColumn], None]) -> Callable[[ArcTable], ArcTable]:
        def _arrow628(table: ArcTable) -> ArcTable:
            copy: ArcTable = table.Copy()
    ...
    def update_cell_at(column_index: int, row_index: int, cell: CompositeCell, skip_validation: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow629(table: ArcTable) -> ArcTable:
    ...
    def set_cell_at(column_index: int, row_index: int, cell: CompositeCell, skip_validation: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow630(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def update_cells_by(f: Callable[[int, int, CompositeCell], CompositeCell], skip_validation: bool | None=None) -> Callable[[ArcTable], None]:
        def _arrow631(table: ArcTable) -> None:
            new_table: ArcTable = table.Copy()
    ...
    def update_cell_by(column_index: int, row_index: int, f: Callable[[CompositeCell], CompositeCell], skip_validation: bool | None=None) -> Callable[[ArcTable], None]:
        def _arrow632(table: ArcTable) -> None:
            new_table: ArcTable = table.Copy()
    ...
    def update_header(index: int, header: CompositeHeader) -> Callable[[ArcTable], ArcTable]:
        def _arrow633(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def add_column(header: CompositeHeader, cells: Array[CompositeCell] | None=None, index: int | None=None, force_replace: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow634(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def AddColumnFill(self, header: CompositeHeader, cell: CompositeCell, index: int | None=None, force_replace: bool | None=None) -> None:
        this: ArcTable = self
        def _arrow635(_arg: int) -> CompositeCell:
            return cell.Copy()

        cells: Array[CompositeCell] = initialize(this.RowCount, _arrow635, None)
    ...
    def add_column_fill(header: CompositeHeader, cell: CompositeCell, index: int | None=None, force_replace: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow636(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def update_column(column_index: int, header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow637(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def insert_column(index: int, header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow638(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def append_column(header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow639(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def add_columns(columns: Array[CompositeColumn], index: int | None=None, skip_fill_missing: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow640(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def remove_column(index: int) -> Callable[[ArcTable], ArcTable]:
        def _arrow641(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def RemoveColumns(self, index_arr: Array[int]) -> None:
        this: ArcTable = self
        def _arrow642(index: int) -> None:
            SanityChecks_validateColumnIndex(index, this.ColumnCount, False)

        iterate_1(_arrow642, index_arr)
        def _arrow643(index_1: int) -> None:
        ...
        iterate_1(_arrow643, sort_descending(index_arr, ObjectExpr644()))

    @staticmethod
    def remove_columns(index_arr: Array[int]) -> Callable[[ArcTable], ArcTable]:
        def _arrow645(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def GetColumn(self, column_index: int) -> CompositeColumn:
        ...
        def _arrow647(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow646(i: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow646, range_big_int(0, 1, this.RowCount - 1))

        cells: Array[CompositeCell] = to_array(delay(_arrow647))
        return CompositeColumn.create(h, cells)

    @staticmethod
    def get_column(index: int) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow648(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_column_by_header(header: CompositeHeader) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow649(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_column_by_header(header: CompositeHeader) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow650(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_input_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow651(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_input_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow652(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_output_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow653(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_output_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow654(table: ArcTable) -> CompositeColumn:
    ...
    def move_column(start_col: int, end_col: int) -> Callable[[ArcTable], ArcTable]:
        def _arrow655(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def AddRow(self, cells: Array[CompositeCell] | None=None, index: int | None=None) -> None:
        ...
        def _arrow657(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow656(column_index: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow656, range_big_int(0, 1, this.ColumnCount - 1))

        cells_1: Array[CompositeCell] = to_array(delay(_arrow657)) if (cells is None) else value_3(cells)
    ...
    def add_row(cells: Array[CompositeCell] | None=None, index: int | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow658(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def update_row(row_index: int, cells: Array[CompositeCell]) -> Callable[[ArcTable], ArcTable]:
        def _arrow659(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def append_row(cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow660(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def insert_row(index: int, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow661(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
            new_table.AddRow(cells, index)
            return new_table
    ...
    def add_rows(rows: Array[Array[CompositeCell]], index: int | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow662(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def AddRowsEmpty(self, row_count: int, index: int | None=None) -> None:
        this: ArcTable = self
        def _arrow664(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow663(column_index: int) -> IEnumerable_1[CompositeCell]:
                return singleton(Unchecked_getEmptyCellForHeader(this.Headers[column_index], Unchecked_tryGetCellAt(column_index, 0, this.Values)))

            return collect(_arrow663, range_big_int(0, 1, this.ColumnCount - 1))

        row: Array[CompositeCell] = to_array(delay(_arrow664))
        def _arrow665(_arg: int) -> Array[CompositeCell]:
            return row

        rows: Array[Array[CompositeCell]] = initialize(row_count, _arrow665, None)
        this.AddRows(rows, index)

    @staticmethod
    def add_rows_empty(row_count: int, index: int | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow666(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def remove_row(index: int) -> Callable[[ArcTable], ArcTable]:
        def _arrow667(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def RemoveRows(self, index_arr: Array[int]) -> None:
        this: ArcTable = self
        def _arrow668(index: int) -> None:
            SanityChecks_validateRowIndex(index, this.RowCount, False)

        iterate_1(_arrow668, index_arr)
        def _arrow669(index_1: int) -> None:
        ...
        iterate_1(_arrow669, sort_descending(index_arr, ObjectExpr670()))

    @staticmethod
    def remove_rows(index_arr: Array[int]) -> Callable[[ArcTable], ArcTable]:
        def _arrow671(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
            new_table.RemoveColumns(index_arr)
            return new_table
    ...
    def GetRow(self, row_index: int, SkipValidation: bool | None=None) -> Array[CompositeCell]:
        ...
        def _arrow673(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow672(column_index: int) -> CompositeCell:
    ...
    def get_row(index: int) -> Callable[[ArcTable], Array[CompositeCell]]:
        def _arrow674(table: ArcTable) -> Array[CompositeCell]:
    ...
    def join(table: ArcTable, index: int | None=None, join_options: str | None=None, force_replace: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow675(this: ArcTable) -> ArcTable:
    ...
    def SplitByColumnValues(column_index: int) -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow677(table: ArcTable) -> Array[ArcTable]:
            ...
            return map_indexed(mapping_3, map_1(mapping_1, Array_groupBy(projection, indexed(table.GetColumn(column_index).Cells), ObjectExpr676()), None), None)

        return _arrow677

    @staticmethod
    def SplitByColumnValuesByHeader(header: CompositeHeader) -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow678(table: ArcTable) -> Array[ArcTable]:
            def predicate(x: CompositeHeader) -> bool:
                return equals(x, header)
    ...
    def SplitByProtocolREF() -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow679(table: ArcTable) -> Array[ArcTable]:
    ...
    def append(table1: ArcTable, table2: ArcTable) -> ArcTable:
        def get_list(t: ArcTable) -> FSharpList[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
            def _arrow683(__unit: None=None, t: Any=t) -> IEnumerable_1[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
                def _arrow682(row: int) -> FSharpList[tuple[CompositeHeader, CompositeCell]]:
                    def _arrow681(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                        def _arrow680(col: int) -> tuple[CompositeHeader, CompositeCell]:
                            return (t.Headers[col], get_item_from_dict(t.Values, (col, row)))

                        return map(_arrow680, range_big_int(0, 1, t.ColumnCount - 1))

                    return to_list(delay(_arrow681))

                return map(_arrow682, range_big_int(0, 1, t.RowCount - 1))

            return to_list(delay(_arrow683))
    ...
    def __str__(self, __unit: None=None) -> str:
        ...
        def _arrow692(__unit: None=None) -> IEnumerable_1[str]:
                    ...
                    def _arrow689(__unit: None=None) -> IEnumerable_1[str]:
                        ...
                        def _arrow687(__unit: None=None) -> IEnumerable_1[str]:
                            def _arrow686(__unit: None=None) -> IEnumerable_1[str]:
                                def _arrow685(row_i_1: int) -> str:
                                    return join("\t|\t", map(to_string, this.GetRow(row_i_1)))

                                return map(_arrow685, range_big_int(row_count - 20, 1, row_count - 1))

                            return append_1(singleton("..."), delay(_arrow686))

                        def _arrow688(row_i_2: int) -> str:
                            return join("\t|\t", map(to_string, this.GetRow(row_i_2)))

                        return append_1(map(_arrow684, range_big_int(0, 1, 19)), delay(_arrow687)) if (row_count > 50) else (singleton("No rows") if (row_count == 0) else map(_arrow688, range_big_int(0, 1, row_count - 1)))

                    return append_1(singleton(join("\t|\t", map(to_string, this.Headers))), delay(_arrow689))

                return append_1(singleton("-------------"), delay(_arrow690))

            return append_1(singleton(("Table: " + this.Name) + ""), delay(_arrow691))
    ...
    def StructurallyEquals(self, other: ArcTable) -> bool:
        ...
        def sort(arg: Any) -> Array[Any]:
            ...
            return sort_by(projection, list(arg), ObjectExpr693())
        ...
        def _arrow696(__unit: None=None) -> bool:
            ...
            def _arrow695(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow694(i: int) -> bool:
                    return equals(item(i, a), item(i, b))

                return map(_arrow694, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow695))) if (length(a) == length(b)) else False

        if _arrow696() if (this.Name == other.Name) else False:
            ...
            def _arrow698(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow697(i_1: int) -> bool:
                    return equals(item(i_1, a_1), item(i_1, b_1))

                return map(_arrow697, range_big_int(0, 1, length(a_1) - 1))
