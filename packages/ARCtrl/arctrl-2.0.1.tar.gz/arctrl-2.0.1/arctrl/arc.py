...
class ARC:
    ...
    def RemoveAssay(self, assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow2260(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr2259:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow2258(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(assay_identifier, i.AssayIdentifiers, ObjectExpr2259())
        ...
        def _arrow2263(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow2262(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow2261(__unit: None=None) -> IEnumerable_1[Contract]:
                    return map_1(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract, studies)

                return append(singleton(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(isa)), delay(_arrow2261))

            return append(singleton(ARCtrl_ArcAssay__ArcAssay_ToDeleteContract(assay)), delay(_arrow2262))

        return list(to_list(delay(_arrow2263)))
    ...
    def RenameAssay(self, old_assay_identifier: str, new_assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow2266(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr2265:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow2264(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(old_assay_identifier, i.AssayIdentifiers, ObjectExpr2265())
        ...
        def _arrow2268(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow2267(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton(Contract.create_rename(old_assay_folder_path, new_assay_folder_path)), delay(_arrow2267))

        return list(to_list(delay(_arrow2268)))
    ...
    def RenameStudy(self, old_study_identifier: str, new_study_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow2271(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr2270:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow2269(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(old_study_identifier, i.StudyIdentifiers, ObjectExpr2270())
        ...
        renamed_paths: Array[str] = map(mapping, paths, None)
        this.SetFilePaths(renamed_paths)
        def _arrow2273(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow2272(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton(Contract.create_rename(old_study_folder_path, new_study_folder_path)), delay(_arrow2272))

        return list(to_list(delay(_arrow2273)))
    ...
    def GetUpdateContracts(self, __unit: None=None) -> Array[Contract]:
        this: ARC = self
        match_value: ArcInvestigation | None = this.ISA
        def _arrow2274(__unit: None=None) -> bool:
            inv: ArcInvestigation = match_value
            return inv.StaticHash == 0

        def _arrow2275(__unit: None=None) -> Array[Contract]:
            inv_1: ArcInvestigation = match_value
            return this.GetWriteContracts()

        def _arrow2289(__unit: None=None) -> Array[Contract]:
            inv_2: ArcInvestigation = match_value
            def _arrow2288(__unit: None=None) -> IEnumerable_1[Contract]:
                hash_1: int = inv_2.GetLightHashCode() or 0
                def _arrow2287(__unit: None=None) -> IEnumerable_1[Contract]:
                    inv_2.StaticHash = hash_1 or 0
                    def _arrow2280(s: ArcStudy) -> IEnumerable_1[Contract]:
                        hash_2: int = s.GetLightHashCode() or 0
                        def _arrow2279(__unit: None=None) -> IEnumerable_1[Contract]:
                            ...
                            if match_value_1 is not None:
                                if DataMap__get_StaticHash(match_value_1) == 0:
                                    ...
                                    def _arrow2278(__unit: None=None) -> bool:
                            ...
                            if pattern_matching_result == 0:
                                def _arrow2276(__unit: None=None) -> IEnumerable_1[Contract]:
                                    DataMap__set_StaticHash_Z524259A4(dm_2, safe_hash(dm_2))
                                    return empty()

                                return append(singleton(ARCtrl_DataMap__DataMap_ToCreateContractForStudy_Z721C83C5(dm_2, s.Identifier)), delay(_arrow2276))

                            elif pattern_matching_result == 1:
                                def _arrow2277(__unit: None=None) -> IEnumerable_1[Contract]:
                                    DataMap__set_StaticHash_Z524259A4(dm_3, safe_hash(dm_3))
                                    return empty()

                                return append(singleton(ARCtrl_DataMap__DataMap_ToUpdateContractForStudy_Z721C83C5(dm_3, s.Identifier)), delay(_arrow2277))

                            elif pattern_matching_result == 2:
                                return empty()


                        return append(ARCtrl_ArcStudy__ArcStudy_ToCreateContract_6FCE9E49(s, True) if (s.StaticHash == 0) else (singleton(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract(s)) if (s.StaticHash != hash_2) else empty()), delay(_arrow2279))

                    def _arrow2286(__unit: None=None) -> IEnumerable_1[Contract]:
                        def _arrow2285(a: ArcAssay) -> IEnumerable_1[Contract]:
                            hash_3: int = a.GetLightHashCode() or 0
                            def _arrow2284(__unit: None=None) -> IEnumerable_1[Contract]:
                                ...
                                if match_value_2 is not None:
                                    if DataMap__get_StaticHash(match_value_2) == 0:
                                        ...
                                        def _arrow2283(__unit: None=None) -> bool:
                                ...
                                if pattern_matching_result_1 == 0:
                                    def _arrow2281(__unit: None=None) -> IEnumerable_1[Contract]:
                                        DataMap__set_StaticHash_Z524259A4(dm_6, safe_hash(dm_6))
                                        return empty()

                                    return append(singleton(ARCtrl_DataMap__DataMap_ToCreateContractForAssay_Z721C83C5(dm_6, a.Identifier)), delay(_arrow2281))

                                elif pattern_matching_result_1 == 1:
                                    def _arrow2282(__unit: None=None) -> IEnumerable_1[Contract]:
                                        DataMap__set_StaticHash_Z524259A4(dm_7, safe_hash(dm_7))
                                        return empty()

                                    return append(singleton(ARCtrl_DataMap__DataMap_ToUpdateContractForAssay_Z721C83C5(dm_7, a.Identifier)), delay(_arrow2282))

                                elif pattern_matching_result_1 == 2:
                                    return empty()


                            return append(ARCtrl_ArcAssay__ArcAssay_ToCreateContract_6FCE9E49(a, True) if (a.StaticHash == 0) else (singleton(ARCtrl_ArcAssay__ArcAssay_ToUpdateContract(a)) if (a.StaticHash != hash_3) else empty()), delay(_arrow2284))

                        return collect(_arrow2285, inv_2.Assays)

                    return append(collect(_arrow2280, inv_2.Studies), delay(_arrow2286))

                return append(singleton(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(inv_2)) if (inv_2.StaticHash != hash_1) else empty(), delay(_arrow2287))

            return to_array(delay(_arrow2288))

        return (_arrow2275() if _arrow2274() else _arrow2289()) if (match_value is not None) else this.GetWriteContracts()
    ...
    def GetGitInitContracts(self, branch: str | None=None, repository_address: str | None=None, default_gitignore: bool | None=None) -> Array[Contract]:
        ...
        def _arrow2293(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow2292(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow2291(__unit: None=None) -> IEnumerable_1[Contract]:
                    def _arrow2290(__unit: None=None) -> IEnumerable_1[Contract]:
                    ...
                    return append(singleton(gitignore_contract) if default_gitignore_1 else empty(), delay(_arrow2290))

                return append(singleton(gitattributes_contract), delay(_arrow2291))

            return append(singleton(Init_createInitContract_6DFDD678(branch)), delay(_arrow2292))

        return to_array(delay(_arrow2293))
    ...
    def GetRegisteredPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        ...
        def mapping_3(s_1: ArcStudy) -> Any:
            ...
            def _arrow2301(__unit: None=None, s_1: Any=s_1) -> IEnumerable_1[str]:
                def _arrow2300(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow2299(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow2298(table: ArcTable) -> IEnumerable_1[str]:
                            def _arrow2297(kv: Any) -> IEnumerable_1[str]:
                                text_value: str = kv[1].ToFreeTextCell().AsFreeText
                                def _arrow2296(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow2295(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton(((((("" + study_foldername) + "/") + "protocols") + "/") + text_value) + "")

                                    return append(singleton(((((("" + study_foldername) + "/") + "resources") + "/") + text_value) + ""), delay(_arrow2295))

                                return append(singleton(text_value), delay(_arrow2296))

                            return collect(_arrow2297, table.Values)

                        return collect(_arrow2298, s_1.Tables)

                    return append(singleton(((("" + study_foldername) + "/") + "README.md") + ""), delay(_arrow2299))

                return append(singleton(((("" + study_foldername) + "/") + "isa.study.xlsx") + ""), delay(_arrow2300))

            class ObjectExpr2302:
                @property
                def Compare(self) -> Callable[[str, str], int]:
                    return compare_primitives

            return of_seq(to_list(delay(_arrow2301)), ObjectExpr2302())

        class ObjectExpr2303:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives
        ...
        def mapping_4(a: ArcAssay) -> Any:
            ...
            def _arrow2310(__unit: None=None, a: Any=a) -> IEnumerable_1[str]:
                def _arrow2309(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow2308(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow2307(table_1: ArcTable) -> IEnumerable_1[str]:
                            def _arrow2306(kv_1: Any) -> IEnumerable_1[str]:
                                text_value_1: str = kv_1[1].ToFreeTextCell().AsFreeText
                                def _arrow2305(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow2304(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton(((((("" + assay_foldername) + "/") + "protocols") + "/") + text_value_1) + "")

                                    return append(singleton(((((("" + assay_foldername) + "/") + "dataset") + "/") + text_value_1) + ""), delay(_arrow2304))

                                return append(singleton(text_value_1), delay(_arrow2305))

                            return collect(_arrow2306, table_1.Values)

                        return collect(_arrow2307, a.Tables)

                    return append(singleton(((("" + assay_foldername) + "/") + "README.md") + ""), delay(_arrow2308))

                return append(singleton(((("" + assay_foldername) + "/") + "isa.assay.xlsx") + ""), delay(_arrow2309))

            class ObjectExpr2311:
                @property
                def Compare(self) -> Callable[[str, str], int]:
                    return compare_primitives

            return of_seq(to_list(delay(_arrow2310)), ObjectExpr2311())

        class ObjectExpr2312:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        class ObjectExpr2313:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        include_files: Any = union_many(to_enumerable([of_seq(to_enumerable(["isa.investigation.xlsx", "README.md"]), ObjectExpr2294()), union_many(map(mapping_3, registered_studies, None), ObjectExpr2303()), union_many(map(mapping_4, registered_assays, None), ObjectExpr2312())]), ObjectExpr2313())
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        fs_copy: FileSystem = this._fs.Copy()
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow2314(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not (n_1.find(".") == 0)

                return FileSystemTree.filter_folders(_arrow2314)(tree_1)

            else: 
                return tree_1


        def _arrow2316(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            def _arrow2315(n: str) -> bool:
                return not (n.find(".") == 0)

            return FileSystemTree.filter_files(_arrow2315)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow2316()), FileSystemTree.from_file_paths([]))

    def GetAdditionalPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        this: ARC = self
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        class ObjectExpr2317:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        registered_payload: Any = of_seq(FileSystemTree.to_file_paths()(this.GetRegisteredPayload()), ObjectExpr2317())
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow2318(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not (n_1.find(".") == 0)

                return FileSystemTree.filter_folders(_arrow2318)(tree_1)

            else: 
                return tree_1


        def _arrow2320(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            tree = FileSystemTree.from_file_paths(paths)
            def _arrow2319(n: str) -> bool:
                return not (n.find(".") == 0)

            return FileSystemTree.filter_files(_arrow2319)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow2320()), FileSystemTree.from_file_paths([]))

    @staticmethod
    def DefaultContracts() -> Any:
        class ObjectExpr2321:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        return of_seq_1(to_enumerable([(".gitignore", gitignore_contract), (".gitattributes", gitattributes_contract)]), ObjectExpr2321())

    @staticmethod
    def from_rocrate_json_string(s: str) -> ARC:
        def _arrow2322(__unit: None=None) -> ArcInvestigation | None:
    ...
    def GetValidationPackagesConfigWriteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        ...
        class ObjectExpr2325:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow2324(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains_1(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr2325()):
    ...
    def GetValidationPackagesConfigDeleteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        this: ARC = self
        paths: Array[str] = this.FileSystem.Tree.ToFilePaths()
        class ObjectExpr2327:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow2326(x: str, y: str) -> bool:
                    return x == y
        ...
        if contains_1(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr2327()):
            def predicate(p: str) -> bool:
