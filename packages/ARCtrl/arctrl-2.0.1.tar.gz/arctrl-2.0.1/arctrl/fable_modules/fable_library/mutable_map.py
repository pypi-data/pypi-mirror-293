...
from .seq import concat, delay, iterate, iterate_indexed, map, to_array
...
def _expr30(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
class Dictionary(Generic[_KEY, _VALUE]):
    ...
    def System_Collections_Generic_ICollection_1_Contains2B595(self, item: Any) -> bool:
        this: Dictionary[_KEY, _VALUE] = self
        match_value: Any | None = Dictionary__TryFind_2B595(this, item[0])
    ...
    def System_Collections_Generic_IDictionary_2_ContainsKey2B595(self, key: _KEY | None = None) -> bool:
        this: Dictionary[_KEY, _VALUE] = self
        return Dictionary__ContainsKey_2B595(this, key)

    def System_Collections_Generic_IDictionary_2_get_Item2B595(self, key: _KEY | None = None) -> _VALUE:
        this: Dictionary[_KEY, _VALUE] = self
    ...
    def System_Collections_Generic_IDictionary_2_get_Keys(self, __unit: None = None) -> ICollection[_KEY]:
        ...
        def _arrow27(__unit: None = None) -> IEnumerable_1[_KEY]:
            def _arrow26(pair: Any) -> _KEY:
                return pair[0]

            return map(_arrow26, this)

        return to_array(delay(_arrow27))

    def System_Collections_Generic_IDictionary_2_Remove2B595(self, key: _KEY | None = None) -> bool:
        this: Dictionary[_KEY, _VALUE] = self
    ...
    def System_Collections_Generic_IDictionary_2_get_Values(self, __unit: None = None) -> ICollection[_VALUE]:
        ...
        def _arrow29(__unit: None = None) -> IEnumerable_1[_VALUE]:
            def _arrow28(pair: Any) -> _VALUE:
                return pair[1]
    ...
    def __delitem__(self, k: _KEY | None = None) -> bool:
        this: Dictionary[_KEY, _VALUE] = self
...
Dictionary_reflection = _expr30


def Dictionary__ctor_6623D9B3(
...
def Dictionary__TryFindIndex_2B595(this: Dictionary[_KEY, Any], k: _KEY) -> tuple[bool, int, int]:
    ...
    def _arrow31(__unit: None = None, this: Any = this, k: Any = k) -> Array[Any]:
        return out_arg

    def _arrow32(v: Array[Any], this: Any = this, k: Any = k) -> None:
        nonlocal out_arg
        out_arg = v

    match_value = (try_get_value(this.hash_map, h, FSharpRef(_arrow31, _arrow32)), out_arg)
    if match_value[0]:

        def _arrow33(pair: Any, this: Any = this, k: Any = k) -> bool:
            return this.comparer.Equals(k, pair[0])

        return (True, h, find_index(_arrow33, match_value[1]))

    else:
        return (False, h, -1)


def Dictionary__TryFind_2B595(this: Dictionary[_KEY, _VALUE], k: _KEY) -> Any | None:
