...
def detokenize(ele: YAMLElement) -> PreprocessorElement:
    def loop(ele_1: YAMLElement, ele: Any=ele) -> PreprocessorElement:
        if ele_1.tag == 0:
            ...
            def _arrow291(__unit: None=None, ele_1: Any=ele_1) -> IEnumerable_1[PreprocessorElement]:
                return map_2(loop, ele_1.fields[0])

            return PreprocessorElement(0, to_list(delay(_arrow291)))

        elif ele_1.tag == 2:
            def _arrow293(__unit: None=None, ele_1: Any=ele_1) -> IEnumerable_1[PreprocessorElement]:
                def _arrow292(ele_3: YAMLElement) -> IEnumerable_1[PreprocessorElement]:
                ...
                return collect(_arrow292, ele_1.fields[0])

            return PreprocessorElement(0, to_list(delay(_arrow293)))
