...
def int_1(value: YAMLElement) -> int:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: int = 0
        def _arrow357(__unit: None=None, value: Any=value) -> int:
            return out_arg

        def _arrow358(v_1: int, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1 or 0

        match_value = (try_parse(v.Value, 511, False, 32, FSharpRef(_arrow357, _arrow358)), out_arg)
        if match_value[0]:
...
def float_1(value: YAMLElement) -> float:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: float = 0.0
        def _arrow359(__unit: None=None, value: Any=value) -> float:
            return out_arg

        def _arrow360(v_1: float, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_1(v.Value, FSharpRef(_arrow359, _arrow360)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def bool_1(value: YAMLElement) -> bool:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: bool = False
        def _arrow361(__unit: None=None, value: Any=value) -> bool:
            return out_arg

        def _arrow362(v_1: bool, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_2(v.Value, FSharpRef(_arrow361, _arrow362)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def map(key_decoder: Callable[[str], _A], value_decoder: Callable[[YAMLElement], _B], value: YAMLElement) -> Any:
    if value.tag == 3:
        ...
        return of_list(map_1(mapping, value.fields[0]), ObjectExpr363())
...
def dict_1(key_decoder: Callable[[str], _A], value_decoder: Callable[[YAMLElement], _B], value: YAMLElement) -> Any:
    if value.tag == 3:
        ...
        return Dictionary(of_seq(map_1(mapping, value.fields[0]), ObjectExpr364()), ObjectExpr365())
...
def datetime(value: YAMLElement) -> Any:
    ...
    if pattern_matching_result == 0:
        ...
        def _arrow366(__unit: None=None, value: Any=value) -> Any:
            return out_arg

        def _arrow367(v_1: Any, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_3(v.Value, FSharpRef(_arrow366, _arrow367)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def datetime_offset(value: YAMLElement) -> Any:
    ...
    if pattern_matching_result == 0:
        ...
        def _arrow368(__unit: None=None, value: Any=value) -> Any:
            return out_arg

        def _arrow369(v_1: Any, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_4(v.Value, FSharpRef(_arrow368, _arrow369)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def option(decoder: Callable[[YAMLElement], _A], value: YAMLElement) -> _A | None:
    (pattern_matching_result, v, any_else) = (None, None, None)
    if value.tag == 1:
        pattern_matching_result = 0
        v = value.fields[0]
...
def list_1(decoder: Callable[[YAMLElement], _A], value: YAMLElement) -> FSharpList[_A]:
    (pattern_matching_result, v, any_else) = (None, None, None)
    if value.tag == 2:
        pattern_matching_result = 0
        v = value.fields[0]
...
def array(decoder: Callable[[YAMLElement], _A], value: YAMLElement) -> Array[_A]:
    (pattern_matching_result, v, any_else) = (None, None, None)
    if value.tag == 2:
        pattern_matching_result = 0
        v = value.fields[0]
...
def seq(decoder: Callable[[YAMLElement], _A], value: YAMLElement) -> IEnumerable_1[_A]:
    (pattern_matching_result, v, any_else) = (None, None, None)
    if value.tag == 2:
        pattern_matching_result = 0
        v = value.fields[0]
...
def resizearray(decoder: Callable[[YAMLElement], _A], value: YAMLElement) -> Array[_A]:
    (pattern_matching_result, v, any_else) = (None, None, None)
    if value.tag == 2:
        pattern_matching_result = 0
        v = value.fields[0]
...
def values(decoder: Callable[[YAMLElement], _A], value: YAMLElement) -> FSharpList[_A]:
...
def _expr383() -> TypeInfo:
    return class_type("YAMLicious.Decode.Getter", None, Getter)


class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        def _arrow376(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr375(IRequiredGetter):
                def Field(self, field_name: str, dec: Callable[[YAMLElement], __A_]) -> __A_:
                    if ele.tag == 3:
        ...
        self.required: IRequiredGetter = _arrow376()
        def _arrow379(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr378(IOptionalGetter):
                def Field(self, field_name_1: str, dec_1: Callable[[YAMLElement], __A_]) -> __A_ | None:
                    if ele.tag == 3:
        ...
        self.optional: IOptionalGetter = _arrow379()
        def _arrow381(__unit: None=None) -> IOverflowGetter:
            _this_2: Any = self
            class ObjectExpr380(IOverflowGetter):
        ...
        self.overflow: IOverflowGetter = _arrow381()
...
Getter_reflection = _expr383

def Getter__ctor_D9C929(ele: YAMLElement) -> Getter:
    return Getter(ele)


def object(getter: Callable[[IGetters], _A], value: YAMLElement) -> _A:
