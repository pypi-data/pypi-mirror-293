...
extras_require = \
{':python_version >= "2.7" and python_version < "2.8" or python_version >= "3.5" and python_version < "4.0"': ['pyx-core'],
 ':python_version >= "3.7" and python_version < "4.0"': ['pyx-webservice>=1.18'],
