...
SUBJECTS = {"nsubj", "nsubjpass", "csubj", "csubjpass", "agent", "expl","pobj","dobj"}
# dependency markers for objects
OBJECTS = {"dobj", "dative", "attr", "oprd","pobj","pcomp"}
# elif (token.dep_=='amod' or token.dep_=='acomp' or token.dep_=='ROOT' or token.dep_=='relcl' or token.dep_=='advmod'):
...
def _get_all_objs(v, is_pas):
    ...
    objs = [tok for tok in rights if tok.dep_ in OBJECTS or (is_pas and tok.dep_ == 'pobj') or (is_pas and tok.dep_ == 'dobj')]
    objs.extend(_get_objs_from_prepositions(rights, is_pas))
