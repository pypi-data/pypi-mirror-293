...
sys.path.insert(0, '/UOFast')

from UOFast.UOClasses.UOFastConfig import uofastconfiguration, uofastlogging
...
class m_connection(Connection):
    ...
    def uconnect(self, uuser, pw):
        ...
        try:
            ...
            port=self.configparams.UOport, encoding='GB18030')
            ...
            self.logger = uofastlogging(self.sessport, sessionlogfile).logger
