...
from egstudio.app.utils import dbhelpers, auth, commands
from egstudio.app.services import persons_service, auth_service
from egstudio.app.services.exception import (
    IsUserLimitReachedException,
    PersonNotFoundException,
    TwoFactorAuthenticationNotEnabledException,
)
from egstudio.app import app, config

from egstudio import __file__ as root_path
...
def version():
    ...
    """
    from egstudio import __version__

    print(f"egstudio version: {__version__}")
...
def clear_memory_cache():
    ...
    from egstudio.app import cache
...
def dump_database(store=False):
    """
    Dump database described in egstudio environment variables and save it to
