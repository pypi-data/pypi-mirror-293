...
from egstudio.app.utils import thumbnail as thumbnail_utils
from egstudio.app.stores import auth_tokens_store, file_store
from egstudio.app.services import (
    assets_service,
    backup_service,
    deletion_service,
    edits_service,
...
from egstudio.app.models.person import Person
...
from egstudio.app import config

from egstudio.app import app
...
def dump_database(store=False):
    ...
    filename = f"egstudio-db-backup-{now}.sql.gz"
    if store:
