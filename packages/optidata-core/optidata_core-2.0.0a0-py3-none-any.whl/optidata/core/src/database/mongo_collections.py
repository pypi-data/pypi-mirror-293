...
MONGO_COLLECTION_ACTIONS = 'actions'
MONGO_COLLECTION_ACTION_ROLE_RELATIONS = 'action_role_relation'
...
MONGO_COLLECTIONS = {
    ...
    MONGO_COLLECTION_ACTIONS,
    MONGO_COLLECTION_ACTION_ROLE_RELATIONS
}
