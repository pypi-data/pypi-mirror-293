...
class ArchedEmailer:
    ...
    def init_app(self, app, intercept_errors: Optional[bool] = True, add_current_user: bool = True, **kwargs):
        ...
        if intercept_errors:
            ...
            def handle_exception(error):
                ...
                if (request.content_type == "application/xml" or request.content_type == "text/xml") and request.method.lower() == "post":
    ...
    def log_message(self, task_id: int, log_level: str, text: str):
        """
