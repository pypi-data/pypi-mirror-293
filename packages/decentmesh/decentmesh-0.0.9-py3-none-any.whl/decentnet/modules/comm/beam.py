...
class Beam:
    ...
    def init_comm_blockchain(self, insert: bool):
        ...
        """
        logger.debug(f"Initiation of communication blockchain with pub_enc {self.conn_bc.pub_key_for_encryption}")
        ...
        if block_data["cmd"] == CMD.HANDSHAKE_ENCRYPTION.value:
            ...
            if encryption_algorithm == "AES":
                if relay:
                    ...
                    self.encryption_init_complete = True
                else:
    ...
    def __connect_incoming(self, genesis_block: Block, target_key: str):
        ...
        logger.debug(f"Setting new public encryption key for Connection blockchain {received_encryption_pub_key}")
