...
class Block:
    ...
    def to_bytes(self) -> bytes:
        ...
        version_bytes = self.version
        diff_bytes = self.diff.to_bytes()
        previous_hash_bytes = pad(self.previous_hash, HASH_LEN_BLOCK, style='pkcs7')
    ...
    def from_bytes(cls, compressed_block_bytes: bytes):
        ...
        block.previous_hash = unpad(block_bytes[cursor:cursor + HASH_LEN_BLOCK], HASH_LEN_BLOCK,
                                    style='pkcs7')
        cursor += HASH_LEN
