...
class SVLRecomputationType(models.Model):
    _name = "svl_recomputation_type"
    ...
    product_ids = fields.Many2many(
        relation="rel_svl_recomputation_type_2_product_product",
        column1="svl_recomputation_type_id",
        column2="product_id",
    )
    product_category_ids = fields.Many2many(
        relation="rel_svl_recomputation_type_2_product_category",
        column1="svl_recomputation_type_id",
