...
def create_tag(version, tag_name=None):
    ...
    try:
        ...
        # Get the Project Access Token from the environment variable
        ...
        subprocess.run(['git', 'config', '--global', 'http.extraheader', f'Authorization: Bearer {project_access_token}'], check=True)
