...
while true do
    ...
    print(接收数据,data1)
    print(接收数据,data2)
    if data1 ==qewm or data1==qzf_ or data1==qry_then
      if data2 ==01 then
        yd(P1,1)
    ...
    if data1==fewm or data1==fry_ or data1==fwz_ or data1==fsz_then
      Go(P0,Option)
      yd(P14,1)
      Go(P0,Option)
      if data2==01 then
    ...
    if data1==bd_y then
      y=tonumber(data3) 
      local P = {coordinate = {a,b,250, 179.9477, 2.9334,100.8452}, tool = 0, user = 0}
      yd(P,1)
      yd(P13,0)
    end
end