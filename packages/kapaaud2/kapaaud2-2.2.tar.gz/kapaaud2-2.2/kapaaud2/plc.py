...
IF "shou3".DONE THEN
    ...
    ELSIF "c视觉".u_data[0] = 'sj_plc_ry' THEN
        ...
        ELSIF "renyuan_jishu" = 3 THEN
            ...
            END_FOR;
        END_IF;
    ELSIF "c视觉".u_data[0] = 'sj_plc_bd_x' THEN
        "发送"(buf := CONCAT_STRING(IN1 := 'bd_x', IN2 := "c视觉".u_data[1]),
             num := 4);
    ELSIF "c视觉".u_data[0] = 'sj_plc_bd_y' THEN
        "发送"(buf := CONCAT_STRING(IN1 := 'bd_y', IN2 := "c视觉".u_data[1]),
             num := 4);
    END_IF;
END_IF;
//////////////////////////////////////////////////////////////////////////
