...
class HE_Prediction_Dataset(Dataset):
    ...
    Args:
        section: spatial_obj: Spatial object containing the HE image and other information.
        args: argparse.Namespace: Arguments containing the split size and redundancy ratio.
    """
    ...
    def __getitem__(self, idx):
        ...
        Returns:
            sub_image (numpy.ndarray): Sub-image of the tissue.
        """
...
class HE_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        Returns:
            sub_img (numpy.ndarray): Sub-image of the tissue.
            spot_exp (numpy.ndarray): Spot expression.
            feasible_coord (dict): Feasible pixel coordinates for each spot.
            vd_score (float): VD score.
        """
    ...
    def _find_coord_within_radius(self,
        ...
        Args:
            :param center_coord: numpy.ndarray: Array containing the center coordinates.

        Returns:
            coord_within_radius (list): List containing the pixel coordinates within the radius for each center.
        """
    ...
    def get_feasible_coord(self,
        ...
        Args:
            centers (NumPy array): Array of shape (N, 2) containing the spot centers.
            tissue_bound (NumPy array): Array containing the tissue bounds.

        Returns:
            all_coord (dict): Dictionary containing the feasible pixel coordinates for each spot.
        """
