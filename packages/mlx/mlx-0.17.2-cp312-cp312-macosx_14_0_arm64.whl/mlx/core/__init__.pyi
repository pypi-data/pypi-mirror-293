...
class ArrayAt:
    ...
    def add(self, value: bool | int | float | array | Annotated[ArrayLike, dict(writable=False, order='C', device='cpu')] | complex | object) -> array: ...

    def subtract(self, value: bool | int | float | array | Annotated[ArrayLike, dict(writable=False, order='C', device='cpu')] | complex | object) -> array: ...

    def multiply(self, value: bool | int | float | array | Annotated[ArrayLike, dict(writable=False, order='C', device='cpu')] | complex | object) -> array: ...

    def divide(self, value: bool | int | float | array | Annotated[ArrayLike, dict(writable=False, order='C', device='cpu')] | complex | object) -> array: ...

    def maximum(self, value: bool | int | float | array | Annotated[ArrayLike, dict(writable=False, order='C', device='cpu')] | complex | object) -> array: ...

    def minimum(self, value: bool | int | float | array | Annotated[ArrayLike, dict(writable=False, order='C', device='cpu')] | complex | object) -> array: ...
