...
class ArrayAt:
    ...
    def add(self, value: Union[bool, int, float, array, Annotated[ArrayLike, dict(writable=False, order='C', device='cpu')], complex, object]) -> array: ...

    def subtract(self, value: Union[bool, int, float, array, Annotated[ArrayLike, dict(writable=False, order='C', device='cpu')], complex, object]) -> array: ...

    def multiply(self, value: Union[bool, int, float, array, Annotated[ArrayLike, dict(writable=False, order='C', device='cpu')], complex, object]) -> array: ...

    def divide(self, value: Union[bool, int, float, array, Annotated[ArrayLike, dict(writable=False, order='C', device='cpu')], complex, object]) -> array: ...

    def maximum(self, value: Union[bool, int, float, array, Annotated[ArrayLike, dict(writable=False, order='C', device='cpu')], complex, object]) -> array: ...

    def minimum(self, value: Union[bool, int, float, array, Annotated[ArrayLike, dict(writable=False, order='C', device='cpu')], complex, object]) -> array: ...
