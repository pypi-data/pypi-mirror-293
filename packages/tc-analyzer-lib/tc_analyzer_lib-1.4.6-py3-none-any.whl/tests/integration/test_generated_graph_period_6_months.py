...
class TestNetworkGraphSixMonthRecomputeAnalytics(IsolatedAsyncioTestCase):
    async def test_networkgraph_six_months_period_recompute_available_analytics(self):
        """
