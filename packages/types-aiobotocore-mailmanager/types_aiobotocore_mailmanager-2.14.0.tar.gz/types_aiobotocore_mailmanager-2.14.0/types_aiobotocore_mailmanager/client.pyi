...
class MailManagerClient(AioBaseClient):
    ...
    async def delete_addon_instance(self, *, AddonInstanceId: str) -> Dict[str, Any]:
        """
    ...
    async def delete_addon_subscription(self, *, AddonSubscriptionId: str) -> Dict[str, Any]:
        """
    ...
    async def delete_archive(self, *, ArchiveId: str) -> Dict[str, Any]:
        """
    ...
    async def delete_ingress_point(self, *, IngressPointId: str) -> Dict[str, Any]:
        """
    ...
    async def delete_relay(self, *, RelayId: str) -> Dict[str, Any]:
        """
    ...
    async def delete_rule_set(self, *, RuleSetId: str) -> Dict[str, Any]:
        """
        Delete a rule set.
    ...
    async def delete_traffic_policy(self, *, TrafficPolicyId: str) -> Dict[str, Any]:
        """
    ...
    async def get_addon_instance(self, *, AddonInstanceId: str) -> GetAddonInstanceResponseTypeDef:
        """
    ...
    async def get_archive(self, *, ArchiveId: str) -> GetArchiveResponseTypeDef:
        """
    ...
    async def get_archive_export(self, *, ExportId: str) -> GetArchiveExportResponseTypeDef:
        """
    ...
    async def get_archive_search(self, *, SearchId: str) -> GetArchiveSearchResponseTypeDef:
        """
    ...
    async def get_ingress_point(self, *, IngressPointId: str) -> GetIngressPointResponseTypeDef:
        """
    ...
    async def get_relay(self, *, RelayId: str) -> GetRelayResponseTypeDef:
        """
    ...
    async def get_rule_set(self, *, RuleSetId: str) -> GetRuleSetResponseTypeDef:
        """
    ...
    async def get_traffic_policy(self, *, TrafficPolicyId: str) -> GetTrafficPolicyResponseTypeDef:
        """
    ...
    async def stop_archive_export(self, *, ExportId: str) -> Dict[str, Any]:
        """
    ...
    async def stop_archive_search(self, *, SearchId: str) -> Dict[str, Any]:
        """
