...
if TYPE_CHECKING:
  from ..models.perms_by_role_for_rbac_detection_rule_permission_type_permissions_by_role import PermsByRoleForRbacDetectionRulePermissionTypePermissionsByRole
...
class PermsByRoleForRbacDetectionRulePermissionType:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.perms_by_role_for_rbac_detection_rule_permission_type_permissions_by_role import PermsByRoleForRbacDetectionRulePermissionTypePermissionsByRole
        d = src_dict.copy()
        permissions_by_role = PermsByRoleForRbacDetectionRulePermissionTypePermissionsByRole.from_dict(d.pop("permissions_by_role"))
