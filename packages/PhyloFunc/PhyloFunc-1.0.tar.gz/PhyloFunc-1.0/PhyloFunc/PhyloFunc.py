...
def Phylofunc_matirx(tree_file=None, sample_file=None):
    ...
    Sample_pair_matrix_norm = pd.DataFrame()
    column_pairs = list(zip(Intensity, range(2, len(Intensity) + 2)))

    for Sample1_col, a_idx in column_pairs:
        ...
        for Sample2_col, b_idx in column_pairs:
            if Sample1_col == Sample2_col:
                continue
            ...
            Sample_pair_matrix_norm.at[Sample1_col, Sample2_col] = PhyloFunc
