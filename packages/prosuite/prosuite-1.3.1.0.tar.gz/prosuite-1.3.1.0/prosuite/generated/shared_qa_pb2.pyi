...
class DataRequest(_message.Message):
    ...
    search_geometry: _shared_types_pb2.ShapeMsg
    sub_fields: str
    where_clause: str
    def __init__(self, class_def: _Optional[_Union[ClassDef, _Mapping]] = ..., rel_query_def: _Optional[_Union[RelationshipClassQuery, _Mapping]] = ..., where_clause: _Optional[str] = ..., search_geometry: _Optional[_Union[_shared_types_pb2.ShapeMsg, _Mapping]] = ..., sub_fields: _Optional[str] = ..., count_only: bool = ...) -> None: ...
...
class GdbData(_message.Message):
    ...
    gdb_objects: _containers.RepeatedCompositeFieldContainer[_shared_types_pb2.GdbObjectMsg]
    def __init__(self, gdb_object_count: _Optional[int] = ..., gdb_objects: _Optional[_Iterable[_Union[_shared_types_pb2.GdbObjectMsg, _Mapping]]] = ...) -> None: ...
...
class IssueMsg(_message.Message):
    ...
    stop_condition: bool
    test: int
    def __init__(self, condition_id: _Optional[int] = ..., issue_geometry: _Optional[_Union[_shared_types_pb2.ShapeMsg, _Mapping]] = ..., description: _Optional[str] = ..., issue_code_id: _Optional[str] = ..., issue_code_description: _Optional[str] = ..., involved_tables: _Optional[_Iterable[_Union[InvolvedTableMsg, _Mapping]]] = ..., legacy_involved_rows: _Optional[str] = ..., allowable: bool = ..., stop_condition: bool = ..., affected_component: _Optional[str] = ..., creation_date_time_ticks: _Optional[int] = ..., test: _Optional[int] = ...) -> None: ...
...
class SchemaMsg(_message.Message):
    ...
    class_definitions: _containers.RepeatedCompositeFieldContainer[_shared_types_pb2.ObjectClassMsg]
    relclass_definitions: _containers.RepeatedCompositeFieldContainer[_shared_types_pb2.ObjectClassMsg]
    def __init__(self, class_definitions: _Optional[_Iterable[_Union[_shared_types_pb2.ObjectClassMsg, _Mapping]]] = ..., relclass_definitions: _Optional[_Iterable[_Union[_shared_types_pb2.ObjectClassMsg, _Mapping]]] = ...) -> None: ...
...
class VerificationParametersMsg(_message.Message):
    ...
    issue_repository_spatial_reference: _shared_types_pb2.SpatialReferenceMsg
...
class VerificationProgressMsg(_message.Message):
    ...
    current_box: _shared_types_pb2.EnvelopeMsg
    ...
    progress_step: int
    progress_type: int
    total_box: _shared_types_pb2.EnvelopeMsg
    def __init__(self, progress_type: _Optional[int] = ..., progress_step: _Optional[int] = ..., overall_progress_total_steps: _Optional[int] = ..., overall_progress_current_step: _Optional[int] = ..., detailed_progress_total_steps: _Optional[int] = ..., detailed_progress__current_step: _Optional[int] = ..., processing_step_message: _Optional[str] = ..., current_box: _Optional[_Union[_shared_types_pb2.EnvelopeMsg, _Mapping]] = ..., total_box: _Optional[_Union[_shared_types_pb2.EnvelopeMsg, _Mapping]] = ..., message: _Optional[str] = ..., message_level: _Optional[int] = ...) -> None: ...
...
class WorkContextMsg(_message.Message):
    ...
    version_name: str
    workspace: _shared_types_pb2.WorkspaceMsg
    def __init__(self, ddx_id: _Optional[int] = ..., type: _Optional[int] = ..., workspace: _Optional[_Union[_shared_types_pb2.WorkspaceMsg, _Mapping]] = ..., version_name: _Optional[str] = ..., verified_dataset_ids: _Optional[_Iterable[int]] = ..., context_type: _Optional[str] = ..., context_name: _Optional[str] = ...) -> None: ...
