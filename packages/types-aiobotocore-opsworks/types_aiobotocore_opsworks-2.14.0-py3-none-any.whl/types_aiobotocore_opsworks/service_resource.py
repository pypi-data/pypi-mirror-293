...
class Layer(AIOBoto3ServiceResource):
    ...
    cloud_watch_logs_configuration: Awaitable[CloudWatchLogsConfigurationExtraOutputTypeDef]
    ...
    default_recipes: Awaitable[RecipesExtraOutputTypeDef]
    custom_recipes: Awaitable[RecipesExtraOutputTypeDef]
