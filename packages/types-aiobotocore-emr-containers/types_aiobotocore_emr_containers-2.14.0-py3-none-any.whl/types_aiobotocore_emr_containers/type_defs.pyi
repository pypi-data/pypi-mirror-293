...
__all__ = (
    ...
    "ConfigurationOverridesExtraOutputTypeDef",
    "ConfigurationOverridesOutputTypeDef",
    "ConfigurationOverridesTypeDef",
    "ParametricConfigurationOverridesExtraOutputTypeDef",
    ...
    "JobTemplateDataExtraOutputTypeDef",
...
SparkSubmitJobDriverExtraOutputTypeDef = TypedDict(
    "SparkSubmitJobDriverExtraOutputTypeDef",
    {
        "entryPoint": str,
...
JobDriverExtraOutputTypeDef = TypedDict(
    "JobDriverExtraOutputTypeDef",
    {
        "sparkSubmitJobDriver": NotRequired[SparkSubmitJobDriverExtraOutputTypeDef],
...
JobDriverUnionTypeDef = Union[JobDriverTypeDef, JobDriverExtraOutputTypeDef]
ConfigurationOverridesExtraOutputTypeDef = TypedDict(
    "ConfigurationOverridesExtraOutputTypeDef",
    {
        "applicationConfiguration": NotRequired[List["ConfigurationExtraOutputTypeDef"]],
...
ParametricConfigurationOverridesExtraOutputTypeDef = TypedDict(
    "ParametricConfigurationOverridesExtraOutputTypeDef",
    {
        "applicationConfiguration": NotRequired[List["ConfigurationExtraOutputTypeDef"]],
...
ConfigurationOverridesUnionTypeDef = Union[
    ConfigurationOverridesTypeDef, ConfigurationOverridesExtraOutputTypeDef
]
...
JobTemplateDataExtraOutputTypeDef = TypedDict(
    "JobTemplateDataExtraOutputTypeDef",
    {
        "executionRoleArn": str,
        "releaseLabel": str,
        "jobDriver": JobDriverExtraOutputTypeDef,
        "configurationOverrides": NotRequired[ParametricConfigurationOverridesExtraOutputTypeDef],
...
JobTemplateDataUnionTypeDef = Union[JobTemplateDataTypeDef, JobTemplateDataExtraOutputTypeDef]
