...
def main():
    ...
    path = "/home/jimmy/github_repos/jlmtech-ds-toolkit-repo/jlm-tech-ds-ml-ba-toolkit/src/jlm_tech_ds_ml_ba_toolkit/"
    
    # # full path to csv
    # csv_fname = "Train_set_(1)_(1).csv"
    ...
    config_object["enable_1D_plot_processing"] = True
    config_object["enable_2D_plot_processing"] = True
    config_object["enable_correlation_processing"] = True
    ...
    getStatisticsAndInfoOnDataSets(
        data_frame=df, 
        file_name="Titanic-Data-Analysis.txt",
