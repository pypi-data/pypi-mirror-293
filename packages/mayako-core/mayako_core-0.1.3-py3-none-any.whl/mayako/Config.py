...
class CCOMMAND:
    ...
    SELECT_SERIAL: str = "SELECT_SERIAL"
    SELECT_BLE: str = "SELECT_BLE"
    SELECT_WIFI: str = "SELECT_WIFI"   
...
class CPACKET:
    ...
    METHOD_ACKNOWLEDGEMENT: int = 0x20 #SP
    METHOD_DATA: int = 0x21 #!
    METHOD_COMMAND: int = 0x22 #"
    METHOD_HEARTBEAT: int = 0x23 ##
    METHOD_DEBUG: int = 0x24 #$
    METHOD_INFO: int = 0x25 #%
    METHOD_ERROR: int = 0x26 #&
