...
class Logger:
    ...
    def init_logger(self, logging_level: LoggingLevel = LoggingLevel.WARN, destination: LoggingDestination = LoggingDestination.STDOUT, output_format: str = _LOG_FORMAT, queue: Queue = None) -> None:
