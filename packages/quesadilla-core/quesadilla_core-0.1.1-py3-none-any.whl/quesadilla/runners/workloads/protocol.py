...
from quesadilla.runners.runners.protocol import RunnerLoggingExtras
...
class WorkloadLoggingExtras(TypedDict):
    task_queue: TaskQueueLoggingExtras
    id: str
    runner: RunnerLoggingExtras


class ExecutedQueuedTaskLoggingExtras(QueuedTaskLoggingExtras):
    workload: WorkloadLoggingExtras


class Workload:
    @cached_property
    def name(self) -> str: ...  # pragma: nocover
    ...
    ) -> ExecutedQueuedTaskLoggingExtras: ...  # pragma: nocover
