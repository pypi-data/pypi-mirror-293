...
from quesadilla.core.task_queues import TaskQueues
from quesadilla.core.tasks import async_task, sync_task
from quesadilla.runners import MultithreadingRunner, RoundRobinSelector, RunnerConfig
...
queues = TaskQueues("quesadilla", connector=ThreadSafeInMemoryConnector())
...
if __name__ == "__main__":
    ...
    with runner:
        ...
        # doesn't matter much for threads, but it's good practice
