...
BufferType = MutableMapping[str | None, BufferQueueType]
LedgerEntryType = MutableMapping[ulid.ULID, str]
LedgerQueueType = MutableMapping[str, LedgerEntryType]
LedgerType = MutableMapping[str | None, LedgerQueueType]


@dataclass(frozen=True)
class InMemoryConnector(Connector, JSONConnectorMixin):
    ...
    def find(
        self, namespace: str | None, task_queue: str, task_id: ulid.ULID
    ...
    def pull(
        self, namespace: str | None, task_queue: str
    ) -> SerializedTask[Any] | None:
        try:
