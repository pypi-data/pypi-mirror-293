...
"""
    ...
    pip3 cache purge
    pip3 install -i https://pypi.tuna.tsinghua.edu.cn/simple Fr1997v011==2.0.4
"""
...
class TimeJike:
    ...
    @staticmethod
    def hour_minute_seconds(t=None) -> tuple[int, int, int]:
        """
        获取指定时间戳的时、分、秒（整数）。
...
class XhsJike:
    ...
    def xhs_app_url_302(self, url):
        pattern = r'://xhslink\.com(/?[A-Za-z0-9]+/[A-Za-z0-9]{6})|://xhslink\.com/([A-Za-z0-9]{6})'
...
#     "bool": {
#         "must_not": [
#             {"exists": {"field": "wx_update_time"}}
#         ]
#     }
# }
# source = [F_keyword]
# data_data = mode_pro.es_search_new_v8(table=table, query=query, size=3, _source=source)
# print(data_data)

# table = config_dict['db_name']['table11']
# table = 'dso_video_alias'
# query = {
#     "bool": {
#         "must": [
#             {"match_phrase": {"video_keywords": "苹果用户"}},
#             # {"match_phrase": {"_id": "苹果用户必备"}},
#             {"match": {"cat_three_id": "66000000001073"}}
#         ]
#     }
# }
# source = [F_keyword, 'cat_two_id', 'cat_one_id', 'cat_three_id']
# save_data = []
# data_data = mode_pro.es_search_new_v8(table=table, query=query, size=1000, _source=source)
# for i in data_data:
#     _index = i['_index']
#     _id = i['_id']
#     _source = i['_source']
#
#     print(_index, _id, _source)
#     save_data.append({'update': {'_index': _index, '_id': f'{_id}'}})
#     save_data.append({
#         'doc': {
#             'cat_two_id': [],
#             'cat_one_id': [],
...
#
# print(save_data)
# mode_pro.es_create_update_noIndex(save_data)
