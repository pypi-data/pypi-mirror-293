...
# class ExampleUserInputItem(BaseModel):
#     content: str
#     description: str | None = None


# class ExampleUserInputs(BaseModel):
#     items = list[ExampleUserInputItem]


# @router.get("/example_inputs")
# async def example_inputs(user: OptionalUserDep):
#     results = ExampleUserInputs(
#         items=[ExampleUserInputItem(content="123", description="456")]
#     )
#     return results
