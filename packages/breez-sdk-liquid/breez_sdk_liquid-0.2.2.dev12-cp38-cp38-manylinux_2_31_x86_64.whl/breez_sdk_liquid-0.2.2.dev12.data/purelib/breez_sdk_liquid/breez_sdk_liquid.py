...
class Config:
    liquid_electrum_url: "str";bitcoin_electrum_url: "str";mempoolspace_url: "str";working_dir: "str";network: "LiquidNetwork";payment_timeout_sec: "int";zero_conf_min_fee_rate_msat: "int";zero_conf_max_amount_sat: "typing.Optional[int]";

    @typing.no_type_check
    def __init__(self, liquid_electrum_url: "str", bitcoin_electrum_url: "str", mempoolspace_url: "str", working_dir: "str", network: "LiquidNetwork", payment_timeout_sec: "int", zero_conf_min_fee_rate_msat: "int", zero_conf_max_amount_sat: "typing.Optional[int]"):
    ...
    def __str__(self):
        return "Config(liquid_electrum_url={}, bitcoin_electrum_url={}, mempoolspace_url={}, working_dir={}, network={}, payment_timeout_sec={}, zero_conf_min_fee_rate_msat={}, zero_conf_max_amount_sat={})".format(self.liquid_electrum_url, self.bitcoin_electrum_url, self.mempoolspace_url, self.working_dir, self.network, self.payment_timeout_sec, self.zero_conf_min_fee_rate_msat, self.zero_conf_max_amount_sat)
...
class Payment:
    timestamp: "int";amount_sat: "int";fees_sat: "int";payment_type: "PaymentType";status: "PaymentState";destination: "typing.Optional[str]";tx_id: "typing.Optional[str]";details: "typing.Optional[PaymentDetails]";

    @typing.no_type_check
    def __init__(self, timestamp: "int", amount_sat: "int", fees_sat: "int", payment_type: "PaymentType", status: "PaymentState", destination: "typing.Optional[str]" = _DEFAULT, tx_id: "typing.Optional[str]" = _DEFAULT, details: "typing.Optional[PaymentDetails]" = _DEFAULT):
        self.timestamp = timestamp
        self.amount_sat = amount_sat
    ...
    def __str__(self):
        return "Payment(timestamp={}, amount_sat={}, fees_sat={}, payment_type={}, status={}, destination={}, tx_id={}, details={})".format(self.timestamp, self.amount_sat, self.fees_sat, self.payment_type, self.status, self.destination, self.tx_id, self.details)
...
class PreparePayOnchainRequest:
    receiver_amount_sat: "int";sat_per_vbyte: "typing.Optional[int]";

    @typing.no_type_check
    def __init__(self, receiver_amount_sat: "int", sat_per_vbyte: "typing.Optional[int]" = _DEFAULT):
        self.receiver_amount_sat = receiver_amount_sat
        if sat_per_vbyte is _DEFAULT:
            self.sat_per_vbyte = None
        else:
            self.sat_per_vbyte = sat_per_vbyte

    def __str__(self):
        return "PreparePayOnchainRequest(receiver_amount_sat={}, sat_per_vbyte={})".format(self.receiver_amount_sat, self.sat_per_vbyte)
...
class _UniffiConverterTypePreparePayOnchainRequest(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return PreparePayOnchainRequest(
            ...
            sat_per_vbyte=_UniffiConverterOptionalUInt32.read(buf),
        )

    @staticmethod
    def write(value, buf):
        _UniffiConverterUInt64.write(value.receiver_amount_sat, buf)
        _UniffiConverterOptionalUInt32.write(value.sat_per_vbyte, buf)
...
class PrepareReceiveRequest:
    payer_amount_sat: "typing.Optional[int]";payment_method: "PaymentMethod";

    @typing.no_type_check
    def __init__(self, payer_amount_sat: "typing.Optional[int]", payment_method: "PaymentMethod"):
        self.payer_amount_sat = payer_amount_sat
        self.payment_method = payment_method

    def __str__(self):
        return "PrepareReceiveRequest(payer_amount_sat={}, payment_method={})".format(self.payer_amount_sat, self.payment_method)
...
class PrepareRefundRequest:
    swap_address: "str";refund_address: "str";sat_per_vbyte: "int";

    @typing.no_type_check
    def __init__(self, swap_address: "str", refund_address: "str", sat_per_vbyte: "int"):
        self.swap_address = swap_address
        self.refund_address = refund_address
        self.sat_per_vbyte = sat_per_vbyte

    def __str__(self):
        return "PrepareRefundRequest(swap_address={}, refund_address={}, sat_per_vbyte={})".format(self.swap_address, self.refund_address, self.sat_per_vbyte)
...
class PrepareSendRequest:
    ...
    @typing.no_type_check
    def __init__(self, destination: "str", amount_sat: "typing.Optional[int]"):
        self.destination = destination
        self.amount_sat = amount_sat
...
class ReceivePaymentRequest:
    prepare_response: "PrepareReceiveResponse";description: "typing.Optional[str]";

    @typing.no_type_check
    def __init__(self, prepare_response: "PrepareReceiveResponse", description: "typing.Optional[str]" = _DEFAULT):
        self.prepare_response = prepare_response
        if description is _DEFAULT:
            self.description = None
        else:
    ...
    def __str__(self):
        return "ReceivePaymentRequest(prepare_response={}, description={})".format(self.prepare_response, self.description)
...
class RefundRequest:
    ...
    def __str__(self):
        return "RefundRequest(swap_address={}, refund_address={}, sat_per_vbyte={})".format(self.swap_address, self.refund_address, self.sat_per_vbyte)
...
class RouteHintHop:
    src_node_id: "str";short_channel_id: "int";fees_base_msat: "int";fees_proportional_millionths: "int";cltv_expiry_delta: "int";htlc_minimum_msat: "typing.Optional[int]";htlc_maximum_msat: "typing.Optional[int]";
