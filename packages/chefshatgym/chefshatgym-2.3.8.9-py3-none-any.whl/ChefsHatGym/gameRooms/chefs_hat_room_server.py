            ...
            if isMatchOver:
                ...
                if not self.env.gameFinished:
                    ...
                    if not action_type == "Dinner served!":
                        ...
                        self._broadcast_message(
                            list(self.players.keys())[player_chef], p, info_special
                        )
                        ...
                        self._broadcast_message(
                            list(self.players.keys())[player_sourchef], p, info_special
                        )
                        ...
                        self._broadcast_message(
                            list(self.players.keys())[player_waiter], p, info_special
                        )
