...
created in the [CHEXNEXT-2018]_ study. Test data uses the available annotations with
[CXR8-2017]_.

* Database references:

  * Original data: [CXR8-2017]_ (contains 112'120 chest X-ray images) and
    up to 14 associated radiological findings.
  * Labels and split references: We use train and validation splits published
    at [CHEXNEXT-2018]_, that are `available here` <nih-cxr14-relabeled_>`_.
    These are **different compared to the file lists provided with the original
    [CXR8-2017]_ study** (train/val set: 86'523 samples; test set: 25'595
    samples; +2 missing samples which are not listed, making up 112'120
    samples). The splits at [CHEXNEXT-2018]_, which we copied in this library,
    ...
    relabeling work provided by [CHEXNEXT-2018]_ does not provide **test** set
...
.. important:: **Raw data organization**
    ...
    The labels from [CHEXNEXT-2018]_ (`available here <nih-cxr14-relabeled_>`_)
