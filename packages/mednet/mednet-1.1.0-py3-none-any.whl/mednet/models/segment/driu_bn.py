...
""":py:mod:`DRIU network architecture <.segment.models.driu>`, with added batch-normalization."""
...
class DRIUBN(Model):
    ...
    augmentation_transforms
        An optional sequence of torch modules containing augmentation transforms to be
        applied on the input **before** it is fed into the network.
    num_classes
