...
class Object:
    ...
    def plot_streams_and_temperature_intervals(self, figsize=(12, 6)):
        ...
        for i in range(len(names)):
            ...
            # Ajouter l'annotation avec la valeur arrondie de delta_H
            plt.text(names.iloc[i], mid_temp, f'{delta_H.iloc[i]:.2f}', 
        ...
        plt.xticks(range(len(names)), [f'{name}\n($mCp={{{mCp_val:.2f}}}$)' for name, mCp_val in zip(names, mCp)],
                fontsize=8, rotation=90)  # rotation=90 pour les mettre à la verticale
