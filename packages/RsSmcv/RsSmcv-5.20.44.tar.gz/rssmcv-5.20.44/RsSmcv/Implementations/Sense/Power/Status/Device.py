...
class DeviceCls:
	...
	def set(self, status: bool, channel=repcap.Channel.Default) -> None:
		"""SCPI: SENSe<CH>:[POWer]:STATus:[DEVice] \n
		Snippet: driver.sense.power.status.device.set(status = False, channel = repcap.Channel.Default) \n
		...
		self._core.io.write(f'SENSe{channel_cmd_val}:POWer:STATus:DEVice {param}')
