...
class ExternalCls:
	...
	def get_sbandwidth(self) -> enums.FilterWidth:
		...
		Depending on the RF hardware version, and the installed options, the synchronizsation bandwidth varies.
