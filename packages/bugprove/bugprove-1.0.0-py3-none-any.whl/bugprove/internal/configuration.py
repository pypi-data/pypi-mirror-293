...
class Configuration:
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = "https://public.eu.bugprove.com/api/public/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("bugprove.internal")
            ...
            },
            {
                ...
                "variables": {
                    "hostname": {
                        ...
                        "default_value": "workspace.bugprove.local",
                    }
                },
            },
        ]
