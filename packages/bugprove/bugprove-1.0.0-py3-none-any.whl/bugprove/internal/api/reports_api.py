...
class ReportsApi:
    ...
    def _create_report_serialize(
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/scans/{scanId}/reports",
    ...
    async def download_report(
        self,
        scan_id: Annotated[StrictStr, Field(description="Scan ID")],
        revision: Annotated[StrictInt, Field(description="Report revision")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        """Generate a signed URL to download a report


        :param scan_id: Scan ID (required)
        :type scan_id: str
        :param revision: Report revision (required)
        :type revision: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    @validate_call
    async def download_report_with_http_info(
        self,
        scan_id: Annotated[StrictStr, Field(description="Scan ID")],
        revision: Annotated[StrictInt, Field(description="Report revision")],
        _request_timeout: Union[
    ...
    @validate_call
    async def download_report_without_preload_content(
        self,
        scan_id: Annotated[StrictStr, Field(description="Scan ID")],
        revision: Annotated[StrictInt, Field(description="Report revision")],
        _request_timeout: Union[
    ...
    def _download_report_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/scans/{scanId}/reports/{revision}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
