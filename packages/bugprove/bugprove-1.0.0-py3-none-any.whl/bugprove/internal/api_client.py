...
from bugprove.internal.api_response import ApiResponse, T as ApiResponseT
import bugprove.internal.models
from bugprove.internal import rest
from bugprove.internal.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(bugprove.internal.models, klass)
