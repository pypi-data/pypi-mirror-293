...
class LinksApi:
    ...
    async def create_link(
        ...
        create_link_request: Annotated[Optional[CreateLinkRequest], Field(description="Request")] = None,
        ...
        """Generate a link for a scan


        :param scan_id: Scan ID (required)
        :type scan_id: str
        :param create_link_request: Request
    ...
    def _create_link_serialize(
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/scans/{scanId}/link",
    ...
    async def revoke_link(
        ...
        _param = self._revoke_link_serialize(
            scan_id=scan_id,
    ...
    @validate_call
    async def revoke_link_with_http_info(
        self,
        scan_id: Annotated[StrictStr, Field(description="Scan ID")],
        session_id: Annotated[StrictStr, Field(description="Session ID")],
        _request_timeout: Union[
    ...
    @validate_call
    async def revoke_link_without_preload_content(
        self,
        scan_id: Annotated[StrictStr, Field(description="Scan ID")],
        session_id: Annotated[StrictStr, Field(description="Session ID")],
        _request_timeout: Union[
    ...
    def _revoke_link_serialize(
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/scans/{scanId}/link/{sessionId}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
