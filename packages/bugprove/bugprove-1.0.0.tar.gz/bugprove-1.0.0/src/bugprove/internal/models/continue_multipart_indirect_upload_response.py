...
class ContinueMultipartIndirectUploadResponse(BaseModel):
    """
    ...
    expiry: datetime
    __properties: ClassVar[List[str]] = ["partSize", "signedUrls", "expiry"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContinueMultipartIndirectUploadResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContinueMultipartIndirectUploadResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"partSize": obj.get("partSize"), "signedUrls": obj.get("signedUrls"), "expiry": obj.get("expiry")}
        )
        return _obj
