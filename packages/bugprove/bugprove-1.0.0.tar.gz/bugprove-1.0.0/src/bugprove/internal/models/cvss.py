...
class Cvss(BaseModel):
    ...
    version: CvssVersion
    base_score: Union[StrictFloat, StrictInt] = Field(alias="baseScore")
    vector: CvssVector
    __properties: ClassVar[List[str]] = ["version", "baseScore", "vector"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"version": obj.get("version"), "baseScore": obj.get("baseScore"), "vector": obj.get("vector")}
        )
        return _obj
