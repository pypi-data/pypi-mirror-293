...
class getter_RaceData(baseGetter):
    ...
    def __del__(self):
        ...
        # seleniumでデータ取得しているgetterのみwebdriverをquit
    ...
    def init_recset(self):
        ...
        if self.raceResult.wdc.browserCtl != None : self.raceResult.wdc.browserCtl.resetLoadPageCount()
        if self.horseResult.wdc.browserCtl != None : self.horseResult.wdc.browserCtl.resetLoadPageCount()
        if self.openInfo.wdc.browserCtl != None : self.openInfo.wdc.browserCtl.resetLoadPageCount()
        if self.refundInfo.wdc.browserCtl != None : self.refundInfo.wdc.browserCtl.resetLoadPageCount()
        if self.traningAssInfo.wdc.browserCtl != None : self.traningAssInfo.wdc.browserCtl.resetLoadPageCount()
