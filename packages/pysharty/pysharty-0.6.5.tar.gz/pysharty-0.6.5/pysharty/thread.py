...
class Thread(object):
    """Represents a soyjak.party thread.
    ...
    Attributes:
        ...
        topic (:class:`pysharty.Post`): Topic post of the thread, the OP.
        posts (list of :class:`pysharty.Post`): List of all posts in the thread, including the OP.
        all_posts (list of :class:`pysharty.Post`): List of all posts in the thread, including the OP and any omitted posts.
        url (string): URL of the thread, not including semantic slug.
        semantic_url (string): URL of the thread, with the semantic slug.
        semantic_slug (string): The 'pretty URL slug' assigned to this thread by soyjak.party.
    """
    def __init__(self, board, id):
        self._board = board
        self._url = Url(board_name=board.name, https=board.https)       # soyjak.party URL generator
    ...
    def file_objects(self):
        """Returns the :class:`pysharty.File` objects of all files attached to posts in the thread."""
        if self.topic.has_file:
