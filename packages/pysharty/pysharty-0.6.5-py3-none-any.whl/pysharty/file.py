...
class File(object):
    ...
    Constructor:
        post (pysharty.Post) - parent Post object.
    ...
    def __init__(self, post, data):
        self._post = post
        self._data = data
        self._url = Url(board_name=self._post._thread._board.name, https=self._post._thread._board.https)       # soyjak.party URL generator
