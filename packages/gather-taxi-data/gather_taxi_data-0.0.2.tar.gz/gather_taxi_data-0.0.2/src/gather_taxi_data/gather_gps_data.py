...
import taxi_data_core.automate_gps_tracker_web_site as WebSite
from taxi_data_core.classes import GpsRecord, PlaybackButtons, PlaybackSpeed, TrackerEntry, RawEvent, ProcessedEvent, GpsTrackerEvent
from datetime import datetime, time
from typing import List, Dict, Generator
from argparse import ArgumentParser
from os import getenv
from pathlib import Path
from taxi_data_core.initialize_database import initialize_gps_database
from datetime import timedelta
from re import findall
from taxi_data_core.database_actions import add_or_update_gps_records as save_data
from taxi_data_core.database_actions import fetch_all_gps_records
    ...
    try:
        ...
        for date in date_range_generator(start_date= start_date, finish_date= finish_date):
            ...
            if gps_records[date].kml_file is None:
                kml_file_path = f"{destination}/{Constants.FILE_NAME_STRING}{datetime.strftime(date, '%Y-%m-%d')}.kml"
            else:
