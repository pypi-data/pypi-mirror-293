...
class Logger(object):
    def __init__(self, file_path=None, print_to_screen=False):
        super(Logger, self).__init__()

        self.file_path = file_path if file_path is not None else os.path.join(os.path.expanduser("~"), "dcs_code_injector.log")
