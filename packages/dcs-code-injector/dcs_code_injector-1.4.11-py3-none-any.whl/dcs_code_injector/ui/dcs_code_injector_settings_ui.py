...
class Ui_settings_dialog(object):
    def setupUi(self, settings_dialog):
        ...
        settings_dialog.resize(1357, 785)
        ...
        self.chk_play_sound_on_mission_scripting_error = QCheckBox(settings_dialog)
        self.chk_play_sound_on_mission_scripting_error.setObjectName(u"chk_play_sound_on_mission_scripting_error")
        self.chk_play_sound_on_mission_scripting_error.setChecked(True)
        self.chk_play_sound_on_mission_scripting_error.setTristate(False)

        self.gridLayout.addWidget(self.chk_play_sound_on_mission_scripting_error, 3, 1, 1, 1)
        ...
        self.chk_copy_hook_on_startup = QCheckBox(settings_dialog)
        self.chk_copy_hook_on_startup.setObjectName(u"chk_copy_hook_on_startup")
        self.chk_copy_hook_on_startup.setEnabled(True)
        self.chk_copy_hook_on_startup.setChecked(False)
        self.chk_copy_hook_on_startup.setTristate(False)

        self.gridLayout.addWidget(self.chk_copy_hook_on_startup, 4, 1, 1, 1)
    ...
    def retranslateUi(self, settings_dialog):
        ...
        self.chk_play_sound_on_mission_scripting_error.setText("")
        ...
        self.label_4.setText(QCoreApplication.translate("settings_dialog", u"Automatically copy hook file on startup", None))
        self.chk_copy_hook_on_startup.setText("")
    # retranslateUi
