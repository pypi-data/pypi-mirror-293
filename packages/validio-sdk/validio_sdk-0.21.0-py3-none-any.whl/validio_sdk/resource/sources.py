...
class Source(Resource):
    ...
    def __init__(
        ...
        """
        super().__init__(name, credential._resource_graph, ignore_changes)
    ...
    def _decode(
        ...
        source = cls(**cast(dict[str, object], {**args, "credential": credential}))
...
class DemoSource(Source):
    ...
    def __init__(
        ...
        """Constructor."""
        super().__init__(name, credential, ignore_changes, jtd_schema)
...
class AwsKinesisSource(StreamSource):
    ...
    def __init__(
        ...
        """
        super().__init__(name, credential, ignore_changes, jtd_schema, message_format)
