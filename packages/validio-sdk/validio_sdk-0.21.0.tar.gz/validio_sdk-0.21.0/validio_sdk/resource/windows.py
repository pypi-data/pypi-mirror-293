...
class Window(Resource):
    ...
    def __init__(self, name: str, source: Source, ignore_changes: bool = False) -> None:
        """
        Constructor.
        ...
        """
        super().__init__(name, source._resource_graph, ignore_changes)
...
class GlobalWindow(Window):
    ...
    def __init__(self, name: str, source: Source, ignore_changes: bool = False) -> None:
        ...
        :param ignore_changes: If set to true, changes to the resource will be ignored.
        """
        super().__init__(name=name, ignore_changes=ignore_changes, source=source)
...
class FixedBatchWindow(Window):
    ...
    def __init__(
        ...
        :param ignore_changes: If set to true, changes to the resource will be ignored.
        """
        super().__init__(name=name, source=source, ignore_changes=ignore_changes)
