...
[aiobotocore.Chatbot 2.14.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/chatbot.html#Chatbot)
...
async with session.create_client("chatbot") as client:
    ...
    list_microsoft_teams_channel_configurations_paginator: (
        ListMicrosoftTeamsChannelConfigurationsPaginator
    ) = client.get_paginator("list_microsoft_teams_channel_configurations")
