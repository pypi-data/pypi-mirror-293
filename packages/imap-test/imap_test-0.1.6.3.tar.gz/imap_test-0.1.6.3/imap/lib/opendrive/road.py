...
class Speed:
  ...
  def parse_from(self, raw_speed, manual_speed_limit=-1):
    ...
    if raw_max_speed == 'no limit' or raw_max_speed == 'undefined':
      ...
      self.max_speed = convert_speed(raw_max_speed, self.unit, manual_speed_limit)
...
class RoadType:
  ...
  def parse_from(self, raw_road_type, manual_speed_limit=-1):
...
class Road:
  ...
  def parse_from(self, raw_road, manual_speed_limit=-1):
    ...
    self.road_type.parse_from(raw_road_type, manual_speed_limit)
    ...
    self.lanes.parse_from(raw_lanes, manual_speed_limit)
