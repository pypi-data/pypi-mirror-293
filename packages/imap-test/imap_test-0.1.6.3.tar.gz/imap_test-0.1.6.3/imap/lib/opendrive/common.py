...
def convert_speed(speed_limit, speed_unit, manual_speed_limit=-1) -> float:
  # [2024.07.10][cjh] add manual_speed_limit
  if manual_speed_limit != -1:
    return manual_speed_limit
