...
setup(
    name='fbgrouter',  # Nombre del paquete
    ...
    description='fbgrouter - paquete de creación de rutas',  # Descripción breve
    ...
    url='https://github.com/usuariomen/fbgrouter',  # URL de tu repositorio o sitio
    classifiers=[
