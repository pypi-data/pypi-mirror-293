...
from .units_manager import UnitsManager, _helpstr
...
class UnitsManagerPIC(UnitsManager):
    ...
    def from_pic(cls, units='si', *,
                 l=None, t=None, u_l=None, u_t=None, u_n=None, ne=None, ne_si=None,
        ...
        REQUIRED PARAMETERS
            ...
            Indicate length or time units in one of the following ways:
                l or u_l: length [si] = u_l * length [raw]
                t or u_t: time [si] = u_t * time [raw]
