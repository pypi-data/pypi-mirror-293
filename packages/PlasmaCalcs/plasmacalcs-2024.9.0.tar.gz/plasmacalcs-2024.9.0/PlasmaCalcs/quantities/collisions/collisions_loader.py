...
from ...tools import simple_setdefault_property, UNSET
...
class CollisionsLoader(CollisionsCrossSectionsLoader):
    ...
    collisions_mode = simple_setdefault_property('_collisions_mode', lambda: 'best',
    ...
    def _handle_missing_collisions_crosstab(self):
        ...
        RAISE_ERROR_OPTIONS = ('table', 'table_only')
    ...
    def collision_type(self, fluid=UNSET, jfluid=UNSET):
        ...
        returns '0' if fluid and jfluid are the same fluid,
                ...
                i.e. not in ('best', 'table', 'neutral_only', 'table_only').
        '''
        using = dict()
        ...
        with self.using(**using):
            ...
            # the implementation below assumes collisions_mode is one of these 4 options.
            if mode not in ('best', 'table', 'neutral_only', 'table_only'):
