...
DEFAULT_PLOT_SETTINGS = {
    ...
    'kw_share_axlike': [
        ('sharexlike', 'shareylike'),
            ...
            UNSET --> if sharex/sharey not provided, use True, otherwise use bool(sharex)/bool(sharey)."""),
        ],
    ...
    'interval': (UNSET, "UNSET, None, or number",
        """interval between frames, in milliseconds.
        UNSET --> use fps to determine interval.
        None --> use matplotlib defaults.
        mutually exclusive with fps, cannot provide both.""",
        ),
...
MPL_KWARGS = {
    ...
    'pc.XarrayImagePlotElement': {
        'here': ('image_mode', 'aspect',),
        'from': ['xarray.DataArray.plot[image]'],
        },
