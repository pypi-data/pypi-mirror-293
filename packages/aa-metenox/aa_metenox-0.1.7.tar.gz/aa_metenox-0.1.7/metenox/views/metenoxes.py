...
class MetenoxListJson(PermissionRequiredMixin, LoginRequiredMixin, BaseDatatableView):
    ...
    def filter_queryset(self, qs):
        ...
        qs = self._apply_search_filter(
            qs,
            8,
            "moon_eve_moon__eve_planet__eve_solar_system__eve_constellation__eve_region__name",
        )
        qs = self._apply_search_filter(
            qs,
            7,
            "moon_eve_moon__eve_planet__eve_solar_system__eve_constellation__name",
        )
        qs = self._apply_search_filter(
            qs, 5, "moon_eve_moon__eve_planet__eve_solar_system__name"
        )
