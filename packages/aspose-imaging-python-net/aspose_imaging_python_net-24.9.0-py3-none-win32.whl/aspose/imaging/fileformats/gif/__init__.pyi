...
class GifImage(aspose.imaging.RasterCachedMultipageImage):
    ...
    def resize(self, new_width: int, new_height: int, resize_type: aspose.imaging.ResizeType):
        '''Modify the size of the image while maintaining its aspect ratio and visual quality.
        This function allows for easy adjustment of the image dimensions to suit specific
        display or storage needs, ensuring optimal presentation without distortion or loss
        of detail.
    ...
    def resize(self, new_width: int, new_height: int, settings: aspose.imaging.ImageResizeSettings):
        '''Resize the width and height of the image while maintaining its aspect ratio and
        applying additional settings as specified. This method ensures that the image
        dimensions are adjusted proportionally, preserving the overall visual quality and
        appearance according to the provided settings.
