...
def sparta_837c918473(user_obj):
	B=user_obj
	...
	return A
def sparta_ff27eb28c6(json_data,user_obj):
...
def sparta_a2650d666f(json_data,user_obj):
...
def sparta_ef2582a582(json_data,user_obj):
	...
	return{_C:1}
def sparta_9c2f47a64f(json_data,user_obj):
