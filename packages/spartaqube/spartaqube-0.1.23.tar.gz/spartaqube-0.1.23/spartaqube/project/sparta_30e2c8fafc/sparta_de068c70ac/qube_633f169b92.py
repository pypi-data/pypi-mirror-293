...
def sparta_904eeb573a(json_data,userObj):
	A=json_data
	try:D=A[_A];E=A[_C];B=os.path.dirname(D);F,G=sparta_16d00adc2d(B,E);C={_B:1,'files':G,_D:F,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_2afeb0582e(json_data,userObj):
	A=json_data
	try:B=A[_A];D=A[_C];E,F=sparta_16d00adc2d(B,D);C={_B:1,'files':F,_D:E,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_16d00adc2d(currentPath,typeexplorer=None):
...
def sparta_b988201f4f(currentPath):
