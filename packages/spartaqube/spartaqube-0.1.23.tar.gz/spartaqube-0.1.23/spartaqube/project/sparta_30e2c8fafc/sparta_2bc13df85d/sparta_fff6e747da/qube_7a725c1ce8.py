...
plot_example"""}]
def sparta_d398899def():return sparta_0a0db59fa8(type=_N)
def sparta_ebfbb752a5():return sparta_0a0db59fa8(type='gauge2')
def sparta_587349a559():
	type='gauge3'
	if conf_settings.IS_DEV:B=_F
	else:B=_G
