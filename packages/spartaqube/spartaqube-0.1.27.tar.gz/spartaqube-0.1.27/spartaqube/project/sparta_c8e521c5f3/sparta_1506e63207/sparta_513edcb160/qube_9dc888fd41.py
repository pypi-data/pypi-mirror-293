...
def sparta_489e9d6141(type='line'):
...
plot_example"""}]
def sparta_6d0ef04ac0():return sparta_489e9d6141(type='line')
def sparta_3064fb6d5a():return sparta_489e9d6141(type='bar')
def sparta_5945b20188():return sparta_489e9d6141(type='scatter')
def sparta_33a0ad6128():
	if conf_settings.IS_DEV:A=_F
	else:A=_G
...
plot_example"""}]
def sparta_3ab80123b9(type='pie'):
	if conf_settings.IS_DEV:A=_F
	else:A=_G
...
plot_example"""}]
def sparta_7ed1a9f317():return sparta_3ab80123b9(type='donut')
def sparta_5a9b2ff653():return sparta_3ab80123b9(type='polar')
def sparta_a8ae1cdb0e():
	type='bubble'
	if conf_settings.IS_DEV:A=_F
	else:A=_G
	B={_I:_L,_J:_M,_K:_N};C=_O;D=_P;return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
