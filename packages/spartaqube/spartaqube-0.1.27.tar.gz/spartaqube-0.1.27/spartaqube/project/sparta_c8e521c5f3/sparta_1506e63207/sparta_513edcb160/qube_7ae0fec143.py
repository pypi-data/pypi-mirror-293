...
plot_example"""}]
def sparta_02df26a76e():return sparta_489e9d6141(type=_N)
def sparta_4b2de3297d():return sparta_489e9d6141(type='gauge2')
def sparta_557dba02bf():
	type='gauge3'
	if conf_settings.IS_DEV:B=_F
	else:B=_G
