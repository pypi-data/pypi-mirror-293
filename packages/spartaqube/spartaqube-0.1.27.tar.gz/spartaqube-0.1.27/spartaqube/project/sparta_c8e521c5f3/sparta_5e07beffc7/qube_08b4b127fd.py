...
def sparta_acdbcebd5e(json_data,userObj):
	A=json_data
	try:D=A[_A];E=A[_C];B=os.path.dirname(D);F,G=sparta_c8c44d1773(B,E);C={_B:1,'files':G,_D:F,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_583c641299(json_data,userObj):
	A=json_data
	try:B=A[_A];D=A[_C];E,F=sparta_c8c44d1773(B,D);C={_B:1,'files':F,_D:E,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_c8c44d1773(currentPath,typeexplorer=None):
...
def sparta_9944893aa4(currentPath):
