...
import pytz
UTC=pytz.utc
def sparta_9d5d25f878():0
def sparta_f7f78cd138():
...
def sparta_fd7bb2457d():
	...
	return A
def sparta_c00353cae1():
	F='res'
	try:
		C=sparta_fd7bb2457d();A=sparta_f7f78cd138();D=AppVersioning.objects.all();E=datetime.now().astimezone(UTC)
