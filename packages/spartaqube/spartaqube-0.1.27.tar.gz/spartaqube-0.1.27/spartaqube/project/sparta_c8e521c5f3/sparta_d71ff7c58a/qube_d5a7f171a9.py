...
def sparta_432c1dddda(user_obj):
	B=user_obj
	...
	return A
def sparta_be5e3e4adf(json_data,user_obj):
...
def sparta_0b82f5d441(json_data,user_obj):
...
def sparta_a0ae88015c(json_data,user_obj):
	...
	return{_C:1}
def sparta_0c4ecc5b3c(json_data,user_obj):
