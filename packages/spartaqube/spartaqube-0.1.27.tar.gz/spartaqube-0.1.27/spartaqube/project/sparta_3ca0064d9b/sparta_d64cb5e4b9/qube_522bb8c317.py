...
from project.sparta_c8e521c5f3.sparta_1bb3f9f2df.qube_fb22d9c045 import IPythonKernel as IPythonKernel
from project.sparta_c8e521c5f3.sparta_1bb3f9f2df.qube_39854beacd import sparta_5e264c135e
...
from project.sparta_3ca0064d9b.sparta_e277eee10c import qube_b6b724ff27 as qube_b6b724ff27
	...
	def receive(A,text_data):
		...
		if len(M)>0:
			...
			if B=='init-socket'or B=='reconnect-kernel':E={G:1,F:B};A.start_kernel();D=json.dumps(E);A.send(text_data=D);return
				...
				O=[];P=[]
				for I in C[S]:
					X=A.kernel_obj.get_workspace_variable(kernel_variable=I);J=sparta_321a3dbf8f(X,variable_name=I);print('workspace_variable_df');print(J);print(type(J))
					try:O.append(sparta_9e6cb636e2(J));P.append(I)
					except:pass
