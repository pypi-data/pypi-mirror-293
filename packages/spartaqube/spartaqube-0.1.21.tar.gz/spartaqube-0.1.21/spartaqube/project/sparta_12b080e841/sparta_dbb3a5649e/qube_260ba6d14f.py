...
def sparta_3206b511a5(user_obj):
	B=user_obj
	...
	return A
def sparta_d49b4e510c(json_data,user_obj):
...
def sparta_b16bc1f3bf(json_data,user_obj):
...
def sparta_50bffd725b(json_data,user_obj):
	...
	return{_C:1}
def sparta_6381feeea8(json_data,user_obj):
