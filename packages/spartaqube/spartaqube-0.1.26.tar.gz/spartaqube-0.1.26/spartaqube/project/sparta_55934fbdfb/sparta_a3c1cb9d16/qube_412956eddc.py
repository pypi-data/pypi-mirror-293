...
def sparta_0be0c9f6dc(user_obj):
	B=user_obj
	...
	return A
def sparta_836eb87e75(json_data,user_obj):
...
def sparta_e84616d44d(json_data,user_obj):
...
def sparta_bcf9ebc840(json_data,user_obj):
	...
	return{_C:1}
def sparta_cc018464f1(json_data,user_obj):
