...
def sparta_d4572259cf(type='line'):
...
plot_example"""}]
def sparta_d3a2a8e9b5():return sparta_d4572259cf(type='line')
def sparta_88c1f6467c():return sparta_d4572259cf(type='bar')
def sparta_7cd915c6ee():return sparta_d4572259cf(type='scatter')
def sparta_5f3d6d9e69():
	if conf_settings.IS_DEV:A=_F
	else:A=_G
...
plot_example"""}]
def sparta_736e8f8bd3(type='pie'):
	if conf_settings.IS_DEV:A=_F
	else:A=_G
...
plot_example"""}]
def sparta_dbd9074bfa():return sparta_736e8f8bd3(type='donut')
def sparta_c8ae50e2ae():return sparta_736e8f8bd3(type='polar')
def sparta_5f9cee1781():
	type='bubble'
	if conf_settings.IS_DEV:A=_F
	else:A=_G
	B={_I:_L,_J:_M,_K:_N};C=_O;D=_P;return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
