...
def sparta_45697774f7(type='realTimeStock'):
...
plot_example"""}]
def sparta_ed472379a2(type='forex'):
...
plot_example"""}]
def sparta_a79012f794(type='tickerTape'):
...
plot_example"""}]
def sparta_cfcb967329():return sparta_a79012f794('tickerWidget')