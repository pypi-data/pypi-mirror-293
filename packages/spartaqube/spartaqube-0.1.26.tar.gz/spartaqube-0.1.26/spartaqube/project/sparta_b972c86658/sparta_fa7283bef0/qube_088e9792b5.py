...
from project.sparta_55934fbdfb.sparta_b897d2512e.qube_cdf6a31a37 import IPythonKernel as IPythonKernel
from project.sparta_55934fbdfb.sparta_b897d2512e.qube_b0cb4f933f import sparta_b7976c2f87
...
from project.sparta_b972c86658.sparta_741716a68d import qube_4982ec8d00 as qube_4982ec8d00
	...
	def receive(A,text_data):
		...
		if len(M)>0:
			...
			if B=='init-socket'or B=='reconnect-kernel':E={G:1,F:B};A.start_kernel();D=json.dumps(E);A.send(text_data=D);return
				...
				O=[];P=[]
				for I in C[S]:
					X=A.kernel_obj.get_workspace_variable(kernel_variable=I);J=sparta_9bc2dc9979(X,variable_name=I);print('workspace_variable_df');print(J);print(type(J))
					try:O.append(sparta_865a89042b(J));P.append(I)
					except:pass
