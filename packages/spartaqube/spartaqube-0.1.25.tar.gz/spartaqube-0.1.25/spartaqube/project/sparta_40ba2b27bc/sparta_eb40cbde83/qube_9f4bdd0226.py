...
def sparta_24b92d0911(json_data,userObj):
	A=json_data
	try:D=A[_A];E=A[_C];B=os.path.dirname(D);F,G=sparta_4851d9831e(B,E);C={_B:1,'files':G,_D:F,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_be7c3a9834(json_data,userObj):
	A=json_data
	try:B=A[_A];D=A[_C];E,F=sparta_4851d9831e(B,D);C={_B:1,'files':F,_D:E,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_4851d9831e(currentPath,typeexplorer=None):
...
def sparta_13688f7adc(currentPath):
