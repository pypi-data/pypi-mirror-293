...
def sparta_bd87841696(type='candlestick'):
...
plot_example"""}]
def sparta_c8a7af45b2(type='line2'):
	if conf_settings.IS_DEV:A=_E
	else:A=_F
...
plot_example"""}]
def sparta_3ae4bb1bb1():return sparta_c8a7af45b2('line2')
def sparta_cd27de130d():return sparta_c8a7af45b2('bar2')
def sparta_3d65ec46ad():return sparta_c8a7af45b2('area2')
def sparta_7276281a26():return sparta_c8a7af45b2('lollipop2')
def sparta_31149f37a5():
