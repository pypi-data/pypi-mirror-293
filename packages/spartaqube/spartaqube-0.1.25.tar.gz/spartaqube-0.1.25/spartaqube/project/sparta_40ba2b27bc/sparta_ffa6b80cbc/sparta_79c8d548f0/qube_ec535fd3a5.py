...
def sparta_c8a7af45b2(type='line'):
...
plot_example"""}]
def sparta_7b5d227572():return sparta_c8a7af45b2(type='line')
def sparta_789c044d15():return sparta_c8a7af45b2(type='bar')
def sparta_a696f80b43():return sparta_c8a7af45b2(type='scatter')
def sparta_41182e12a6():
	if conf_settings.IS_DEV:A=_F
	else:A=_G
...
plot_example"""}]
def sparta_a91c744ab5(type='pie'):
	if conf_settings.IS_DEV:A=_F
	else:A=_G
...
plot_example"""}]
def sparta_55e55b16e5():return sparta_a91c744ab5(type='donut')
def sparta_71dc26bbfc():return sparta_a91c744ab5(type='polar')
def sparta_fd10522d39():
	type='bubble'
	if conf_settings.IS_DEV:A=_F
	else:A=_G
	B={_I:_L,_J:_M,_K:_N};C=_O;D=_P;return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
