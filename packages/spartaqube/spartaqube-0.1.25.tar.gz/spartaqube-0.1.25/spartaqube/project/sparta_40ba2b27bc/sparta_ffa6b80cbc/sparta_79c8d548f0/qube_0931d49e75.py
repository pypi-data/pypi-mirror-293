...
plot_example"""}]
def sparta_d5da8e0b08():return sparta_c8a7af45b2(type=_N)
def sparta_bfbc8f5d2e():return sparta_c8a7af45b2(type='gauge2')
def sparta_be3dc9f2d2():
	type='gauge3'
	if conf_settings.IS_DEV:B=_F
	else:B=_G
