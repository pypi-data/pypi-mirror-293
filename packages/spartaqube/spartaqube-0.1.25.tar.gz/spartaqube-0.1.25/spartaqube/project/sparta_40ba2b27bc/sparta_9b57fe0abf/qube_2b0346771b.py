...
def sparta_3eae803814(user_obj):
	B=user_obj
	...
	return A
def sparta_da49c97393(json_data,user_obj):
...
def sparta_435bf0de46(json_data,user_obj):
...
def sparta_33242d8b04(json_data,user_obj):
	...
	return{_C:1}
def sparta_0f6f235c7d(json_data,user_obj):
