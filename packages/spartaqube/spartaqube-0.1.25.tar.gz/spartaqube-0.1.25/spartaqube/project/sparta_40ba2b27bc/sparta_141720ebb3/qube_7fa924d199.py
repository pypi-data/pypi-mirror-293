...
def sparta_4fc9896c96(is_owner=_A):return{_F:is_owner,_B:_E,_C:_E,_D:_E}
def sparta_194eba8099():return{_F:_A,_B:_A,_C:_A,_D:_A}
def sparta_869b007f80(user_obj,portfolio_obj):
	B=portfolio_obj;A=user_obj
	if B.user==A:return sparta_4fc9896c96(_E)
	F=qube_3228fef6bb.sparta_9cd3e03d0b(A);E=[A.userGroup for A in F]
	...
	if D.count()==0:return sparta_194eba8099()
	G=D[0];C=G.ShareRights
	if C.is_delete:return sparta_194eba8099()
	return{_F:_A,_B:C.is_admin,_C:C.has_write_rights,_D:C.has_reshare_rights}
def sparta_d57f3505a0(user_obj,universe_obj):
	B=universe_obj;A=user_obj
	if B.user==A:return sparta_4fc9896c96()
	F=qube_3228fef6bb.sparta_9cd3e03d0b(A);E=[A.userGroup for A in F]
