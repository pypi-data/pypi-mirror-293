...
class WaveformCls:
	...
	def get_status(self) -> str:
		...
		Queries the status of the ARB Ethernet upload application. \n
			:return: status: string 'not loaded' No waveform data available as source. 'loading' Loads waveform data into the ARB memory of the R&S SMW. The R&S SMW receives the data from the external device connected to the QSFP+ network. 'loaded' Waveform data is loaded into the ARB memory and ready for playback.
		"""
