...
class DvbxCls:
	...
	def get_annex_m(self) -> bool:
		"""SCPI: [SOURce<HW>]:BB:DVB:DVBX:ANNexm \n
		Snippet: value: bool = driver.source.bb.dvb.dvbx.get_annex_m() \n
		No command help available \n
			:return: annex_m: No help available
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:DVB:DVBX:ANNexm?')
		return Conversions.str_to_bool(response)

	def set_annex_m(self, annex_m: bool) -> None:
		"""SCPI: [SOURce<HW>]:BB:DVB:DVBX:ANNexm \n
		Snippet: driver.source.bb.dvb.dvbx.set_annex_m(annex_m = False) \n
		No command help available \n
			:param annex_m: No help available
		"""
		param = Conversions.bool_to_str(annex_m)
		self._core.io.write(f'SOURce<HwInstance>:BB:DVB:DVBX:ANNexm {param}')
