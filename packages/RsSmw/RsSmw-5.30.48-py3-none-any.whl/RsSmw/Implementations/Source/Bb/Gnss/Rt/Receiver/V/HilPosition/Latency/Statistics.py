...
class StatisticsCls:
	...
	class GetStruct(StructBase):
		"""Response structure. Fields: \n
			- Cmd_Hw_Time: float: float The hardware time at the moment the last HIL command is received.
			- Last_Latency: float: float Time delay between the time specified with the parameter ElapsedTime in a HIL command and the time this command is executed in the R&S SMW. Unit: s
