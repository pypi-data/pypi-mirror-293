...
class PatternCls:
	...
	class PatternStruct(StructBase):
		"""Response structure. Fields: \n
			- Cgu_Ci_Pattern: str: 1024 bits Bit pattern
			- Cgu_Ci_Bit_Count: int: integer Pattern length, should be the same as the length set with the command [:SOURcehw]:BB:NR5G:SCHed:CELLcc:SUBFsf:USERus:BWPartbwp:ALLocal:PUSCh:UCI:CGUCi:BITS. Range: 0 to 1024"""
		__meta_args_list = [
