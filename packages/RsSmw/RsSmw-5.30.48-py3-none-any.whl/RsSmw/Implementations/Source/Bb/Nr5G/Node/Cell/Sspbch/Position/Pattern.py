...
class PatternCls:
	...
	class PatternStruct(StructBase):
		"""Response structure. Fields: \n
			- Pattern: str: 64 bits An internally generated sequence according to a bit pattern. Each bit applies to one SS/PBCH block. 1: SS/PBCH block is present 0: SS/PBCH transmission is suppressed.
