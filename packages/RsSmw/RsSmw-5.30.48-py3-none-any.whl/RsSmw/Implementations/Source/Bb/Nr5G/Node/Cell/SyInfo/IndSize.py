...
class IndSizeCls:
	...
	def set(self, indicator_size_12: int, cellNull=repcap.CellNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CC(CH0)>:SYINfo:INDSize \n
		Snippet: driver.source.bb.nr5G.node.cell.syInfo.indSize.set(indicator_size_12 = 1, cellNull = repcap.CellNull.Default) \n
