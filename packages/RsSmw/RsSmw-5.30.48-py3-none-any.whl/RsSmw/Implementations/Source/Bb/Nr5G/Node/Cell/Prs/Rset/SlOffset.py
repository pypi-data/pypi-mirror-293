...
class SlOffsetCls:
	...
	def set(self, prs_rs_slot_offset: int, cellNull=repcap.CellNull.Default, resourceSetNull=repcap.ResourceSetNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CC(CH0)>:PRS:RSET<ST0>:SLOFfset \n
		Snippet: driver.source.bb.nr5G.node.cell.prs.rset.slOffset.set(prs_rs_slot_offset = 1, cellNull = repcap.CellNull.Default, resourceSetNull = repcap.ResourceSetNull.Default) \n
