...
class PatternCls:
	...
	def set(self, pattern: str, bitcount: int, userNull=repcap.UserNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:UBWP:USER<US(CH0)>:DSCH:PATTern \n
		Snippet: driver.source.bb.nr5G.ubwp.user.dsch.pattern.set(pattern = rawAbc, bitcount = 1, userNull = repcap.UserNull.Default) \n
