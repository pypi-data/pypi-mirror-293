...
class DfreqCls:
	...
	def set(self, delta_fto_dc: float, cellNull=repcap.CellNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CC(CH0)>:DFReq \n
		Snippet: driver.source.bb.nr5G.node.cell.dfreq.set(delta_fto_dc = 1.0, cellNull = repcap.CellNull.Default) \n
