...
class SettingCls:
	...
	def delete(self, filename: str) -> None:
		...
		Snippet: driver.source.bb.dm.setting.delete(filename = 'abc') \n
	...
	def load(self, filename: str) -> None:
		...
		Snippet: driver.source.bb.dm.setting.load(filename = 'abc') \n
	...
	def set_store(self, filename: str) -> None:
		...
		Snippet: driver.source.bb.dm.setting.set_store(filename = 'abc') \n
