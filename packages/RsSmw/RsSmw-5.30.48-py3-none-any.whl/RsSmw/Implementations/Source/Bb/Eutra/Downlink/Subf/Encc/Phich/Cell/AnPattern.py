...
class AnPatternCls:
	...
	def set(self, an_pattern: str, subframeNull=repcap.SubframeNull.Default, cellNull=repcap.CellNull.Default, antennaPattern=repcap.AntennaPattern.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.downlink.subf.encc.phich.cell.anPattern.set(an_pattern = 'abc', subframeNull = repcap.SubframeNull.Default, cellNull = repcap.CellNull.Default, antennaPattern = repcap.AntennaPattern.Default) \n
