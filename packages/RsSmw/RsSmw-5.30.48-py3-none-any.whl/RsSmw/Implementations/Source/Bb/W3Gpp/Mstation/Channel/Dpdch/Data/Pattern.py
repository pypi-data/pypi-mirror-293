...
class PatternCls:
	...
	def set(self, pattern: str, bitcount: int, mobileStation=repcap.MobileStation.Default, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.w3Gpp.mstation.channel.dpdch.data.pattern.set(pattern = rawAbc, bitcount = 1, mobileStation = repcap.MobileStation.Default, channel = repcap.Channel.Default) \n
