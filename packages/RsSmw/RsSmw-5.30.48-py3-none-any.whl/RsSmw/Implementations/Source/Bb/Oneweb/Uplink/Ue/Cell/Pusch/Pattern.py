...
class PatternCls:
	...
	def set(self, pattern: str, bitcount: int, userEquipment=repcap.UserEquipment.Default, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.oneweb.uplink.ue.cell.pusch.pattern.set(pattern = rawAbc, bitcount = 1, userEquipment = repcap.UserEquipment.Default, cellNull = repcap.CellNull.Default) \n
