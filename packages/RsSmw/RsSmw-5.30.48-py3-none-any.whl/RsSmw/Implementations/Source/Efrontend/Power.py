...
class PowerCls:
	...
	def get_offset(self) -> float:
		...
		Requires frontend R&S FE170ST. Requires [SOURce<hw>]:EFRontend:AMODe AOFFset. Adds an offset value to the attenuation
		value provided from the external frontend. \n
