...
class RemoteCls:
	...
	def send(self, send_scpi_command: str, iqConnector=repcap.IqConnector.Default) -> None:
		"""SCPI: SCONfiguration:EXTernal:IQOutput<CH>:REMote:SEND \n
		Snippet: driver.sconfiguration.external.iqOutput.remote.send(send_scpi_command = 'abc', iqConnector = repcap.IqConnector.Default) \n
		...
		self._core.io.write(f'SCONfiguration:EXTernal:IQOutput{iqConnector_cmd_val}:REMote:SEND {param}')
