...
class RemoteCls:
	...
	def send(self, send_scpi_command: str, path=repcap.Path.Default) -> None:
		"""SCPI: SCONfiguration:EXTernal:RF<CH>:REMote:SEND \n
		...
		self._core.io.write(f'SCONfiguration:EXTernal:RF{path_cmd_val}:REMote:SEND {param}')
