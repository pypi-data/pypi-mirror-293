...
class RemoteCls:
	...
	def send(self, send_scpi_command: str, digitalIq=repcap.DigitalIq.Default) -> None:
		...
		self._core.io.write(f'SCONfiguration:EXTernal:FADer{digitalIq_cmd_val}:REMote:SEND {param}')
