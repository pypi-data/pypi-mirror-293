...
class ClockCls:
	...
	def get_impedance(self) -> enums.ImpG50G1K:
		...
		Selects the input impedance for the external trigger/clock inputs. \n
			:return: impedance: G50| G1K G50 50 Ohm per ground G1K 1 kOhm per ground G10K For backward compatibility with other Rohde & Schwarz signal generators. The R&S SMW maps this value to G1K.
		"""
	...
	def set_impedance(self, impedance: enums.ImpG50G1K) -> None:
		...
		Selects the input impedance for the external trigger/clock inputs. \n
			:param impedance: G50| G1K G50 50 Ohm per ground G1K 1 kOhm per ground G10K For backward compatibility with other Rohde & Schwarz signal generators. The R&S SMW maps this value to G1K.
		"""
