...
class Is02Cls:
	...
	def set(self, indicator_size_02: int, cellNull=repcap.CellNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CC(CH0)>:SYINfo:IS02 \n
		Snippet: driver.source.bb.nr5G.node.cell.syInfo.is02.set(indicator_size_02 = 1, cellNull = repcap.CellNull.Default) \n
