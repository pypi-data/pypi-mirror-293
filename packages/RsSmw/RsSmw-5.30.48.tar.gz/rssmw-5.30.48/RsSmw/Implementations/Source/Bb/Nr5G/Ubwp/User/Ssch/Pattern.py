...
class PatternCls:
	...
	def set(self, pattern: str, bitcount: int, userNull=repcap.UserNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:UBWP:USER<US(CH0)>:SSCH:PATTern \n
		Snippet: driver.source.bb.nr5G.ubwp.user.ssch.pattern.set(pattern = rawAbc, bitcount = 1, userNull = repcap.UserNull.Default) \n
		Defines a bit pattern as the PSSCH data source.
			INTRO_CMD_HELP: Prerequisites for this command \n
			- Select bit pattern as data source ([:SOURce<hw>]:BB:NR5G:UBWP:USER<us>:SSCH:DATA) . \n
