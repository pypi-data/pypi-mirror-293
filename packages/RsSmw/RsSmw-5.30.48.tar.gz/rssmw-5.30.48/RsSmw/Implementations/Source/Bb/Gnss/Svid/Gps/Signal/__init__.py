...
class SignalCls:
	"""Signal commands group definition. 130 total commands, 3 Subgroups, 0 group commands"""
	...
	@property
	def l1Band(self):
		"""l1Band commands group. 7 Sub-classes, 0 commands."""
	...
	@property
	def l2Band(self):
		"""l2Band commands group. 7 Sub-classes, 0 commands."""
