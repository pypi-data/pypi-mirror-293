...
class PatternCls:
	...
	def set(self, pattern: str, bitcount: int, cell=repcap.Cell.Default, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.source.bb.tdscdma.up.cell.enh.dch.dtch.data.pattern.set(pattern = rawAbc, bitcount = 1, cell = repcap.Cell.Default, channel = repcap.Channel.Default) \n
