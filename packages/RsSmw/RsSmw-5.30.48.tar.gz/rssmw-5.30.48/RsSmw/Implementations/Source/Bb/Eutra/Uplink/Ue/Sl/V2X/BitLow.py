...
class BitLowCls:
	...
	def set(self, pattern: str, bitcount: int, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Sets the subframe bitmap. [:SOURce<hw>]:BB:EUTRa:UL:UE<st>:SL:V2X:BITLow is enabled,
		if [:SOURce<hw>]:BB:EUTRa:UL:UE<st>:SL:V2X:BMPLength10|16|20|30|40|50. \n
			:param pattern: numeric
			:param bitcount: integer Range: 10 to 50
