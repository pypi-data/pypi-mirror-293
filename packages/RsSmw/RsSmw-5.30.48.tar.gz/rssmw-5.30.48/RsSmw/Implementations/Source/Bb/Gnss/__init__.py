...
class GnssCls:
	"""Gnss commands group definition. 2427 total commands, 28 Subgroups, 6 group commands"""
	...
	def set_tmode(self, smode: enums.SimMode2) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TMODe \n
		Snippet: driver.source.bb.gnss.set_tmode(smode = enums.SimMode2.AMSJammer) \n
		Sets the test mode. \n
