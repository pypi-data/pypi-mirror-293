...
class ToaDataCls:
	...
	def get_date(self) -> DateStruct:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ADGeneration:NAVIC:TOAData:DATE \n
		Snippet: value: DateStruct = driver.source.bb.gnss.adGeneration.navic.toaData.get_date() \n
		...
		"""
		return self._core.io.query_struct('SOURce<HwInstance>:BB:GNSS:ADGeneration:NAVIC:TOAData:DATE?', self.__class__.DateStruct())
	...
	def get_time(self) -> TimeStruct:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ADGeneration:NAVIC:TOAData:TIME \n
		Snippet: value: TimeStruct = driver.source.bb.gnss.adGeneration.navic.toaData.get_time() \n
		...
		"""
		return self._core.io.query_struct('SOURce<HwInstance>:BB:GNSS:ADGeneration:NAVIC:TOAData:TIME?', self.__class__.TimeStruct())
