...
class VshiftCls:
	...
	def set(self, lte_vshift: int, cellNull=repcap.CellNull.Default, patternNull=repcap.PatternNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CC(CH0)>:LTE:PATT<ST0>:VSHift \n
		Snippet: driver.source.bb.nr5G.node.cell.lte.patt.vshift.set(lte_vshift = 1, cellNull = repcap.CellNull.Default, patternNull = repcap.PatternNull.Default) \n
