...
class PatternCls:
	...
	def set(self, pattern: str, bitcount: int, cell=repcap.Cell.Default, slotNull=repcap.SlotNull.Default, channelNull=repcap.ChannelNull.Default) -> None:
		...
		Snippet: driver.source.bb.tdscdma.down.cell.slot.channel.data.pattern.set(pattern = rawAbc, bitcount = 1, cell = repcap.Cell.Default, slotNull = repcap.SlotNull.Default, channelNull = repcap.ChannelNull.Default) \n
