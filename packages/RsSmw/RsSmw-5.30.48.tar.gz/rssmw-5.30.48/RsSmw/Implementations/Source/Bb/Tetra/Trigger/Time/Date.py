...
class DateCls:
	...
	def set(self, year: int, month: int, day: int) -> None:
		"""SCPI: [SOURce<HW>]:BB:TETRa:TRIGger:TIME:DATE \n
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:TETRa:TRIGger:TIME:DATE {param}'.rstrip())
	...
	def get(self) -> DateStruct:
		...
		return self._core.io.query_struct(f'SOURce<HwInstance>:BB:TETRa:TRIGger:TIME:DATE?', self.__class__.DateStruct())
