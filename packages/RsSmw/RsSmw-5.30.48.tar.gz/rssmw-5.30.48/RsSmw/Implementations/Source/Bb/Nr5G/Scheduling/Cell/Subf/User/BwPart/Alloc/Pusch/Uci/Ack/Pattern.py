...
class PatternCls:
	...
	class PatternStruct(StructBase):
		"""Response structure. Fields: \n
			- Ack_Pattern: str: 128 bits Bit pattern
			- Ack_Bitcount: int: integer Pattern length, should be the same as the length set with the command [:SOURcehw]:BB:NR5G:SCHed:CELLcc:SUBFsf:USERus:BWPartbwp:ALLocal:PUSCh:UCI:ACK:BITS. Range: 0 to 128"""
		__meta_args_list = [
