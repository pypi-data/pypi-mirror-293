...
class PhOffsetCls:
	...
	def set(self, phase_offset: float, cellNull=repcap.CellNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CC(CH0)>:TMPH:PHOFfset \n
		Snippet: driver.source.bb.nr5G.node.cell.tmph.phOffset.set(phase_offset = 1.0, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default) -> float:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CC(CH0)>:TMPH:PHOFfset \n
		Snippet: value: float = driver.source.bb.nr5G.node.cell.tmph.phOffset.get(cellNull = repcap.CellNull.Default) \n
		Defines a cell specific phase offset. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
