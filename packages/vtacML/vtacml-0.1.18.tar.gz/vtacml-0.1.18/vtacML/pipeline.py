...
class VTACMLPipe:
    ...
    def train(self, save_all_model=False, save_path='outputs/models', resample_flag=False, scoring="f1", cv=5,
              verbose=1, n_jobs=None):
        """
        ...
        for name, model in models.items():
            ...
            grid_search = GridSearchCV(
                self.full_pipeline, param_grid, scoring=scoring, verbose=verbose, cv=cv,
