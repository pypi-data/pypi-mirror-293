...
class ProjectModuleS2tLangIdType(BaseModel):
    ...
    mixed_language_ratio: float = Field(
        ..., ge=0.0, le=1.0, alias="mixed_language_ratio"
    )
...
class ProjectModuleSilenceType(BaseModel):
    ...
    place_begin_threshold: float = Field(
        ..., ge=0.0, le=1.0, alias="place_begin_threshold"
    )
...
class ProjectModulesType(BaseModel):
    ...
    category: (
        ProjectModuleTextCategorySettingsType | ProjectModuleAudioCategorySettingsType
    )
