...
import datetime
from typing import Any, Generator, List, Optional, Tuple, Union, cast, AsyncGenerator
...
def _parse_result(
    response: Any, codes: Tuple[int, ...], error_on_404: bool = True
...
class _Project:
        ...
        **kwargs,
        ...
        if data:
            return self.append_document(
                item_id, data, error_details=error_details, **kwargs
            )
        else:
    ...
    def append_file(
        ...
        **kwargs,
        ...
        """
        results = self.append_files(
            [file_id], language=language, error_details=error_details, **kwargs
        )
    ...
    def append_files(
        ...
        **kwargs,
        ...
        resp = self._client.post(
            f"projects/{self.project_id}/files", json=data, **kwargs
        )
    ...
    def append_document(
        ...
        **kwargs,
        ...
        :return: Статус
        """
        results = self.append_documents(
            {document_id: document_data}, error_details=error_details, **kwargs
        )
        return results[str(document_id)]

    @use_error_details
    def append_documents(
        self, documents_dict: dict, *, error_details: bool = False, **kwargs
    ) -> dict:
        ...
        """
        documents = [
            {"id": id_, "data": data_} for id_, data_ in documents_dict.items()
        ]
        body = {"documents": documents}
        resp = self._client.post(
            f"projects/{self.project_id}/documents", json=body, **kwargs
        )
        result = cast(list, _parse_result(resp, (200, 201), True))
        results = {
            document["id"]: result["status"]
            for document, result in zip(documents, result)
        }
        return results
    ...
    def update_documents(
        ...
        """
        documents = [
            {"id": id_, "op_type": "patch", "data": data_}
            for id_, data_ in documents_dict.items()
        ]
        body = {"documents": documents}
        resp = self._client.post(
            f"projects/{self.project_id}/documents", json=body, **kwargs
        ...
        results = {
            document["id"]: result["status"]
            for document, result in zip(documents, result["documents"])
        }
        return results
    ...
    def get_document(
        ...
        **kwargs,
        ...
        assert isinstance(
            body, dict
        ), "Body must be dict or ProjectGetDocumentBody object"
        resp = self._client.post(
    ...
    def search(
        ...
        **kwargs,
        ...
        resp = self._client.post(
            f"projects/{self.project_id}/realtime/search", json=body, **kwargs
        )
        return cast(dict, _parse_result(resp, (200,), True))
    ...
    def aggregate(
        ...
        **kwargs,
        ...
        assert isinstance(
            body, dict
        ), "Body must be dict or ProjectAggregateBody object"
        resp = self._client.post(
            f"projects/{self.project_id}/realtime/aggregate", json=body, **kwargs
        )
        return cast(dict, _parse_result(resp, (200,), True))
    ...
    @use_error_details
    def append_user(
        self, user_id: str, role_id: str, *, error_details: bool = False, **kwargs
    ) -> List[dict]:
        ...
        """
        results = self.append_users(
            [(user_id, role_id)], error_details=error_details, **kwargs
        )
        return results
    ...
    def append_users(
        ...
        **kwargs,
        ...
        assert users
        data = [
            a if isinstance(a, dict) else {"id": a[0], "role_id": a[1]} for a in users
        ]
        resp = self._client.patch(
            f"projects/{self.project_id}/users", json=data, **kwargs
        )
        return cast(List[dict], _parse_result(resp, (200,), True))

    @use_error_details
    def remove_users(
        self, users: Union[List[str], str], *, error_details: bool = False, **kwargs
    ) -> List[dict]:
    ...
    @use_error_details
    def subjects(
        self, *, error_details: bool = False, **kwargs
    ) -> Optional[List[dict]]:
    ...
    @use_error_details
    def append_subject(
        self, subject_id: str, role_id: str, *, error_details: bool = False, **kwargs
    ) -> dict:
        ...
        resp = self._client.put(
            f"projects/{self.project_id}/subjects/{subject_id}", json=data, **kwargs
        )
        return cast(dict, _parse_result(resp, (200, 201), True))

    @use_error_details
    def remove_subject(
        self, subject_id: str, *, error_details: bool = False, **kwargs
    ) -> None:
        ...
        """
        resp = self._client.delete(
            f"projects/{self.project_id}/subjects/{subject_id}", **kwargs
        )
        _parse_result(resp, (204,), True)
    ...
    def append_checklist(
        ...
        **kwargs,
        ...
        resp = self._client.post(
            f"projects/{self.project_id}/checklists", json=data, **kwargs
        )
        return cast(dict, _parse_result(resp, (200,), True))

    @use_error_details
    def checklist(
        self, checklist_id: str, *, error_details: bool = False, **kwargs
    ) -> Optional[List[dict]]:
        r"""Получить чек-лист
        ...
        resp = self._client.get(
            f"projects/{self.project_id}/checklists/{checklist_id}", **kwargs
        )
        return cast(Optional[List[dict]], _parse_result(resp, (200,), True))
    ...
    def update_checklist(
        ...
        **kwargs,
        ...
        resp = self._client.patch(
            f"projects/{self.project_id}/checklists/{checklist_id}", json=data, **kwargs
        )
        return cast(Optional[List[dict]], _parse_result(resp, (200,), True))
...
class _ProjectAsync:
    ...
    async def append(
        ...
        **kwargs,
        ...
        """
        if data:
            return await self.append_document(
                item_id, data, error_details=error_details, **kwargs
            )
        else:
            return await self.append_file(
                item_id, error_details=error_details, **kwargs
            )
    ...
    async def append_file(
        ...
        **kwargs,
        ...
        :return: True если файл доавблен. Иначе будет выброшено исключение
        """
        results = await self.append_files(
            [file_id], language=language, error_details=error_details, **kwargs
        )
        return results[0]["success"]
    ...
    async def append_document(
        ...
        **kwargs,
        ...
        :return: Статус
        """
        results = await self.append_documents(
            {document_id: document_data}, error_details=error_details, **kwargs
        )
        return results[str(document_id)]
    ...
    async def update_document(
        ...
        **kwargs,
        ...
        :return:
        """
        results = await self.update_documents(
            {document_id: document_data}, error_details=error_details, **kwargs
        )
        return results[str(document_id)]
    ...
    async def get_fields(self, *, error_details: bool = False, **kwargs) -> dict:
        ...
        resp = await self._client.get(
            f"projects/{self.project_id}/realtime/fields", **kwargs
        )
        return cast(dict, _parse_result(resp, (200,), True))
    ...
    async def append_user(
        ...
        :return: Обновляённый список пользователей, принадлежащих проекту
        """
        results = await self.append_users(
            [(user_id, role_id)], error_details=error_details, **kwargs
        )
        return results
    ...
    async def checklists(
        ...
        """
        resp = await self._client.get(
            f"projects/{self.project_id}/checklists", **kwargs
        )
        return cast(Optional[List[dict]], _parse_result(resp, (200,), True))
