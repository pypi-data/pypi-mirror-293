...
class TagsV1Api(object):
    ...
    @validate_arguments
    def delete_tag(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], uuid : Annotated[StrictStr, Field(..., description="Uuid identifier of the entity")], cascade : Annotated[Optional[StrictBool], Field(description="Flag to handle sub-entities.")] = None, **kwargs) -> object:  # noqa: E501
    ...
    @validate_arguments
    def sync_tags(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], body : Annotated[V1EntitiesTags, Field(..., description="Data")], **kwargs) -> object:  # noqa: E501
        """Sync tags  # noqa: E501
