...
class ConnectionsV1Api(object):
    ...
    @validate_arguments
    def delete_connection(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], uuid : Annotated[StrictStr, Field(..., description="Uuid identifier of the entity")], **kwargs) -> object:  # noqa: E501
