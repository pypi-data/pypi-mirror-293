...
def get_qf_from_str(
    ...
    if metric in ("demographic_parity_difference", "demographic_parity_ratio", "equalized_odds_difference", "equalized_odds_ratio"):
        return metric
...
def get_quality_function_from_str(metric: str) -> Callable[[pd.Series, pd.Series], float]:
    ...
    if metric in ("demographic_parity", "dp", "demographic_parity_difference", "demographic_parity_ratio"):
