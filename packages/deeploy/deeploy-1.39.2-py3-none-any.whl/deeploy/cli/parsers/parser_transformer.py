...
def parse_args_transformer(sys_args):
    parser = argparse.ArgumentParser(parents=[kserve.model_server.parser], conflict_handler='resolve')
    parser.add_argument(
        "--model_name",
        type=str,
    ...
    parser.add_argument("--predictor_host",  type=str, help="The host for the predictor", required=True)
    parser.add_argument("--explainer_host",  type=str, help="The host for the explainer", required=False)
