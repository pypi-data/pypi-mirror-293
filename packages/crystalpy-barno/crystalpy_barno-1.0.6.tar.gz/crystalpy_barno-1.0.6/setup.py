...
setup(
    ...
    license="MIT",
    package_dir={'': 'src'},
    packages=find_packages(where='src'),  # Adjusted to find all packages under 'src'
    include_package_data=True,
    package_data={
        "crystalpy_barno_barno.baptu": ["ReportsClasses/CR/*", "ReportsClasses/Helper/*", 
                                        "ReportsClasses/Sales/*", "ReportsClasses/Stock/*", 
                                        "rpt/*"],  # Updated to reflect correct package data structure
    },
