...
class Metrics:
    ...
    def increase_queries_size(self, amount):
        """
        Increase the average size of queries.

        :param amount: The amount to increase by.
        """
        self.average_size_queries += amount
    ...
    def aggregate_convergence(self, converged2):
        """
        Aggregate the convergence status.

        :param converged2: The new convergence status to compare with the current status.
        """
    ...
    def finalize_results(self):
        """
        Finalize and calculate the results of the metrics.
        """
        self.total_time = time.time() - self.start_time

        self.average_size_queries = round(self.average_size_queries / self.membership_queries_count,
    ...
    def __add__(self, other):
        """
        Add the metrics of another Metrics object to this one.

        :param other: The other Metrics object.
        :return: A new Metrics object with aggregated metrics.
        """
        new = self

        new.cl += other.cl
        new.increase_membership_queries_count(other.membership_queries_count)
        new.increase_recommendation_queries_count(other.recommendation_queries_count)
        new.increase_generalization_queries_count(other.generalization_queries_count)
        ...
        new.total_queries_progress.extend(other.total_queries_progress)
        new.membership_queries_progress.extend(other.membership_queries_progress)
        new.recommendation_queries_progress.extend(other.recommendation_queries_progress)
        new.generalization_queries_progress.extend(other.generalization_queries_progress)
