...
class Rest(BaseRest):
    ...
    def __init__(self, file: str = None, server_name: str = None, host: str = None,
                 headers: dict or Serializable = None, cookies: dict or Serializable = None,
                 auth: tuple or Serializable = None, hooks: dict[str, Callable] or Serializable = None,
    ...
    def __request(self, func: callable, kwargs: dict, api_name: str = None, server_name: str = None, host: str = None,
        ...
        req_args = {'auth': self.__auth, 'proxies': self.__proxies, 'hooks': self.__hooks,
        ...
        # noinspection PyBroadException
        try:
            resp: Response or None = self.__action(method_.lower(), url, **req_args)
            if check_status_:
            ...
            arguments = "".join([f'\t{k.ljust(20, " ")} => {v}\n' for k, v in req_args.items() if v])
            try:
