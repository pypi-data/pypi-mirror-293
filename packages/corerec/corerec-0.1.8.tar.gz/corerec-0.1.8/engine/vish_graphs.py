...
try:
    from engine.optimal_path.held_karp import *
except ImportError as e:
    print("Vishesh : Trying Alternative to upload", e)
    try:
        from optimal_path.held_karp import *
    except ImportError as e:
        print("Alternative import method also failed:", e)
