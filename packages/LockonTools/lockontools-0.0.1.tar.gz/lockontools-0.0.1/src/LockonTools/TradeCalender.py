...
calender_path = os.path.join(os.path.dirname(__file__), "calender.json")
calender_days = Series(json.load(open(calender_path)))
calender_days.index = to_datetime(calender_days.index)
