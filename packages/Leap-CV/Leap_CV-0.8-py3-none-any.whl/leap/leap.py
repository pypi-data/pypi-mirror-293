...
def install_linux_dependencies():
    try:
        # Run the command to install LaTeX packages on Linux
        subprocess.check_call(["sudo", "apt-get", "update"])
        
        # Install the required TeX Live packages individually
        subprocess.check_call(["sudo", "apt-get", "install", "-y", "texlive-latex-base"])
        subprocess.check_call(["sudo", "apt-get", "install", "-y", "texlive-latex-extra"])
        subprocess.check_call(["sudo", "apt-get", "install", "-y", "texlive-fonts-recommended"])
        subprocess.check_call(["sudo", "apt-get", "install", "-y", "texlive-fonts-extra"])
        subprocess.check_call(["sudo", "apt", "install", "-y", "xetex"])
