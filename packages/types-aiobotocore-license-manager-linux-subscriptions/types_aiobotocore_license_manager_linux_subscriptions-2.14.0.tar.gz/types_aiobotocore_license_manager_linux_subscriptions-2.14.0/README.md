...
[aiobotocore.LicenseManagerLinuxSubscriptions 2.14.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/license-manager-linux-subscriptions.html#LicenseManagerLinuxSubscriptions)
...
async with session.create_client("license-manager-linux-subscriptions") as client:
    ...
    list_registered_subscription_providers_paginator: (
        ListRegisteredSubscriptionProvidersPaginator
