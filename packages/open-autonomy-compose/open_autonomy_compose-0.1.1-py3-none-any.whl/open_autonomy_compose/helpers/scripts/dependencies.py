...
#
# ------------------------------------------------------------------------------
# pylint: disable=import-error, cyclic-import, too-few-public-methods
...
from aea.configurations.data_types import Dependency  # type: ignore[import]
from aea.package_manager.base import load_configuration  # type: ignore[import]
...
class Pipfile:
    ...
    ignore = []  # type: ignore[var-annotated]
...
class ToxFile:
    ...
    skip = []  # type: ignore[var-annotated]
