...
from beancount_import.data_types import Transaction
from beancount_import.utils import strip_txn_base_path
...
type Extractor = typing.Callable[[], typing.Generator[Transaction, None, None]]
type ExtractorFactory = typing.Callable[[typing.TextIO], Extractor]


def get_extractor(extrator_name: str) -> ExtractorFactory | None:
    extractor = None

    def import_extractor() -> typing.Any:
        try:
            return import_module(extrator_name)
        except ImportError:
            return None
