...
class ConnectCasesClient(AioBaseClient):
    ...
    async def delete_field(self, *, domainId: str, fieldId: str) -> Dict[str, Any]:
        """
    ...
    async def delete_layout(self, *, domainId: str, layoutId: str) -> Dict[str, Any]:
        """
    ...
    async def delete_template(self, *, domainId: str, templateId: str) -> Dict[str, Any]:
        """
