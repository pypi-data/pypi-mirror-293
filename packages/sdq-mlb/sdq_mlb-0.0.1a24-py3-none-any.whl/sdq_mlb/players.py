...
class Players(UserDict):
    ...
    @overload
    def fetch(
        self, stats: Literal[False] = False, reload: bool = True, from_db: bool = False
    ) -> Self: ...

    @overload
    async def fetch(
        self, stats: Literal[True] = True, reload: bool = True, from_db: bool = False
    ) -> Self: ...

    @overload
    async def fetch(
        self, stats: bool = True, reload: bool = False, from_db: Literal[True] = True
    ) -> Self: ...

    def fetch(
        self, stats: bool = False, reload: bool = True, from_db: bool = True
