    ...
    def _compute_features(self):
        ...
        if self.features_hourly_features_fps is not None:
            ...
            for feature_name in self.features:
                if feature_name in self._measurements_data:
                    feature = self._measurements_data[feature_name]
                else:
                    feature_fp = self.features_hourly_features_fps[feature_name]
                    ...
                    self._measurements_data[feature_name] = feature
