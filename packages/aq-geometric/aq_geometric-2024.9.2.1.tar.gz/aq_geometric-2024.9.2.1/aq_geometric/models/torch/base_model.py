...
class TorchBaseModelAdapter(BaseModel, torch.nn.Module):
    ...
    def forward(self, graph: Data) -> torch.Tensor:
        ...
        raise NotImplementedError(
            "Forward pass not implemented in the base adapter.")
    ...
    def fit(self, train_set: TorchGeometricDatasetAdapter,
            ...
            loss_fn: Optional[torch.nn.Module] = None, **kwargs) -> None:
        """
        ...
        """
        raise NotImplementedError(
            "Training not implemented for the base model.")
    ...
    def inverse_transform_predictions(self, predictions: torch.Tensor, *args,
                                      **kwargs) -> torch.Tensor:
        """
    ...
    def shuffle_in_batches(self, iterable, batch_size=5):
        ...
        batches = [[i for i in range(v, min(v + batch_size, len(iterable)))]
                   for v in range(0, len(iterable), batch_size)]
