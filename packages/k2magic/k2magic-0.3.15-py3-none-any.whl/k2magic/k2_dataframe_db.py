...
class K2DataFrameDB(DataFrameDB):
    ...
    def __init__(self, repo_url: Union[str, URL], schema=None, db_port: int = None, debug: bool = False):
        ...
        print(f"Disclosed url: {str(self.db_url_obj)}")
    ...
    def get_repo_file(self, dest_path: str, start_time: Union[str, int, datetime],
        ...
        api_url = (
            f"{protocol}://{self.repo_url_obj.host}:{self.repo_url_obj.port}/api/v2/repo-data/{self.repo_url_obj.database}/download"
    ...
    def _disclose_db_url(self) -> URL:
        ...
        if storage == 'postgresql':
            ...
            if jdbc_url_obj.host == 'postgresql' or jdbc_url_obj.host == 'k2a-postgresql':
