...
class RsSmbv:
	...
	_driver_options = "SupportedInstrModels = SMW/SMBV/SMCV, SupportedIdnPatterns = SMW/SMBV/SMCV, SimulationIdnString = 'Rohde&Schwarz,SMBV100B,100001,5.30.48.0029'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		Parameter options tokens examples:
			...
			- ``LogToGlobalTarget = True`` - Sets the logging target to the class-property previously set with RsSmbv.set_global_logging_target() Default: ``False``
		...
		self._core.driver_version = '5.30.48.0029'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '5.30.48.0029'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsSmbv version failed. Current version: '5.30.48.0029', minimum required version: '{min_version}'")
	...
	def _sync_to_custom_properties(self, cloned: 'RsSmbv') -> None:
	...
	def sconfiguration(self):
		"""sconfiguration commands group. 6 Sub-classes, 1 commands."""
	...
	@property
	def source(self):
		"""source commands group. 34 Sub-classes, 1 commands."""
	...
	@property
	def system(self):
		"""system commands group. 39 Sub-classes, 28 commands."""
	...
	@property
	def test(self):
		"""test commands group. 11 Sub-classes, 6 commands."""
