...
class SeparatorCls:
	...
	def get_decimal(self) -> enums.DexchSepDec:
		...
		Snippet: value: enums.DexchSepDec = driver.source.pulm.train.dexchange.afile.separator.get_decimal() \n
	...
	def set_decimal(self, decimal: enums.DexchSepDec) -> None:
		"""SCPI: [SOURce<HW>]:PULM:TRAin:DEXChange:AFILe:SEParator:DECimal \n
		Snippet: driver.source.pulm.train.dexchange.afile.separator.set_decimal(decimal = enums.DexchSepDec.COMMa) \n
		Sets '.' (decimal point) or ',' (comma) as the decimal separator used in the ASCII data with floating-point numerals. \n
