...
class TiptCls:
	...
	def set(self, tipt: enums.BtoCsTiP1, channelNull=repcap.ChannelNull.Default) -> None:
		...
		Snippet: driver.source.bb.btooth.cs.sevent.mthree.tipt.set(tipt = enums.BtoCsTiP1.TIP1_10, channelNull = repcap.ChannelNull.Default) \n
	...
	def get(self, channelNull=repcap.ChannelNull.Default) -> enums.BtoCsTiP1:
		"""SCPI: [SOURce<HW>]:BB:BTOoth:CS:[SEVent<CH0>]:MTHRee:TIPT \n
		Snippet: value: enums.BtoCsTiP1 = driver.source.bb.btooth.cs.sevent.mthree.tipt.get(channelNull = repcap.ChannelNull.Default) \n
		No command help available \n
			:param channelNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Sevent')
