...
class DselectCls:
	...
	def set(self, dselect: str, baseStation=repcap.BaseStation.Default, groupNull=repcap.GroupNull.Default, offset=repcap.Offset.Default) -> None:
		...
		Snippet: driver.source.bb.c2K.bstation.cgroup.coffset.data.dselect.set(dselect = 'abc', baseStation = repcap.BaseStation.Default, groupNull = repcap.GroupNull.Default, offset = repcap.Offset.Default) \n
