...
class BertCls:
	...
	def load(self, filename: str) -> None:
		"""SCPI: BERT:LOAD \n
		Snippet: driver.bert.load(filename = 'abc') \n
	...
	class ResultStruct(StructBase):  # From ReadStructDefinition CmdPropertyTemplate.xml
		...
		__meta_args_list = [
			...
			ArgStruct.scalar_float('Error_Rate'),
	...
	def set_store(self, filename: str) -> None:
		"""SCPI: BERT:STORe \n
		Snippet: driver.bert.set_store(filename = 'abc') \n
	...
	def clone(self) -> 'BertCls':
		"""Clones the group by creating new object from it and its whole existing subgroups
		Also copies all the existing default Repeated Capabilities setting,
		which you can change independently without affecting the original group"""
		new_group = BertCls(self._core, self._cmd_group.parent)
