...
class SlOffsetCls:
	...
	def set(self, prs_res_slot_off: int, cellNull=repcap.CellNull.Default, resourceSetNull=repcap.ResourceSetNull.Default, resourceNull=repcap.ResourceNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CC(CH0)>:PRS:RSET<ST0>:RES<DIR0>:SLOFfset \n
		Snippet: driver.source.bb.nr5G.node.cell.prs.rset.res.slOffset.set(prs_res_slot_off = 1, cellNull = repcap.CellNull.Default, resourceSetNull = repcap.ResourceSetNull.Default, resourceNull = repcap.ResourceNull.Default) \n
