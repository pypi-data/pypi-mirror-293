...
class DselectCls:
	...
	def set(self, dselect: str, baseStation=repcap.BaseStation.Default, channelNull=repcap.ChannelNull.Default) -> None:
		...
		Snippet: driver.source.bb.w3Gpp.bstation.channel.fdpch.dpcch.tpc.data.dselect.set(dselect = 'abc', baseStation = repcap.BaseStation.Default, channelNull = repcap.ChannelNull.Default) \n
