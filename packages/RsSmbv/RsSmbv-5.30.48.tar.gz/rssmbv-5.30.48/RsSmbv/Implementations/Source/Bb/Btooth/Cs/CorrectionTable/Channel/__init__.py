...
class ChannelCls:
	"""Channel commands group definition. 4 total commands, 4 Subgroups, 0 group commands
	...
	@property
	def callowed(self):
		"""callowed commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_callowed'):
			from .Callowed import CallowedCls
			self._callowed = CallowedCls(self._core, self._cmd_group)
		return self._callowed
