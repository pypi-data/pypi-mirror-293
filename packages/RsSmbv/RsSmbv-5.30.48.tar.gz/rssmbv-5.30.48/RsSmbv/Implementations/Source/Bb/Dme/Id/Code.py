...
class CodeCls:
	...
	def get_state(self) -> bool:
		"""SCPI: [SOURce<HW>]:[BB]:DME:ID:CODE:STATe \n
		Snippet: value: bool = driver.source.bb.dme.id.code.get_state() \n
		No command help available \n
			:return: state: No help available
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:DME:ID:CODE:STATe?')
	...
	def set_state(self, state: bool) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:DME:ID:CODE:STATe {param}')

	def get_value(self) -> str:
		"""SCPI: [SOURce<HW>]:[BB]:DME:ID:CODE \n
		...
		is sent uncoded (key down) . \n
			:return: code: string
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:DME:ID:CODE?')
	...
	def set_value(self, code: str) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:DME:ID:CODE {param}')
