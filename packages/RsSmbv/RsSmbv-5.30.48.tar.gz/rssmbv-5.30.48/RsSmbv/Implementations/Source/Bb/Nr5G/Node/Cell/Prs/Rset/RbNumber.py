...
class RbNumberCls:
	...
	def set(self, prs_rs_num_rb: int, cellNull=repcap.CellNull.Default, resourceSetNull=repcap.ResourceSetNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CC(CH0)>:PRS:RSET<ST0>:RBNumber \n
		Snippet: driver.source.bb.nr5G.node.cell.prs.rset.rbNumber.set(prs_rs_num_rb = 1, cellNull = repcap.CellNull.Default, resourceSetNull = repcap.ResourceSetNull.Default) \n
