...
class NresourcesCls:
	...
	def set(self, prs_num_res: int, cellNull=repcap.CellNull.Default, resourceSetNull=repcap.ResourceSetNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CC(CH0)>:PRS:RSET<ST0>:NRESources \n
		Snippet: driver.source.bb.nr5G.node.cell.prs.rset.nresources.set(prs_num_res = 1, cellNull = repcap.CellNull.Default, resourceSetNull = repcap.ResourceSetNull.Default) \n
