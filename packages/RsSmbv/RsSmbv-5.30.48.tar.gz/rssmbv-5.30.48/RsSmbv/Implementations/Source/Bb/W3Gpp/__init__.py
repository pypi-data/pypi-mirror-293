...
class W3GppCls:
	...
	def get_lreference(self) -> enums.WcdmaLevRef:
		...
		Determines the power reference for the calculation of the output signal power in uplink direction. \n
			:return: reference: RMS| DPCC| PMP| LPP| EDCH| HACK| PCQI RMS RMS Power DPCC First DPCCH PMP PRACH Message Part LPP Last PRACH Preamble EDCH Requires R&S SMBVB-K83. First E-DCH HACK Requires R&S SMBVB-K83. First HARQ-ACK PCQI Requires R&S SMBVB-K83. First PCI/CQI
		"""
	...
	def set_lreference(self, reference: enums.WcdmaLevRef) -> None:
		...
		Determines the power reference for the calculation of the output signal power in uplink direction. \n
			:param reference: RMS| DPCC| PMP| LPP| EDCH| HACK| PCQI RMS RMS Power DPCC First DPCCH PMP PRACH Message Part LPP Last PRACH Preamble EDCH Requires R&S SMBVB-K83. First E-DCH HACK Requires R&S SMBVB-K83. First HARQ-ACK PCQI Requires R&S SMBVB-K83. First PCI/CQI
		"""
