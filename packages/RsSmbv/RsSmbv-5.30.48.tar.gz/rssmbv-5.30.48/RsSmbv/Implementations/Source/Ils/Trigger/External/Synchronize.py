...
class SynchronizeCls:
	...
	def get_output(self) -> bool:
		"""SCPI: [SOURce<HW>]:ILS:TRIGger:EXTernal:SYNChronize:OUTPut \n
		Snippet: value: bool = driver.source.ils.trigger.external.synchronize.get_output() \n
		No command help available \n
			:return: output: No help available
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:ILS:TRIGger:EXTernal:SYNChronize:OUTPut?')
	...
	def set_output(self, output: bool) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:ILS:TRIGger:EXTernal:SYNChronize:OUTPut {param}')
