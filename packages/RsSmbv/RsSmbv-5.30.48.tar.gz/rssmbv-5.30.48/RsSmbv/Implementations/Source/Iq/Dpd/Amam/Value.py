...
class ValueCls:
	...
	def get_level(self) -> float:
		...
		Queries the delta power value for the current root mean square (RMS) power level of the generated RF signal. \n
			:return: delta_power: float Range: -20 to 20
		"""
	...
	def get_pep(self) -> float:
		...
		Queries the delta power value for the current peak envelope power (PEP) level of the generated RF signal. \n
			:return: delta_power: float Range: -20 to 20
		"""
