...
class RepetitionCls:
	...
	def get_value(self) -> str:
		...
		Snippet: value: str = driver.source.pulm.train.hopping.repetition.get_value() \n
		No command help available \n
			:return: repetition: No help available
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:PULM:TRAin:HOPPing:REPetition?')
		return trim_str_response(response)

	def set_value(self, repetition: str) -> None:
		"""SCPI: [SOURce<HW>]:PULM:TRAin:HOPPing:REPetition \n
		Snippet: driver.source.pulm.train.hopping.repetition.set_value(repetition = 'abc') \n
		No command help available \n
			:param repetition: No help available
		"""
		param = Conversions.value_to_quoted_str(repetition)
