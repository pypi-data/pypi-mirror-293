...
class StateCls:
	...
	def get(self, digitalIq=repcap.DigitalIq.Default) -> bool:
		"""SCPI: SCONfiguration:EXTernal:FADer<CH>:IQConnection:STATe \n
		Snippet: value: bool = driver.sconfiguration.external.fader.iqConnection.state.get(digitalIq = repcap.DigitalIq.Default) \n
		...
		response = self._core.io.query_str(f'SCONfiguration:EXTernal:FADer{digitalIq_cmd_val}:IQConnection:STATe?')
