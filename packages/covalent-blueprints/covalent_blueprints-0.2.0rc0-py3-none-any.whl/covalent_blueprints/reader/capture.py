...
def capture_cloud_calls():
    ...
    def _capture_lattice_declaration(_func=None, **kwargs):
        ...
        def _capture_lattice_wrapper(_func=None):
            ...
            captured_lattice = CapturedLatticeDeclaration(
                lattice_obj, _func, **kwargs)
    ...
    def _capture_dispatch(*args, **kwargs):
        ...
        bp_log.debug(
            "Captured dispatch:\n%s",
            pformat(captured_dispatch.__dict__)
        )
    ...
    def _capture_deploy(*args, **kwargs):
        ...
        bp_log.debug(
            ...
            pformat(captured_deploy_args.__dict__)
        )
    ...
    def _capture_cloud_executor(*args, **kwargs):
        ...
        bp_log.debug(
            ...
            pformat(captured_executor.__dict__)
        )
    ...
    with \
            ...
            patch("covalent.electron", _capture_electron_declaration), \
