...
def set_metadata(bp: CovalentBlueprint, func: Callable) -> None:
    """Set the example and input documentation for a blueprint.

    Args:
        bp: a CovalentBlueprint object.
        func: the initializer function for the blueprint.
    """
    bp.example = get_usage_example(func)
    bp.inputs.docs = get_input_docs(func)
...
def get_input_docs(func: Callable) -> Dict[str, Optional[str]]:
    """Get a dictionary mapping parameter names to their documentation.
