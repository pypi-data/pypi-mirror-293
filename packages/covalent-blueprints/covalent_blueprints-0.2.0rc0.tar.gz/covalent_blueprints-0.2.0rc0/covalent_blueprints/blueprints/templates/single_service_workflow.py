...
"""Templates for Covalent scripts that run a workflow that executes
a single electron and deploys a single service."""
...
class ServiceWorkflowExecutorMap(ExecutorMap):
    ...
    def set_executor_key(self, electron_key: str, service_key: str) -> None:
        """Set the executor keys for the service workflow deployment."""
