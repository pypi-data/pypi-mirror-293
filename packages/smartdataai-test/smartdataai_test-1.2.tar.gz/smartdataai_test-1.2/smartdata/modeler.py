...
class SmartData:
    ...
    def extract_code_from_response(self, response):
        ...
        try:
            ...
            if (1 in last_response and len(last_response[1]) == 0) or (1 not in last_response) or (not any(substring in last_response[1].lower() for substring in self.check_plot_error_substring_list)):
