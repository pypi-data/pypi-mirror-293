...
def show_params_function_task(**kwargs):
    ...
    work_day_start_interval = task_instance.xcom_pull(task_ids='get_config_task', key='work_day_start_interval')
    ...
    print(f"Pulled parameter value: work_day_start_interval: {str(work_day_start_interval)}")
...
def query_task(**kwargs):
    ...
    check_time_raise(work_day_start_interval,work_day_end_interval)
