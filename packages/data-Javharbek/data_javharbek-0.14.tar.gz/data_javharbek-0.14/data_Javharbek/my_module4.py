...
def convert_to_utf8(byte_string):
    # Определение кодировки
    result = chardet.detect(byte_string)
    encoding = result['encoding']

    # Декодирование из исходной кодировки
...
def execute_task_one_transform_task(transform_task, transform_plan, index):
    ...
    script_python_3 = convert_to_utf8(script_python_3)
    script_python_3_init = convert_to_utf8(script_python_3_init)
