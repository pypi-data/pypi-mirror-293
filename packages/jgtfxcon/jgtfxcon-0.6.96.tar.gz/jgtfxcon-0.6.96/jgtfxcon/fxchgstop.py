...
def change_trade(fx, trade):
    ...
    if future_validation_stop:
        ...
        if not quiet or not stop_entry_validated:
            print_jsonl_message(msg,extra_dict={"last_close":last_close_price,"stop_rate":stopv,"bs":trade.buy_sell})
    ...
    if FXTRADE_DEBUG_FLAG:
        ...
        print_jsonl_message(fxtrade.message,extra_dict={"filepath":saved_filepath})
