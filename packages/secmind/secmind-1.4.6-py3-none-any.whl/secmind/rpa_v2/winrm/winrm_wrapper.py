...
class WinRMWrapper(ChainCommand):
    ...
    def execute_command(self, command):
        ...
        std_out_encoding = chardet.detect(result.std_out)['encoding']
        std_err_encoding = chardet.detect(result.std_err)['encoding']
        return {
            'status_code': result.status_code,
            'std_out': result.std_out.decode(std_out_encoding),
            'std_err': result.std_err.decode(std_err_encoding)
        }
