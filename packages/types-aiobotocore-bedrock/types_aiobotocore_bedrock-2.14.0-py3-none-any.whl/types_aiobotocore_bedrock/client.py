...
class BedrockClient(AioBaseClient):
    ...
    async def batch_delete_evaluation_job(
        self, *, jobIdentifiers: Sequence[str]
    ) -> BatchDeleteEvaluationJobResponseTypeDef:
        """
    ...
    async def create_model_import_job(
        ...
        *,
        ...
        jobTags: Sequence[TagTypeDef] = ...,
        importedModelTags: Sequence[TagTypeDef] = ...,
        clientRequestToken: str = ...,
        vpcConfig: VpcConfigUnionTypeDef = ...,
    ...
    async def delete_custom_model(self, *, modelIdentifier: str) -> Dict[str, Any]:
        """
    ...
    async def delete_imported_model(self, *, modelIdentifier: str) -> Dict[str, Any]:
        """
    ...
    async def get_custom_model(self, *, modelIdentifier: str) -> GetCustomModelResponseTypeDef:
        """
    ...
    async def get_evaluation_job(self, *, jobIdentifier: str) -> GetEvaluationJobResponseTypeDef:
        """
    ...
    async def get_imported_model(self, *, modelIdentifier: str) -> GetImportedModelResponseTypeDef:
        """
    ...
    async def get_inference_profile(
        self, *, inferenceProfileIdentifier: str
    ) -> GetInferenceProfileResponseTypeDef:
        """
    ...
    async def get_model_copy_job(self, *, jobArn: str) -> GetModelCopyJobResponseTypeDef:
        """
    ...
    async def get_model_import_job(self, *, jobIdentifier: str) -> GetModelImportJobResponseTypeDef:
        """
    ...
    async def stop_evaluation_job(self, *, jobIdentifier: str) -> Dict[str, Any]:
        """
    ...
    async def stop_model_customization_job(self, *, jobIdentifier: str) -> Dict[str, Any]:
        """
    ...
    async def stop_model_invocation_job(self, *, jobIdentifier: str) -> Dict[str, Any]:
        """
