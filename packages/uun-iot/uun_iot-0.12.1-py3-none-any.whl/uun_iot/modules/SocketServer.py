...
from uun_iot import EvStart, EvStop, EvExternal
...
class SocketServer(Module):
    ...
    def start(self, evs):
        ...
        sel.register(pipe_r, selectors.EVENT_READ, lambda pipe, mask: logger.debug("stopping socket server"))
