...
class Make(Utility.AbstractBase):
    ...
    def __init__(self, BuildID, Srcs, scratch=os.getcwd(), verbose=0, *args, **kwargs):
        ...
        if 'win' in sys.platform:   
            ...
            if kwargs.get("initialize",True): self.iniCompiler = self.setup(**kwargs)[-1]
        ...
        ## Default version of Microsoft visual studio used by the Intel Fortran Compiler. Defaults to 'vs2010'.
    ...
    def setup(*args, **kwargs): # pragma: no cover
        ...
        # Initialize and create tool chain for Visual Studio on Windows
        elif kwargs.get("msvsc",'vs2015') in ["vs2015","vs2017"]: # pragma: no cover
            ...
            # Return all paths
            return (None, None, msvsc_shell_initialization )
        pass
...
class Custom(Make):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Add additional MKL dependencies. Only when source files
        ...
        # Use an exception to allow help message to be printed.
            ...
            if AllowDefaultMakeOption:         
                ...
                py2x(BuildID,
                        ...
                        command=VTL.GetBuildCommand(0, _format="free"),    
                        ...
                        output=os.path.join(os.path.join(__mcd_core_path,"bin",Utility.GetPlatform(),__arch)), incremental=True, foss=__foss)            
                # Build BoxBeam    
                BuildID = 'bbeam' 
                py2x(BuildID,
...
class PyInstaller(Make):
    ...
    def Build(self, mode="onefile", **kwargs):
        ...
        if Utility.GetPlatform() in ["windows"]: # pragma: no cover
            ...
            if Utility.GetExecutable("upx"): self.makecmd.append(Utility.GetExecutable("upx", get_path=True)[-1])
    ...
    def parse(cls, **kwargs): # pragma: no cover
        ...
        try:
            ...
            settings = {"script":file,
                                "source":source, "output":output, "scratch":scratch, "include":include,
                                "dependency":dependency, "mode":mode, "encryption": encryption, 
                                "verbosity":verbosity}
        # Use an exception to allow help message to be printed.
        except Exception as _:
            BuildID = "PyCODAC"
