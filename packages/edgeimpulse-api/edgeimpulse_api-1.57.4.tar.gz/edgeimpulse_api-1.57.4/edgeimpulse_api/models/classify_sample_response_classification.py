...
class ClassifySampleResponseClassification(BaseModel):
    ...
    anomaly_result: Optional[List[AnomalyResult]] = Field(None, alias="anomalyResult", description="Anomaly scores and computed metrics for GMM anomaly detection, one item per window.")
