...
class ModelPrediction(BaseModel):
    ...
    anomaly_scores: Optional[List[List[float]]] = Field(None, alias="anomalyScores", description="Only set for visual anomaly projects. 2D array of shape (n, n) with raw anomaly scores, where n can be calculated as ((1/8 of image input size)/2 - 1). The scores corresponds to each grid cell in the image's spatial matrix.")
