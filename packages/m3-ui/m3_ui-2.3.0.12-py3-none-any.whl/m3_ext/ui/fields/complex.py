...
class ExtDictSelectField(BaseExtTriggerField):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Энкодер, который будет дампить поле. Можно указать любого наследника JSONEncoder, например M3JSONEncoder,
        # который более всеяден.
    ...
    def render_params(self):
        ...
        for args in (
            ...
            ('recordValue', json.dumps(self.record_value, cls=self.encoder), self.record_value),
        ):
