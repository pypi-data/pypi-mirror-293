...
def stream_process(command, timeout=10.0):
    """Runs a command and yields output line by line, allowing input."""
    ...
    # Capture any remaining output or errors
...
def install_command(
    ...
    try:
        ...
        if requirements:
            ...
            result =stream_process(package_install_cmd)
            err = False
            for line in result:
                if line == " ":
                    err = True
