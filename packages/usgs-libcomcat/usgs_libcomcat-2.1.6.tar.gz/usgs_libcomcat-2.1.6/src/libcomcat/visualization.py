...
class Timeline:
    def __init__(self, max_time, dataframe, event_details):
        if max_time > 5760:
            self.max_time = 5760
    ...
    def finite_fault_text(self):
        ...
        ffault = self.event_details.getProducts("finite-fault")[0]
    ...
    def oaf_data(self):
        ...
        for i in range(0, 5):
            occurrences.append(jdict["observations"][i]["count"])
