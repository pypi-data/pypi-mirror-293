...
def reconnect(cluster_filepath,
    ...
    result_file = f"{outfile_prefix}-all_clusters.json"
...
def main(args=None):
    ...
    reconnect(args.cluster_filepath, args.network_filepath, args.outfile_prefix, args.lb, args.ub, args.lr, args.connectivity_threshold, args.metric, args.max_proteins, args.clusters_labeled, args.modify_clusters)
...
def get_args(parser=None):
    ...
    parser.add_argument("--outfile-prefix", help = "Output file prefix", type = str, required=True)
