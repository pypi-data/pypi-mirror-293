...
def cook(cluster_filepath,
    ...
    reconnect(cluster_filepath, network_filepath, output_prefix, lb, ub, lr, cthresh, metric, max_proteins, clusters_labeled, False)
    parse(cluster_filepath, network_filepath, dsd_file, protein_go_filepaths, go_db_file, output_prefix, f"{output_prefix}-all_clusters.json", threshold, cthresh, metric, readdition_threshold)

    
def main(args=None):
    if args is None:
        args = get_args().parse_args()
    cook(args.cluster_filepath, args.network_filepath, args.dsd_file, args.protein_go_filepaths, args.go_db_file, args.output_prefix, args.clusters_labeled, args.threshold, args.connectivity_threshold, args.lr, args.metric, args.lb, args.ub, args.max_proteins, args.readdition_threshold)
