...
window.vm = new Vue({
  ...
  data: {
    ...
    autoCopy: true,
    useXPathOnly: false,
    platform: localStorage.platform || 'AndroidADB',
  ...
  watch: {
    ...
    serial: function (newval) {
      var deviceId = this.connectDevicesMaps[newval];
      if (deviceId) {
  ...
  methods: {
    ...
    doConnect: function () {
      ...
      return $.ajax({
        ...
        .then((ret) => {
          ...
          this.connectDevicesMaps[this.deviceUrl] = this.deviceId
    ...
    drawAllNodeFromSource: function (source) {
      ...
      function sourceToNodes(source) {
        ...
        if (resourceId) {
          node["resourceId"] = resourceId.substring(resourceId.indexOf('/') + 1)
        }
