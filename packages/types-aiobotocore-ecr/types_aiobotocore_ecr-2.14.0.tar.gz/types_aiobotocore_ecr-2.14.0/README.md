...
[aiobotocore.ECR 2.14.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ecr.html#ECR)
...
async with session.create_client("ecr") as client:
    ...
    describe_repository_creation_templates_paginator: (
        DescribeRepositoryCreationTemplatesPaginator
