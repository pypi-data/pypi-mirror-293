...
from typing import Union, Tuple, Optional, Type, NamedTuple
...
MESH_TYPE = Union[Int[Array, "n_x_points*n_z_points*n_radius 3"], Float[Array, "n_x_points*n_z_points*n_radius 3"]]
...
class FailureBox:
    ...
    mesh: MESH_TYPE = field(init=False)
...
class StabilityConfig:
    ...
    failure_box: FailureBox = FailureBox((80, 110), (3, 30), (3, 70))
...
@dataclass
class FORMResults:
    rf_chains: Float[Array, "n_form_chains n_rf_cells"]
    fos_chains: Float[Array, "n_form_chains"]
    beta_chains: Float[Array, "n_form_chains"]
    failure_circle_chains: Float[Array, "n_form_chains 3"]
    converged_chains: Bool[Array, "n_form_chains"]
