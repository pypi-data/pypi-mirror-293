...
def inject_references_to_messages(
    messages, references, critiques=None, length_control=False
):
    ...
    if critiques is not None:
        ...
        if length_control:
            system += "The fused response can only be as long as the longest response in the current candidate pool.\n"
        system += "Responses from models:\n\n"
