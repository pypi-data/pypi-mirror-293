...
class ProductTemplate(models.Model):
    ...
    inverter_id = fields.Many2one(comodel_name='photovoltaic.inverter', compute='_compute_inverter')
    ...
    type = fields.Selection(related='inverter_id.type')
    ...
    module_id = fields.Many2one(comodel_name='photovoltaic.module', compute='_compute_module')
