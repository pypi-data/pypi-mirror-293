...
from hestia_earth.validation.utils import (
    update_error_path, _filter_list_errors, _next_error, _value_average, is_number,
...
def _get_term_recalculated_max_delta(term: dict):
    ...
    return safe_parse_float(
        get_table_value(download_lookup('emission.csv'), 'termid', term_id, column_name(col_name)),
        5
    ) / 100
