# src/uml_generator/main.py

from uml_generator.core.diagram_drawer import DiagramDrawer
from uml_generator.core.project_analyzer import ProjectAnalyzer
from uml_generator.core.diagram_converter import DiagramConverter

def generate_uml(project_directory, language_type, output_file):
    """
