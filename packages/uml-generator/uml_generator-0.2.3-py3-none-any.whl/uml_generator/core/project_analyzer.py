# src/uml_generator/core/project_analyzer.py

import os
from uml_generator.types.languages import LANGUAGES
from uml_generator.models.uml_diagram import UMLDiagram
from uml_generator.parsers.java_parser import JavaParser
