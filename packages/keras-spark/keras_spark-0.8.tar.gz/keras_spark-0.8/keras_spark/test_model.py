...
from keras_spark.model import SparkKerasModel
...
class TestPredict(unittest.TestCase):
    ...
    def test_predict_1(self):
        ...
        with tf.distribute.OneDeviceStrategy("cpu:0").scope():
            ...
            model = SparkKerasModel(inputs=inputs, outputs=outputs)
            model.compile(optimizer='adam', loss='binary_crossentropy')

        # Train the model using the Spark DataFrame
        df = model.predict(spark_df, batch_size=10, epochs=10,partition_col="partition_id",nr_partitions=1)
    ...
    def test_predict_2(self):
        ...
        with tf.distribute.OneDeviceStrategy("cpu:0").scope():
            ...
            model = SparkKerasModel(inputs=inputs, outputs=[output1, output2])
            model.compile(optimizer='adam', loss='binary_crossentropy')
...
class TestTrain(unittest.TestCase):
    ...
    def test_fit_1(self):
        ...
        # Train the model using the Spark DataFrame
        model.fit(spark_df, batch_size=10, epochs=10,partition_col="partition_id",nr_partitions=1)
    ...
    def test_fit_2(self):
        ...
        # Train the model using the Spark DataFrame
        model.fit(spark_df, batch_size=10, epochs=10,partition_col="partition_id",nr_partitions=2)
    ...
    def test_string_classifier(self):
        ...
        with strategy.scope():
            ...
            model = SparkKerasModel(inputs=input, outputs=nn(hashl(input)))
            model.compile(optimizer='adam', loss='binary_crossentropy')

        model.fit(spark_df, batch_size=10, epochs=30,partition_col="partition_id",nr_partitions=2)
    ...
    def test_higher_dims(self):
        ...
        with strategy.scope():
            ...
            model = SparkKerasModel(inputs=input_3d, outputs=dense(input_3d))
