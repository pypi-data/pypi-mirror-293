...
# def flex_cast(value, target_dtype):
#     current_dtype = value.dtype.name
#     try:
#         if (current_dtype != "string" and target_dtype != "string"):
#             return tf.cast(value, target_dtype)
#         elif current_dtype != "string" and target_dtype == "string":
#             return tf.cast(tf.strings.as_string(value), target_dtype)
#         elif current_dtype == "string" and target_dtype != "string":
#             return tf.cast(tf.strings.to_number(value), target_dtype)
#         else:
#             return value
