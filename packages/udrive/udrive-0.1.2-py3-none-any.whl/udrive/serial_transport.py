...
class SerialStreamTransport(udrive.protocol.StreamSource, udrive.protocol.StreamSink):
    ...
    while not cancellation_token.is_set():
        ...
        for port_name in new_ports:
            try:
                ...
                input_stream = udrive.protocol.PacketFromStreamConverter(serial_device)
                output_stream = udrive.protocol.StreamBasedPacketSink(serial_device)
