...
class EnglishTextInput:
    def __init__(self,text='',empty_text='Input Some Text',
                 ...
                 ,textsize=24,textfile=None):
        
        self.new_data(text,empty_text,back_color,cback_color,
                      text_color,notext_color,textsize,textfile)
    ...
    def connect_page(self,page):
        ...
        self.drawlist.connect(self.changeText,'ChangeText')
    ...
    def draw_background(self,screen):
        ...
        self.DrawBack_cen=pygame.draw.rect(screen,NowColor,self.rect,width=0,
                                       border_radius=6)
    
    def draw_text(self,screen):
        pass
    
    def changeText(self,screen):
    ...
    def new_data(self,text='',empty_text='Input Some Text',
                 back_color=(158,158,158),cback_color=(96,96,96),
                 text_color=(256,256,256),notext_color=(200,200,200)
                 ,centercolor=(128,128,128)
                 ,textsize=24,textfile=None,width=256,outline=3):
