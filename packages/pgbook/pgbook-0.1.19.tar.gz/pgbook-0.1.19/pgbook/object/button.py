...
class TextButton(BaseButton):
    ...
    def draw(self,screen):
        self.rect.height=self.text.textbook.get_rect().height+2*self.outline
        self.rect.width=self.text.TextSize+2*self.outline#self.text.textbook.get_rect().width+2*self.outline
        super().draw(screen)
