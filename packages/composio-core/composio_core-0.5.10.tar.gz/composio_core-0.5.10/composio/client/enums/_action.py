...
class Action(_AnnotatedEnum[ActionData], path=ACTIONS_CACHE):
    ...
    OKTA_ADD_X_509_CERTIFICATE_PUBLIC_KEY: 'Action'
    ...
    OKTA_GENERATE_X_509_CERTIFICATE_FOR_APP_KEY: 'Action'
    ...
    OKTA_GRANT_OAUTH_2_0_SCOPE_CONSENT_FOR_APP: 'Action'
    ...
    WHATSAPP_GET_METRICS_SINCE_V2_21_3: 'Action'
