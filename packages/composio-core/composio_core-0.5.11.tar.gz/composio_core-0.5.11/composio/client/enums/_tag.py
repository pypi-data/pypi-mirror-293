...
class Tag(_AnnotatedEnum[TagData], path=TAGS_CACHE):
    ...
    GITHUB_TEAMS: 'Tag'
    GITHUB_USERS: 'Tag'
    GITLAB_ACCESS_REQUESTS: 'Tag'
    GITLAB_ADMIN: 'Tag'
    GITLAB_ALERT_MANAGEMENT: 'Tag'
    GITLAB_APPLICATION: 'Tag'
    GITLAB_APPLICATIONS: 'Tag'
    GITLAB_AVATAR: 'Tag'
    GITLAB_BADGES: 'Tag'
    GITLAB_BATCHED_BACKGROUND_MIGRATIONS: 'Tag'
    GITLAB_BRANCHES: 'Tag'
    GITLAB_BROADCAST_MESSAGES: 'Tag'
    GITLAB_BULK_IMPORTS: 'Tag'
    GITLAB_CI_VARIABLES: 'Tag'
    GITLAB_CLUSTERS: 'Tag'
    GITLAB_IMPORTANT: 'Tag'
    GITLAB_JOBS: 'Tag'
    GITLAB_METADATA: 'Tag'
    GITLAB_MIGRATIONS: 'Tag'
    GITLAB_PLAN_LIMITS: 'Tag'
    HUBSPOT_BASIC: 'Tag'
    HUBSPOT_BATCH: 'Tag'
    HUBSPOT_CORE: 'Tag'
    HUBSPOT_EVENTS: 'Tag'
    ...
    SLACK_VIEWS: 'Tag'
    SLACK_WORKFLOWS: 'Tag'
    SOUNDCLOUD_IMPORTANT: 'Tag'
    SOUNDCLOUD_LIKES: 'Tag'
    SOUNDCLOUD_ME: 'Tag'
    SOUNDCLOUD_MISCELLANEOUS: 'Tag'
    SOUNDCLOUD_OAUTH: 'Tag'
    SOUNDCLOUD_PLAYLISTS: 'Tag'
    SOUNDCLOUD_REPOSTS: 'Tag'
    SOUNDCLOUD_SEARCH: 'Tag'
    SOUNDCLOUD_TRACKS: 'Tag'
    SOUNDCLOUD_USERS: 'Tag'
    SPOTIFY_ALBUMS: 'Tag'
    SPOTIFY_ARTISTS: 'Tag'
