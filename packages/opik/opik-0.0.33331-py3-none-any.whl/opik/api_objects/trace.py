...
class Trace:
    def __init__(
        ...
        """
        A Trace object. This object should not be created directly, instead using :meth:`opik.Comet.trace` or
        :func:`opik.comet_context.get_current_trace` if you are using function decorators.
        """
        self.id = id
