...
from opik.api_objects import span, comet, trace
from opik import dict_utils
from opik import comet_context
...
class CometTracer(BaseTracer):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._comet_client = comet.get_client_cached()
    ...
    def _track_root_run(self, run_dict: Dict[str, Any]) -> None:
        ...
        current_span = comet_context.get_current_span()
        ...
        current_trace = comet_context.get_current_trace()
    ...
    def _initialize_span_and_trace_from_scratch(
        ...
        trace_ = self._comet_client.trace(
            name=run_dict["name"],
            input=run_dict["inputs"],
    ...
    def flush(self) -> None:
        """
        Flush to ensure all data is sent to the Comet server.
        """
        self._comet_client.flush()

    def created_traces(self) -> List[trace.Trace]:
        """
        Get a list of traces created by CometTracer.
