...
class CometApi:
    ...
    environment : CometApiEnvironment
        The environment to use for requests from the client. from .environment import CometApiEnvironment



        Defaults to CometApiEnvironment.DEFAULT
    ...
    def __init__(
        ...
        *,
        ...
        environment: CometApiEnvironment = CometApiEnvironment.DEFAULT,
...
def _get_base_url(
    *, base_url: typing.Optional[str] = None, environment: CometApiEnvironment
) -> str:
