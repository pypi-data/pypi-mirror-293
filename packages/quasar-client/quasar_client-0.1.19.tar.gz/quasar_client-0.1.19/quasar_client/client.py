...
from .resources.text_line_detect import AsyncTextLineDetectorResource, SyncTextLineDetectorResource
...
class Quasar(OpenAI):
    ...
    def __init__(
        self,
        quasar_base: str,
        enable_v2: Optional[bool] = False,
        quasar_v2_base: Optional[str] = None,
        split_v2_percentage: Optional[float] = None,
        *args,
        **kwargs,
    ) -> None:
        ...
        self.classifier = SyncClassifierResource(self.quasar_base, **quasar_resource_kwargs)
        ...
        self.extractor = SyncExtractorResource(self.quasar_base, **quasar_resource_kwargs)
...
class AsyncQuasar(AsyncOpenAI):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        kwargs["base_url"] = urljoin(self.quasar_base, "/predictions/v1")
        super().__init__(*args, **kwargs)
        self.classifier = AsyncClassifierResource(self.quasar_base, **quasar_resource_kwargs)
        ...
        self.extractor = AsyncExtractorResource(self.quasar_base, **quasar_resource_kwargs)
