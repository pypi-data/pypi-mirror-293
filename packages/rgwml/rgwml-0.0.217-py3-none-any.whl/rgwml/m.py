        ...
        try:
            if token:
                ...
                if idinfo:
                    ...
                    #response = make_response(jsonify(response_data), 200).set_cookie('authToken', token, httponly=True, secure=True, domain=cookie_domain, samesite='None')
                    response = make_response(jsonify(response_data), 200).set_cookie('authToken', token, domain=cookie_domain, samesite='None')
