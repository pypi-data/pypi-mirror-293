...
class m:
    ...
    def send_secure_data(self, invoking_function_name, secure_data, sqlite_db_path, telegram_bot_preset_name, google_client_id, access_control_allow_origin_url):
        ...
        try:
            ...
            if access_control_allow_origin_url:
                response.headers["Access-Control-Allow-Origin"] = access_control_allow_origin_url
