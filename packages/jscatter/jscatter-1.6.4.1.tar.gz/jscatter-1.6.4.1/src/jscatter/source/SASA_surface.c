 ...
 *
 * Changed to python 3 compatibility Ralf Biehl 2021
 */
...
surface1atom(PyObject *dummy, PyObject *args)
{
  ...
  /* generate tesselation sphere if needed */
...
static struct PyModuleDef moduledef = {
        ...
        "surface",
        "Module for determination of solvent-accessible surface area (SASA)",
        -1,
        surface_methods,
        NULL,
        NULL,
...
PyInit_surface(void)
{
    ...
    /* Check for errors */
    if (module == NULL)
        Py_FatalError("can't initialize module surface");
return module;
}
