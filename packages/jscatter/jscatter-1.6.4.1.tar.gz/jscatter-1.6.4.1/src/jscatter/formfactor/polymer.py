...
def wormlikeChain(q, N, a, R=None, SLD=1, solventSLD=0, rtol=0.02):
    ...
    **Micellar wormlike structure** with core shell disc cross section.
    ...
    fz = FZ(q, z)
    I1 = scipy.integrate.simpson(fz, z, axis=0)
    I2 = scipy.integrate.simpson(fz * z, z, axis=0)
    P0 = 2. / x * (I1 - I2 / x)
    ...
    while True:
        ...
        I1 = scipy.integrate.simpson(nfz, nz, axis=0)
        I2 = scipy.integrate.simpson(nfz * nz, nz, axis=0)
        nP0 = 2. / x * (I1 - I2 / x)
