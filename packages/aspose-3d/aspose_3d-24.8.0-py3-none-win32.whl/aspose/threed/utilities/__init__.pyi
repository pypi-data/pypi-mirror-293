...
class DummyFileSystem(FileSystem):
    ...
    def read_file(self, file_name : str, options : aspose.threed.formats.IOConfig) -> io.RawIOBase:
        ...
        :param options: Instance of :py:class:`aspose.threed.formats.IOConfig` used in loading/saving'''
        ...
...
class LocalFileSystem(FileSystem):
    ...
    def read_file(self, file_name : str, options : aspose.threed.formats.IOConfig) -> io.RawIOBase:
        ...
        :param options: :py:class:`aspose.threed.formats.IOConfig` instance used in loading/saving
        :returns: Stream for reading the file.'''
        ...
...
class MemoryFileSystem(FileSystem):
    ...
    def write_file(self, file_name : str, options : aspose.threed.formats.IOConfig) -> io.RawIOBase:
        ...
        :returns: Stream for writing the stream.'''
        ...
...
class ZipArchiveFileSystem(FileSystem):
    ...
    def write_file(self, file_name : str, options : aspose.threed.formats.IOConfig) -> io.RawIOBase:
        ...
        :returns: No return, this is a read-only file system.'''
        ...
