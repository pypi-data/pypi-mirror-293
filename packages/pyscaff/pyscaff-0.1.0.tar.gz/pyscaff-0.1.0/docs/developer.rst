...
.. warning::
   ...
   `pyscaff` package. If you just want to write code that uses it
...
In your terminal, change to the directory where you cloned `pyscaff`.
...
This virtual environment contains all the Pyscaff dependencies and a few useful
...
.. _available on GitHub: https://gitlab.com/jdhp-dev/pyscaff
...
.. _TODO.md: https://gitlab.com/jdhp-dev/pyscaff/blob/master/TODO.md
