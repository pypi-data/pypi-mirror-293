...
version="test"
global_container_folder = ""
currentDir = os.path.dirname(os.path.abspath(__file__))
if version == "test":
    global_container_folder = os.path.join(currentDir, "data")
else:
    global_container_folder = os.path.join(currentDir, "node_modules", "tigrina_alphabets_coder_decoder", "data")
