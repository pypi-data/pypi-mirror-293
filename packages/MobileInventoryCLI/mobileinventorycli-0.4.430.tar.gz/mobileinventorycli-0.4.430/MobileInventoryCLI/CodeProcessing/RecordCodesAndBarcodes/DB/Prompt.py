...
{Fore.light_green}ne{Fore.light_steel_blue} - create a new entry menu{Style.reset}
{Fore.light_green}se{Fore.light_steel_blue} - search entry menu{Style.reset}
                '''
                print(extra)
            else:
                #print(func)
...
'''
            ...
            if cmd.endswith("#c2cbe"):
                ...
                print(helpText)
                extra=f'''{Fore.light_steel_blue}{Style.underline}Access from anywhere But {Fore.light_red}Root{Style.reset}
{Fore.light_yellow}{'.'*os.get_terminal_size().columns}{Style.reset}
{Fore.light_green}ne{Fore.light_steel_blue} - create a new entry menu{Style.reset}
{Fore.light_green}se{Fore.light_steel_blue} - search entry menu{Style.reset}
