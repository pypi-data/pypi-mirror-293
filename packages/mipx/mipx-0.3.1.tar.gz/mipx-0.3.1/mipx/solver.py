...
# @Author  : luyi
from typing import Any, Generator, List, Literal, Union, Tuple, Dict
...
class Model:
    ...
    def __init__(self, solver_id: Literal["SCIP", "CBC", "CP", "SAT", "CLP", "CPLEX", "CPLEX_CP", "GLOP", "BOP"] = "SCIP", name=""):
        super().__init__()
    ...
    def _get_update_lub(self, lb, ub: Any, vtype: Vtype):
