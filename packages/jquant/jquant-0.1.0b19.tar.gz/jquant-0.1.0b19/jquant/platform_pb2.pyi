...
class Kline(_message.Message):
    __slots__ = ("timestamp", "platform", "instrument", "resolution", "open", "high", "low", "close", "volume", "info", "extend")
    class ExtendEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    info: str
    extend: _containers.ScalarMap[str, str]
    def __init__(self, timestamp: _Optional[int] = ..., platform: _Optional[str] = ..., instrument: _Optional[str] = ..., resolution: _Optional[str] = ..., open: _Optional[str] = ..., high: _Optional[str] = ..., low: _Optional[str] = ..., close: _Optional[str] = ..., volume: _Optional[str] = ..., info: _Optional[str] = ..., extend: _Optional[_Mapping[str, str]] = ...) -> None: ...
...
class Instrument(_message.Message):
    __slots__ = ("platform", "kind", "id", "name", "price_tick", "volume_tick", "long_margin_ratio", "short_margin_ratio", "max_leverage", "volume_multiple", "max_order_size", "min_order_size", "is_trading", "exchange_id", "info", "extend", "updated_time")
    class ExtendEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
