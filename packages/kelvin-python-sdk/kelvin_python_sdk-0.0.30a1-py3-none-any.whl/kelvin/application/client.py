...
class KelvinApp:
    ...
    def __init__(self, config: KelvinStreamConfig = KelvinStreamConfig()) -> None:
        ...
        self.on_asset_change: Optional[Callable[[AssetInfo], Awaitable[None]]] = None
