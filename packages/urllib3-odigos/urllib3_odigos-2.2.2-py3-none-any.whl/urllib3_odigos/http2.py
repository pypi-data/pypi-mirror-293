...
import urllib3_odigos.connection
...
def inject_into_urllib3() -> None:
    ...
    urllib3_odigos.connection.HTTPSConnection = HTTP2Connection  # type: ignore[misc]

    # TODO: Offer 'http/1.1' as well, but for testing purposes this is handy.
    urllib3_odigos.util.ssl_.ALPN_PROTOCOLS = ["h2"]


def extract_from_urllib3() -> None:
    HTTPSConnectionPool.ConnectionCls = orig_HTTPSConnection
    urllib3_odigos.connection.HTTPSConnection = orig_HTTPSConnection  # type: ignore[misc]

    urllib3_odigos.util.ssl_.ALPN_PROTOCOLS = ["http/1.1"]
