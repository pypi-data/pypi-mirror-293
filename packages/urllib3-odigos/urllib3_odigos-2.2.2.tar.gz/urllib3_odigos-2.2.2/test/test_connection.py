...
from urllib3_odigos.connection import (  # type: ignore[attr-defined]
    RECENT_DATE,
    CertificateError,
    HTTPConnection,
    HTTPSConnection,
...
from urllib3_odigos.exceptions import HTTPError, ProxyError, SSLError
from urllib3_odigos.util import ssl_
from urllib3_odigos.util.request import SKIP_HEADER
from urllib3_odigos.util.ssl_match_hostname import (
    CertificateError as ImplementationCertificateError,
)
from urllib3_odigos.util.ssl_match_hostname import _dnsname_match, match_hostname

if typing.TYPE_CHECKING:
    from urllib3_odigos.util.ssl_ import _TYPE_PEER_CERT_RET_DICT
