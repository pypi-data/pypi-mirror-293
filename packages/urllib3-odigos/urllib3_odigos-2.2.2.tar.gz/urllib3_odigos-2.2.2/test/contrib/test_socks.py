...
from urllib3_odigos.contrib import socks
from urllib3_odigos.exceptions import ConnectTimeoutError, NewConnectionError

try:
    import ssl

    from urllib3_odigos.util import ssl_ as better_ssl
