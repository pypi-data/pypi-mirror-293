...
try:
    from urllib3_odigos.contrib.pyopenssl import extract_from_urllib3, inject_into_urllib3
except ImportError:
    pass
...
def setup_module() -> None:
    try:
        from urllib3_odigos.contrib.pyopenssl import inject_into_urllib3
...
def teardown_module() -> None:
    try:
        from urllib3_odigos.contrib.pyopenssl import extract_from_urllib3
