...
from urllib3_odigos.fields import _TYPE_FIELD_VALUE_TUPLE
...
def test_index(
    ...
    def pyodide_test(selenium_coverage, host: str, port: int) -> None:  # type: ignore[no-untyped-def]
        from urllib3_odigos.connection import HTTPConnection
        from urllib3_odigos.response import BaseHTTPResponse
...
def test_pool_requests(
    ...
    def pyodide_test(selenium_coverage, host: str, port: int, https_port: int) -> None:  # type: ignore[no-untyped-def]
        ...
        http = urllib3_odigos.PoolManager()
        ...
        pool = urllib3_odigos.HTTPConnectionPool(host, port, maxsize=1, block=True)
        ...
        # data is read
        pool2 = urllib3_odigos.HTTPConnectionPool(host, port, maxsize=1, block=True)
...
def test_timeout_warning(
    ...
    def pyodide_test(selenium_coverage, host: str, port: int) -> None:  # type: ignore[no-untyped-def]
        ...
        import urllib3_odigos.contrib.emscripten.fetch
        from urllib3_odigos.connection import HTTPConnection
        ...
        assert urllib3_odigos.contrib.emscripten.fetch._SHOWN_TIMEOUT_WARNING
...
def test_index_https(
    ...
    @run_in_pyodide  # type: ignore[misc]
    def pyodide_test(selenium_coverage, host: str, port: int) -> None:  # type: ignore[no-untyped-def]
        from urllib3_odigos.connection import HTTPSConnection
        from urllib3_odigos.response import BaseHTTPResponse
...
def test_non_streaming_no_fallback_warning(
    ...
    def pyodide_test(selenium_coverage, host: str, port: int) -> None:  # type: ignore[no-untyped-def]
        ...
        assert not urllib3_odigos.contrib.emscripten.fetch._SHOWN_STREAMING_WARNING
...
def test_streaming_fallback_warning(
    ...
    def pyodide_test(selenium_coverage, host: str, port: int) -> None:  # type: ignore[no-untyped-def]
        ...
        urllib3_odigos.contrib.emscripten.fetch.is_cross_origin_isolated = lambda: False
        ...
        assert urllib3_odigos.contrib.emscripten.fetch._SHOWN_STREAMING_WARNING
...
def test_specific_method(
    ...
    @run_in_pyodide  # type: ignore[misc]
    def pyodide_test(selenium_coverage, host: str, port: int) -> None:  # type: ignore[no-untyped-def]
        from urllib3_odigos import HTTPSConnectionPool
...
def test_upload(
    ...
    @run_in_pyodide  # type: ignore[misc]
    def pyodide_test(selenium_coverage, host: str, port: int) -> None:  # type: ignore[no-untyped-def]
        from urllib3_odigos import HTTPConnectionPool
...
def test_response_init_length(
    ...
    def pyodide_test(selenium_coverage, host: str, port: int) -> None:  # type: ignore[no-untyped-def]
        ...
        import urllib3_odigos.exceptions
        from urllib3_odigos.connection import HTTPConnection
        from urllib3_odigos.response import BaseHTTPResponse
        ...
        with pytest.raises(urllib3_odigos.exceptions.InvalidHeader):
...
def test_retries(
    ...
    def pyodide_test(selenium_coverage, host: str, port: int) -> None:  # type: ignore[no-untyped-def]
        ...
        pool = urllib3_odigos.HTTPConnectionPool(
            host,
            port,
            maxsize=1,
            block=True,
            retries=urllib3_odigos.util.Retry(connect=5, read=5, redirect=5),
        )

        # monkeypatch connection class to count calls
        old_request = urllib3_odigos.connection.HTTPConnection.request
        count = 0
        ...
        urllib3_odigos.connection.HTTPConnection.request = count_calls  # type: ignore[method-assign]
        with pytest.raises(urllib3_odigos.exceptions.MaxRetryError):
            pool.urlopen("GET", "/")
