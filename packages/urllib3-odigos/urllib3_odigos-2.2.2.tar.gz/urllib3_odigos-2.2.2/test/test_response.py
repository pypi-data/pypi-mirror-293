...
from urllib3_odigos import HTTPHeaderDict
...
from urllib3_odigos.response import (  # type: ignore[attr-defined]
    BaseHTTPResponse,
    BytesQueueBuffer,
    HTTPResponse,
    brotli,
)
from urllib3_odigos.util.response import is_fp_closed
