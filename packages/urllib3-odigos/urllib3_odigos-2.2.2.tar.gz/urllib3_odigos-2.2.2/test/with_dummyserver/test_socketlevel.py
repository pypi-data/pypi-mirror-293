...
from urllib3_odigos import HTTPConnectionPool, HTTPSConnectionPool, ProxyManager, util
from urllib3_odigos._collections import HTTPHeaderDict
from urllib3_odigos.connection import HTTPConnection, _get_default_user_agent
from urllib3_odigos.connectionpool import _url_from_pool
...
from urllib3_odigos.poolmanager import proxy_from_url
from urllib3_odigos.util import ssl_, ssl_wrap_socket
...
class TestMultipartResponse(SocketDummyServerTestCase):
    def test_multipart_assert_header_parsing_no_defects(self) -> None:
        ...
        from urllib3_odigos.connectionpool import log
