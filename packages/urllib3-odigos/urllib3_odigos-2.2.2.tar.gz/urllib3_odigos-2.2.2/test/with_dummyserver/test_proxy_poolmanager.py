...
from urllib3_odigos import HTTPResponse
from urllib3_odigos._collections import HTTPHeaderDict
from urllib3_odigos.connection import VerifiedHTTPSConnection
from urllib3_odigos.connectionpool import connection_from_url
...
from urllib3_odigos.poolmanager import ProxyManager, proxy_from_url
from urllib3_odigos.util.ssl_ import create_urllib3_context
from urllib3_odigos.util.timeout import Timeout
...
class TestHTTPProxyManager(HypercornDummyProxyTestCase):
    ...
    def test_proxy_conn_fail_from_dns(
        ...
        with proxy_from_url(
            ...
            assert isinstance(
                e.value.reason.original_error, urllib3_odigos.exceptions.NameResolutionError
            )
...
class TestHTTPSProxyVerification:
    ...
    def test_https_proxy_no_san_hostname_checks_common_name(
        ...
        proxy_ctx = urllib3_odigos.util.ssl_.create_urllib3_context()
        try:
