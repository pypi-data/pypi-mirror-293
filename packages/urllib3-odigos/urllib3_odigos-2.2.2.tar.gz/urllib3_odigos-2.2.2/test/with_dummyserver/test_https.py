...
import urllib3_odigos.util as util
import urllib3_odigos.util.ssl_
...
from urllib3_odigos.connection import RECENT_DATE, HTTPSConnection, VerifiedHTTPSConnection
...
from urllib3_odigos.util.ssl_match_hostname import CertificateError
...
class BaseTestHTTPS(HTTPSHypercornDummyServerTestCase):
    ...
    def test_set_cert_inherits_cert_reqs_from_ssl_context(
        ...
        ssl_context = urllib3_odigos.util.ssl_.create_urllib3_context(cert_reqs=verify_mode)
    ...
    def test_default_ssl_context_ssl_min_max_versions(self) -> None:
        ctx = urllib3_odigos.util.ssl_.create_urllib3_context()
