...
setup(
    ...
    install_requires=['### package_auto_assembler.py', 'pip_audit==2.7.3', 'nbformat', 'pandas==2.1.1', 'attrs>=22.2.0', 'requests', 'pyyaml', 'mkdocs==1.6.0', 'numpy==1.26.0', 'stdlib-list', 'nbconvert', 'click==8.1.7', 'nbconvert==7.16.4'],
    ...
    author="Kyrylo Mordan", author_email="parachute.repo@gmail.com", description="A tool to automate package creation within ci based on just .py and optionally .ipynb file.", keywords="['python', 'packaging']", version="0.4.3"
)
