...
from PlayDrissionPage._drisson_page.page_plus import PagePlus

ChromiumPageSelf = typing.TypeVar("ChromiumPage", bound=typing.Union[ChromiumPage, PagePlus])
...
class RemoteBrowserClient:
    ...
    @classmethod
    def inject_plus(cls, page) -> typing.Union[PagePlus, ChromiumPage]:
        page = PagePlus(page)
        page = typing.cast(typing.Union[PagePlus, ChromiumPage], page)
        return page
