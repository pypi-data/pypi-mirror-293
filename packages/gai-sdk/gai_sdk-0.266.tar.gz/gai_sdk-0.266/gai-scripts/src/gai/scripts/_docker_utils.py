...
#     # Retrieve the file path from the caller's frame
#     caller_path = caller_frame.f_globals['__file__']
#     # Use os.path to handle the file path correctly
#     here = os.path.dirname(os.path.abspath(caller_path))

#     # initialize project path. NOTE: pyproject.toml will be used as the marker file where the rest of the files will be relative to.
