...
from lynq.backendutils.lynq.pycache_remover import remove_pycache_from
from lynq.backendutils.lynq.pycache_remover import PYCACHE_REMOVAL_LOCATIONS
...
VERSION: Final[tuple[int, str, str]] = (6, "v6mj", "Lynq v6 MAJOR")
