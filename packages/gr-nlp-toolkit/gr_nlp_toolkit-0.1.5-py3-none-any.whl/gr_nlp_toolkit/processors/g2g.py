    ...
    def __init__(self, mode = 'LSTM', model_path = None, tokenizer_path = None, device = 'cpu'):
        ...
        if self.mode == 'LSTM':
            ...
            if model_path is None:
                model_path = os.path.join(os.path.dirname(__file__), '..', 'RBNLM_weights', 'LSTM_LM_50000_char_120_32_512.pt')

            if tokenizer_path is None:
                tokenizer_path = os.path.join(os.path.dirname(__file__), '..', 'RBNLM_weights', 'RBNLMtextVectorizer.pkl')            
