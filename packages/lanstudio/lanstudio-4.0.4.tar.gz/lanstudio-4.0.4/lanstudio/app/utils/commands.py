...
from lanstudio.app.utils import thumbnail as thumbnail_utils
from lanstudio.app.stores import auth_tokens_store, file_store
...
def dump_database(store=False):
    ...
    filename = f"lanstudio-db-backup-{now}.sql.gz"
    if store:
