...
from lanstudio.app.utils import dbhelpers
from lanstudio.app.utils.env import envtobool, env_with_semicolon_to_list
...
TMP_DIR = os.getenv("TMP_DIR", os.path.join(tempfile.gettempdir(), "lanstudio"))
...
JOB_QUEUE_NOMAD_PLAYLIST_JOB = os.getenv(
    "JOB_QUEUE_NOMAD_PLAYLIST_JOB", "lanstudio-playlist"
)
JOB_QUEUE_NOMAD_NORMALIZE_JOB = os.getenv("JOB_QUEUE_NOMAD_NORMALIZE_JOB", "")
JOB_QUEUE_NOMAD_HOST = os.getenv("JOB_QUEUE_NOMAD_HOST", "lanstudio-nomad-01.lanstudio")
...
LDAP_BASE_DN = os.getenv("LDAP_BASE_DN", "cn=Users,dc=lanstudio,dc=local")
LDAP_GROUP = os.getenv("LDAP_GROUP", "")
LDAP_DOMAIN = os.getenv("LDAP_DOMAIN", "lanstudio.local")
