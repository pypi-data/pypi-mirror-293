...
from lanstudio.app.utils import dbhelpers, auth, commands
from lanstudio.app.services import persons_service, auth_service
...
from lanstudio import __file__ as root_path
...
def version():
    ...
    """
    from lanstudio import __version__

    print(f"lanstudio version: {__version__}")
...
def clear_memory_cache():
    ...
    from lanstudio.app import cache
...
def dump_database(store=False):
    """
    Dump database described in lanstudio environment variables and save it to
