...
__version__ = importlib.metadata.version("andersan")
...
@deprecated(
    ...
    details="Use code(zoom, lon, lat) instead.",
)
...
@deprecated(
    ...
    removed_in="1.0",
    current_version=__version__,
    details="Use lonlat(zoom, lon, lat) instead.",
)
...
@deprecated(
    ...
    removed_in="1.0",
    current_version=__version__,
    details="Use bounding_box(zoom, ...) instead.",
)
