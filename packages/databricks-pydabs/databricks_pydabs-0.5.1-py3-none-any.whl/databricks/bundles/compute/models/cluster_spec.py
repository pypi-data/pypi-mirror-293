...
from databricks.bundles.compute.models.auto_scale import AutoScale, AutoScaleParam
from databricks.bundles.compute.models.aws_attributes import (
    AwsAttributes,
    AwsAttributesParam,
)
from databricks.bundles.compute.models.azure_attributes import (
    AzureAttributes,
    AzureAttributesParam,
)
from databricks.bundles.compute.models.cluster_log_conf import (
    ClusterLogConf,
    ClusterLogConfParam,
)
from databricks.bundles.compute.models.data_security_mode import (
    DataSecurityMode,
    DataSecurityModeParam,
)
from databricks.bundles.compute.models.docker_image import DockerImage, DockerImageParam
from databricks.bundles.compute.models.gcp_attributes import (
    GcpAttributes,
    GcpAttributesParam,
)
from databricks.bundles.compute.models.init_script_info import (
    InitScriptInfo,
    InitScriptInfoParam,
)
from databricks.bundles.compute.models.runtime_engine import (
    RuntimeEngine,
    RuntimeEngineParam,
)
from databricks.bundles.compute.models.workload_type import (
    WorkloadType,
    WorkloadTypeParam,
)
...
__all__ = ["ClusterSpec", "ClusterSpecParam"]
...
class ClusterSpec:
    ...
    def create(
        ...
        *,
        num_workers: VariableOrOptional[int] = None,
        autoscale: VariableOrOptional[AutoScaleParam] = None,
        cluster_name: VariableOrOptional[str] = None,
        spark_version: VariableOrOptional[str] = None,
        spark_conf: Optional[VariableOrDict[str]] = None,
        aws_attributes: VariableOrOptional[AwsAttributesParam] = None,
        azure_attributes: VariableOrOptional[AzureAttributesParam] = None,
        gcp_attributes: VariableOrOptional[GcpAttributesParam] = None,
        node_type_id: VariableOrOptional[str] = None,
        driver_node_type_id: VariableOrOptional[str] = None,
        ssh_public_keys: Optional[VariableOrList[str]] = None,
        custom_tags: Optional[VariableOrDict[str]] = None,
        cluster_log_conf: VariableOrOptional[ClusterLogConfParam] = None,
        init_scripts: Optional[VariableOrList[InitScriptInfoParam]] = None,
        spark_env_vars: Optional[VariableOrDict[str]] = None,
        autotermination_minutes: VariableOrOptional[int] = None,
        enable_elastic_disk: VariableOrOptional[bool] = None,
        instance_pool_id: VariableOrOptional[str] = None,
        policy_id: VariableOrOptional[str] = None,
        enable_local_disk_encryption: VariableOrOptional[bool] = None,
        driver_instance_pool_id: VariableOrOptional[str] = None,
        workload_type: VariableOrOptional[WorkloadTypeParam] = None,
        runtime_engine: VariableOrOptional[RuntimeEngineParam] = None,
        docker_image: VariableOrOptional[DockerImageParam] = None,
        data_security_mode: VariableOrOptional[DataSecurityModeParam] = None,
        single_user_name: VariableOrOptional[str] = None,
        apply_policy_default_values: VariableOrOptional[bool] = None,
    ) -> "Self":
