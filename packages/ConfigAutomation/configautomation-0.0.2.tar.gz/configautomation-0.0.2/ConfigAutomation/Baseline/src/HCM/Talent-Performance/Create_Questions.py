...
def configure(playwright: Playwright, rowcount, datadict, videodir) -> dict:
    ...
    while i < rowcount:
        ...
        if datadictvalue["C_QSTN_LBRRY"] != PrevQuesFolder:
            ...
            page.get_by_text(datadictvalue["C_QSTN_LBRRY"]).first.click(force=True)
            page.wait_for_timeout(5000)

            PrevQuesFolder = datadictvalue["C_QSTN_LBRRY"]
