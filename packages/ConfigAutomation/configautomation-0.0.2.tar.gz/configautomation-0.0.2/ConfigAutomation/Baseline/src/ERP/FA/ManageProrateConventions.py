...
def configure(playwright: Playwright, rowcount, datadict, videodir) -> dict:
    ...
    while i < rowcount:
        ...
        if i == 0:
            ...
            page.get_by_placeholder("m/d/yy").nth(0).click()
            page.get_by_placeholder("m/d/yy").nth(0).fill(datadictvalue["C_END_DATE"])
            page.get_by_placeholder("m/d/yy").nth(1).click()
            page.get_by_placeholder("m/d/yy").nth(1).fill(datadictvalue["C_PRRT_DATE"])
            ...
            # page.get_by_role("cell", name="m/d/yy Press down arrow to access Calendar Prorate Date Select Date", exact=True).get_by_placeholder("m/d/yy").fill(datadictvalue["C_PRRT_DATE"])
