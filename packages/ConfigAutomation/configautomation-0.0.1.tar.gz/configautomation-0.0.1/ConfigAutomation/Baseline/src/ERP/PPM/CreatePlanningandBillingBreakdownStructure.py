...
def configure(playwright: Playwright, rowcount, datadict, videodir) -> dict:
    ...
    while i < rowcount:
        ...
        if datadictvalue["C_NAME"] != PrevName:
            ...
            if datadictvalue["C_ALLOW_RSRC_CHNGS_TO_PRJCT_LEVEL"] == 'Yes':
                page.get_by_text("Allow resource changes at").check()
            page.wait_for_timeout(2000)

            if datadictvalue["C_ATMTCLLY_ADD_RSRCS_ON_INCRRNG_ACTL_AMNTS"] == 'Yes':
            ...
            if datadictvalue["C_EVENT_TYPE"] == 'Yes':
        ...
        # Enter Spread Curve
        page.get_by_label("Spread Curve").select_option(datadictvalue["C_SPRD_CURVE"])
        page.wait_for_timeout(2000)
