...
def configure(playwright: Playwright, rowcount, datadict, videodir) -> dict:
    ...
    while i < rowcount:
        ...
        page.wait_for_timeout(2000)
        page.get_by_label("Project Status").click()
        page.get_by_label("Project Status").fill(datadictvalue["C_PRJCT_STTS"])
        page.wait_for_timeout(2000)
        page.get_by_role("cell", name="Status Type", exact=True).click()
        page.get_by_label("Status Type").select_option(datadictvalue["C_STTS_TYPE"])
        page.wait_for_timeout(2000)
        page.get_by_role("cell", name="System Status", exact=True).click()
