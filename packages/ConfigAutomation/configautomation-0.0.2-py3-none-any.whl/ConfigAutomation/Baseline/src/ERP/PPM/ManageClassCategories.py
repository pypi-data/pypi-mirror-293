...
def configure(playwright: Playwright, rowcount, datadict, videodir) -> dict:
    ...
    while i < rowcount:
        ...
        page.get_by_placeholder("mm-dd-yyyy").nth(0).fill(datadictvalue["C_FROM_DATE"])
        ...
        # page.get_by_role("cell", name="m/d/yy Press down arrow to access Calendar From Date Select Date").get_by_placeholder("m/d/yy").fill(datadictvalue["C_CC_FROM_DATE"])
        page.get_by_placeholder("mm-dd-yyyy").nth(2).fill(datadictvalue["C_CC_FROM_DATE"])
        if datadictvalue["C_CC_TO_DATE"] != '':
            ...
            page.get_by_placeholder("mm-dd-yyyy").nth(3).fill(datadictvalue["C_CC_TO_DATE"])
        #Assigned Sets
