...
def configure(playwright: Playwright, rowcount, datadict, videodir) -> dict:
    ...
    while i < rowcount:
        ...
        page.locator("//div[text()='Create Award Template']//following::input[@ placeholder='mm-dd-yyyy'][1]").fill(datadictvalue["C_AWARD_START_DATE"])
        ##-- page.get_by_role("row", name="*Start Date m/d/yy Press down arrow to access Calendar Select Date", exact=True).get_by_placeholder("m/d/yy").fill(datadictvalue["C_AWARD_START_DATE"].strftime("%m/%d/%Y"))
        # page.get_by_role("cell", name="*Start Date m/d/yy Press down arrow to access Calendar Select Date", exact=True).get_by_placeholder("m/d/yy").fill(datadictvalue["C_AWARD_START_DATE"])
        if datadictvalue["C_AWARD_END_DATE"] != '':
            ...
            page.locator("//div[text()='Create Award Template']//following::input[@ placeholder='mm-dd-yyyy'][2]").fill(datadictvalue["C_AWARD_END_DATE"])
        ...
        if datadictvalue["C_APPRVL_DATE"] != '':
            page.get_by_role("row", name="Approval Date m/d/yy Press down arrow to access Calendar Select Date", exact=True).get_by_placeholder("m/d/yy").nth(0).fill(datadictvalue["C_APPRVL_DATE"].strftime("%m/%d/%Y"))
        page.wait_for_timeout(2000)
        ...
        if datadictvalue["C_FTF_START_DATE"] != '':
            page.get_by_role("row", name="Start Date m/d/yy Press down arrow to access Calendar Select Date", exact=True).get_by_placeholder("m/d/yy").nth(0).fill(datadictvalue["C_FTF_START_DATE"].strftime("%m/%d/%Y"))
        if datadictvalue["C_FTF_END_DATE"] != '':
            page.get_by_role("row", name="End Date m/d/yy Press down arrow to access Calendar Select Date", exact=True).get_by_placeholder("m/d/yy").nth(0).fill(datadictvalue["C_FTF_END_DATE"].strftime("%m/%d/%Y"))
        page.wait_for_timeout(2000)
        ...
        if datadictvalue["C_TC_NAME"] != '':
            ...
            page.get_by_role("cell", name="m/d/yy Press down arrow to access Calendar Certification Date Select Date",exact=True).get_by_placeholder("m/d/yy").nth(0).fill(datadictvalue["C_CRTFCTNS_DATE"].strftime("%m/%d/%Y"))
            ...
            if datadictvalue["C_CRTFCTN_APPRVL_DATE"] != '':
                page.get_by_role("cell",name="m/d/yy Press down arrow to access Calendar Certification Approval Date Select Date",exact=True).get_by_placeholder("m/d/yy").nth(0).fill(datadictvalue["C_CRTFCTN_APPRVL_DATE"].strftime("%m/%d/%Y"))

            # Entering Certification Expiration Date
            if datadictvalue["C_EXPRTN_DATE"] != '':
                page.get_by_role("cell",name="m/d/yy Press down arrow to access Calendar Certification Expiration Date Select Date",exact=True).get_by_placeholder("m/d/yy").nth(0).fill(datadictvalue["C_EXPRTN_DATE"].strftime("%m/%d/%Y"))
        ...
        if datadictvalue["C_PRSN"] != '':
            ...
            # Entering Start & End Date
            page.get_by_role("cell", name="m/d/yy Press down arrow to access Calendar Start Date Select Date", exact=True).get_by_placeholder("m/d/yy").nth(0).fill(datadictvalue["C_P_START_DATE"].strftime("%m/%d/%Y"))
            if datadictvalue["C_END_DATE"] != '':
                page.get_by_role("cell", name="m/d/yy Press down arrow to access Calendar End Date Select Date",exact=True).get_by_placeholder("m/d/yy").nth(0).fill(datadictvalue["C_END_DATE"].strftime("%m/%d/%Y"))
            page.wait_for_timeout(2000)
