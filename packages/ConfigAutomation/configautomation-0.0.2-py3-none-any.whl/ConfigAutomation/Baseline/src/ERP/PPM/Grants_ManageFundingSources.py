...
def configure(playwright: Playwright, rowcount, datadict, videodir) -> dict:
    ...
    while i < rowcount:
        ...
        # Add - Funding Sources
        # page.get_by_role("row", name="Add", exact=True).locator("div a").click()
        page.get_by_role("button", name="Add").click()
        # page.get_by_role("cell", name="Add Other Internal Funding Source", exact=True).click()
        ...
        # page.get_by_role("row", name="*From Date m/d/yy Press down arrow to access Calendar Select Date",exact=True).get_by_placeholder("m/d/yy").fill(datadictvalue["C_FROM_DATE"].strftime("%m/%d/%Y"))
