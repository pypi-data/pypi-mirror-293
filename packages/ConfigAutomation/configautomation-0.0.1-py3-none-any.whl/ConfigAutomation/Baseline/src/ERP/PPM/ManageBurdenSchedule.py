...
def configure(playwright: Playwright, rowcount, datadict, videodir) -> dict:
    ...
    while i < rowcount:
        ...
        page.get_by_role("cell", name=datadictvalue["C_DFLT_BRDN_STRCTR"]).nth(1).click()
        ...
        page.get_by_placeholder("mm-dd-yyyy").nth(2).fill(datadictvalue["C_BRDN_FROM_DATE"])
        if datadictvalue["C_BRDN_TO_DATE"] != '':
            ...
            page.get_by_placeholder("mm-dd-yyyy").nth(3).fill(datadictvalue["C_BRDN_TO_DATE"])
