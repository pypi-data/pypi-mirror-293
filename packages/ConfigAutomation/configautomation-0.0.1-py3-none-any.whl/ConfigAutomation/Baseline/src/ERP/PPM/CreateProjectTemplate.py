...
def configure(playwright: Playwright, rowcount, datadict, videodir) -> dict:
    ...
    ###-------------------------------------###
            ...
            page.get_by_placeholder("m/d/yy").nth(0).fill(datadictvalue["C_FROM_DATE"])
    ...
    ###-------------------------------------###
            ...
            if page.get_by_role("cell", name="m/d/yy Press down arrow to access Calendar Planned Start Date Select Date",exact=True).get_by_placeholder("m/d/yy").is_visible():
                if datadictvalue["C_PLNND_START_DATE"] != '':
                    page.get_by_role("cell", name="m/d/yy Press down arrow to access Calendar Planned Start Date Select Date",exact=True).get_by_placeholder("m/d/yy").fill(datadictvalue["C_PLNND_START_DATE"])
            page.wait_for_timeout(2000)
            ...
            if datadictvalue["C_FNSH_DATE"] != '':
                ...
                page.get_by_placeholder("m/d/yy").nth(1).fill(datadictvalue["C_FNSH_DATE"])
            if page.get_by_role("cell", name="m/d/yy Press down arrow to access Calendar Planned Finish Date Select Date", exact=True).get_by_placeholder("m/d/yy").is_visible():
                if datadictvalue["C_PLNND_FNSH_DATE"] != '':
                    page.get_by_role("cell", name="m/d/yy Press down arrow to access Calendar Planned Finish Date Select Date", exact=True).get_by_placeholder("m/d/yy").fill(datadictvalue["C_PLNND_FNSH_DATE"])
                    page.wait_for_timeout(2000)
