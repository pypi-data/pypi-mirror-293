...
def fuzz(url, wordlist, method='GET', headers=None, params=None, data=None, json_data=None, regex=None, ssl_verify=True):
    with open(wordlist, 'r') as wl:
        words = wl.read().splitlines()

    results = []

    for word in tqdm(words, desc="Fuzzing Progress"):
...
if __name__ == "__main__":
    ...
    results = fuzz(args.url, args.wordlist, method=args.method, headers=headers, params=params, data=args.data, json_data=json_data, regex=args.regex, ssl_verify=args.ssl_verify)
