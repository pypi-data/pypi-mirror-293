...
class TestFiAnalytics(unittest.TestCase):
    def setUp(self):
        ...
        self.cny_treas_zero_1m = create_std_zero_cpn_bond_template('cny_treas_zero_1m', ('1m'), self.currency,
                                                                   self.cal)
        self.cny_treas_cpn_a_3m = create_std_fixed_cpn_bond_template('cny_treas_cpn_a_3m', ('3m'),
                                                                     self.currency, self.cal)
        self.cny_treas_cpn_a_6m = create_std_fixed_cpn_bond_template('cny_treas_cpn_a_6m', ('6m'),
                                                                     self.currency, self.cal)
        self.cny_treas_cpn_a_9m = create_std_fixed_cpn_bond_template('cny_treas_cpn_a_9m', ('9m'),
                                                                     self.currency, self.cal)
        self.cny_treas_cpn_a_1y = create_std_fixed_cpn_bond_template('cny_treas_cpn_a_1y', ('1y'),
                                                                     self.currency, self.cal)
        self.cny_treas_cpn_a_2y = create_std_fixed_cpn_bond_template('cny_treas_cpn_a_2y', ('2Y'),
                                                                     self.currency, self.cal)
        self.cny_treas_cpn_a_3y = create_std_fixed_cpn_bond_template('cny_treas_cpn_a_3y', ('3Y'),
                                                                     self.currency, self.cal)
        self.cny_treas_cpn_a_5y = create_std_fixed_cpn_bond_template('cny_treas_cpn_a_5y', ('5Y'),
                                                                     self.currency, self.cal)
        self.cny_treas_cpn_sa_7y = create_std_fixed_cpn_bond_template('cny_treas_cpn_sa_7y', ('7Y'),
                                                                      self.currency, self.cal)
        self.cny_treas_cpn_sa_10y = create_std_fixed_cpn_bond_template('cny_treas_cpn_sa_10y', ('10Y'),
                                                                       self.currency, self.cal)
        self.cny_treas_cpn_sa_15y = create_std_fixed_cpn_bond_template('cny_treas_cpn_sa_15y', ('15Y'),
                                                                       self.currency, self.cal)
        self.cny_treas_cpn_sa_20y = create_std_fixed_cpn_bond_template('cny_treas_cpn_sa_20y', ('20Y'),
                                                                       self.currency, self.cal)
        self.cny_treas_cpn_sa_30y = create_std_fixed_cpn_bond_template('cny_treas_cpn_sa_30y', ('30Y'),
                                                                       self.currency, self.cal)

        self.cny_mtn_aaa_cpn_a_1m = create_std_fixed_cpn_bond_template('cny_mtn_aaa_cpn_a_1m', ('1M'),
                                                                       self.currency, self.cal)
        self.cny_mtn_aaa_cpn_a_3m = create_std_fixed_cpn_bond_template('cny_mtn_aaa_cpn_a_3m', ('3M'),
                                                                       self.currency, self.cal)
        self.cny_mtn_aaa_cpn_a_6m = create_std_fixed_cpn_bond_template('cny_mtn_aaa_cpn_a_6m', ('6M'),
                                                                       self.currency, self.cal)
        self.cny_mtn_aaa_cpn_a_9m = create_std_fixed_cpn_bond_template('cny_mtn_aaa_cpn_a_9m', ('9M'),
                                                                       self.currency, self.cal)
        self.cny_mtn_aaa_cpn_a_1y = create_std_fixed_cpn_bond_template('cny_mtn_aaa_cpn_a_1y', ('1Y'),
                                                                       self.currency, self.cal)
        self.cny_mtn_aaa_cpn_a_2y = create_std_fixed_cpn_bond_template('cny_mtn_aaa_cpn_a_2y', ('2Y'),
                                                                       self.currency, self.cal)
        self.cny_mtn_aaa_cpn_a_3y = create_std_fixed_cpn_bond_template('cny_mtn_aaa_cpn_a_3y', ('3Y'),
                                                                       self.currency, self.cal)
        self.cny_mtn_aaa_cpn_a_4y = create_std_fixed_cpn_bond_template('cny_mtn_aaa_cpn_a_4y', ('4Y'),
                                                                       self.currency, self.cal)
        self.cny_mtn_aaa_cpn_a_5y = create_std_fixed_cpn_bond_template('cny_mtn_aaa_cpn_a_5y', ('5Y'),
                                                                       self.currency, self.cal)
        self.cny_mtn_aaa_cpn_a_7y = create_std_fixed_cpn_bond_template('cny_mtn_aaa_cpn_a_7y', ('7Y'),
                                                                       self.currency, self.cal)
        self.cny_mtn_aaa_cpn_a_8y = create_std_fixed_cpn_bond_template('cny_mtn_aaa_cpn_a_8y', ('8Y'),
                                                                       self.currency, self.cal)
        self.cny_mtn_aaa_cpn_a_9y = create_std_fixed_cpn_bond_template('cny_mtn_aaa_cpn_a_9y', ('9Y'),
                                                                       self.currency, self.cal)
