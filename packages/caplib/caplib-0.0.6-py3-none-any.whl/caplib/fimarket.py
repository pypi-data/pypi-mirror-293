...
def create_std_bond_template(inst_name, bond_type, settlement_days, maturity,
                             currency,                               
                             day_count,
                             calendar, frequency, interest_day_convention, stub_policy, broken_period_type,
                             pay_day_offset, pay_day_convention,
    ...
    '''    
    return create_vanilla_bond_template(inst_name, bond_type, create_date(None), settlement_days, create_date(None), maturity,
                                        0.0, currency, 100.0,                                 
                                        day_count,
                                        calendar, frequency, interest_day_convention, stub_policy, broken_period_type,
                                        pay_day_offset, pay_day_convention,
...
def create_std_zero_cpn_bond_template(inst_name, maturity, currency, calendar, 
                                      settlement_days = 1, 
    ...
    return create_std_bond_template(inst_name, 'ZERO_COUPON_BOND', settlement_days, maturity,
                                    currency,                          
                                    day_count,
...
def create_std_fixed_cpn_bond_template(inst_name, maturity,
                                       currency, calendar, 
                                       settlement_days = 1, 
                                       day_count = 'ACT_365_FIXED',
                                       frequency = 'ANNUAL', 
    ...
    '''    
    return create_std_bond_template(inst_name, 'FIXED_COUPON_BOND', settlement_days, maturity,
                                    currency,                       
                                    day_count,
                                    calendar, frequency, interest_day_convention, stub_policy, broken_period_type,
                                    pay_day_offset, pay_day_convention,
