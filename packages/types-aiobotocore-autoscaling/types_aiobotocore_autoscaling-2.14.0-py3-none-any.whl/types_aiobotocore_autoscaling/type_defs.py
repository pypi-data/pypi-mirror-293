...
LaunchTemplateExtraOutputTypeDef = TypedDict(
    "LaunchTemplateExtraOutputTypeDef",
    {
        "LaunchTemplateSpecification": NotRequired[LaunchTemplateSpecificationTypeDef],
...
PredictiveScalingCustomizedCapacityMetricExtraOutputTypeDef = TypedDict(
    "PredictiveScalingCustomizedCapacityMetricExtraOutputTypeDef",
    {
        "MetricDataQueries": List[MetricDataQueryExtraOutputTypeDef],
    },
)
PredictiveScalingCustomizedLoadMetricExtraOutputTypeDef = TypedDict(
    "PredictiveScalingCustomizedLoadMetricExtraOutputTypeDef",
    {
        "MetricDataQueries": List[MetricDataQueryExtraOutputTypeDef],
    },
)
PredictiveScalingCustomizedScalingMetricExtraOutputTypeDef = TypedDict(
    "PredictiveScalingCustomizedScalingMetricExtraOutputTypeDef",
    {
        "MetricDataQueries": List[MetricDataQueryExtraOutputTypeDef],
    },
...
MixedInstancesPolicyExtraOutputTypeDef = TypedDict(
    "MixedInstancesPolicyExtraOutputTypeDef",
    {
        "LaunchTemplate": NotRequired[LaunchTemplateExtraOutputTypeDef],
...
PredictiveScalingMetricSpecificationExtraOutputTypeDef = TypedDict(
    "PredictiveScalingMetricSpecificationExtraOutputTypeDef",
    {
        "TargetValue": float,
...
MixedInstancesPolicyUnionTypeDef = Union[
    MixedInstancesPolicyTypeDef, MixedInstancesPolicyExtraOutputTypeDef
]
...
PredictiveScalingConfigurationExtraOutputTypeDef = TypedDict(
    "PredictiveScalingConfigurationExtraOutputTypeDef",
    {
...
TargetTrackingConfigurationUnionTypeDef = Union[
    TargetTrackingConfigurationTypeDef, TargetTrackingConfigurationExtraOutputTypeDef
]
...
PredictiveScalingConfigurationUnionTypeDef = Union[
    PredictiveScalingConfigurationTypeDef, PredictiveScalingConfigurationExtraOutputTypeDef
]
