...
class DockerContainerDto(BaseModel):
    ...
    porject: Optional[ProjectDto] = Field(None, alias='project')
    ...
    business_status: ContainerBussinessStatusEnumDto = Field(ContainerBussinessStatusEnumDto.UNKNOWN, alias='status')
    frontend_status: Optional[FrontendStatusDto] = Field(None, alias='frontendStatus')

    pending_action: Optional[ContainerPendingActionEnumDto] = Field(None, alias='pendingAction')
