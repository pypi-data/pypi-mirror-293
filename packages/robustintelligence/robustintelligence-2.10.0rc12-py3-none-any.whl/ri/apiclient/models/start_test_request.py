...
class StartTestRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["agentId", "awsIntegrationId", "body", "endpointPayloadTemplate", "filters", "httpAuthIntegrationId", "httpHeaders", "modelId", "mutualTlsIntegrationId", "name", "responseJsonPath", "systemPrompt", "url", "workspaceId"]
