...
@storage_api_router.post("/storage")
...
@storage_api_router.get("/storage/{filepath:path}")
...
@storage_api_router.delete("/storage/{filepath:path}")
...
@storage_api_router.get("/storage/{filepath:path}/exists")
