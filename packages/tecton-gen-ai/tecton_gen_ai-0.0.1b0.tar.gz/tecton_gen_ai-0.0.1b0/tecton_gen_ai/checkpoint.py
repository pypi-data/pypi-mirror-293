...
from .core_utils import get_cache_base_path

_CHECKPOINT_ATTR = "__tecton_checkpoint__"
...
def make_deterministic(obj: Any, key_obj: Any) -> Any:
    ...
    if isinstance(obj, pd.DataFrame):
        setattr(obj, _CHECKPOINT_ATTR, _to_uuid(key_obj))
        return obj
...
def _to_uuid(obj: Any) -> str:
    def _to_serializable(obj):
        ...
        elif hasattr(obj, _CHECKPOINT_ATTR):
            return getattr(obj, _CHECKPOINT_ATTR)
