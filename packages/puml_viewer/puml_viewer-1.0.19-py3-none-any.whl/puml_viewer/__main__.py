...
def get_png_files():
    # Get and sort the list of .png files
    png_files = sorted(f for f in os.listdir(MONITOR_DIR) if f.endswith('.png'))

    # Now you can use the sorted list of png_files
    return [f for f in png_files]
