from apogee_connect_rpi.Helpers.Calculators import *
...
class ApogeeSensor():
    ...
    def compatibleFirmware(self, hw: int, fw: int):
...
class S2_112(ApogeeSensor):
    ...
    def calculate_live_data(self, data):
        ...
        ndvi = ndvi_calculator(live_data[0], live_data[1])
...
class Four_Channel(ApogeeSensor):
    def __init__(self, address: str):
        super().__init__(address)
        self.sensorID = 25
...
class Dual_Channel(ApogeeSensor):
    def __init__(self, address: str):
        super().__init__(address)
        self.sensorID = 26
...
# Helper Function
def get_sensor_class_from_ID(sensorID, address):
        match sensorID:
            case 1:
            ...
            case 25:
                return Four_Channel(address)
            case 26:
                return Dual_Channel(address)
            case 27:
