    ...
    **kwargs,
    ...
    for ini_hour, end_hour in intervals:
        ...
        for measurement in measurements:
            file_set = set() #file_set no puede acumular ficheros de diferentes sesiones
            file_set = measurement.get_filepaths(within_period=target_period)
            #TODO: get initial hour from first file in file_set
            #TODO: Create measurement_id with initial hour
            if len(file_set) == 0:
                continue
            else:
