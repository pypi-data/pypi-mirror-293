...
class Image(SQLModel, table=True):
  ...
  url: str
  descaled_url: str
  uploadId: int = Field(default=None, foreign_key='upload.id')
...
class PGN(FrontendPGN, table=True):
  uploadId: int = Field(default=None, primary_key=True, foreign_key='upload.id')
...
GameStatus = Literal['uploaded', 'doing', 'done']
