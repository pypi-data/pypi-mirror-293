...
class MassMemoryCls:
	...
	def get_current_directory(self) -> str:
		...
		is specified with them. \n
			:return: directory: String containing the path to another directory. The path can be relative or absolute. To change to a higher directory, use two dots '..' .
		"""
	...
	def set_current_directory(self, directory: str) -> None:
		...
		Changes the default directory for mass memory storage. The directory is used for all subsequent MMEM commands if no path
		is specified with them. \n
			:param directory: String containing the path to another directory. The path can be relative or absolute. To change to a higher directory, use two dots '..' .
		"""
	...
	def delete(self, filename: str) -> None:
		...
		Removes a file from the specified directory. \n
			:param filename: String parameter to specify the name and directory of the file to be removed.
		"""
	...
	def make_directory(self, directory: str) -> None:
		...
		is created in the default directory. This command can also be used to create a directory tree. \n
			:param directory: String parameter to specify the new directory.
		"""
		param = Conversions.value_to_quoted_str(directory)
	...
	def move(self, source_file: str, destination_file: str) -> None:
		...
		Moves an existing file to a new location or, if no path is specified, renames an existing file. \n
			:param source_file: String parameter to specify the name of the file to be moved.
			:param destination_file: String parameters to specify the name of the new file.
		"""
		param = ArgSingleList().compose_cmd_string(ArgSingle('source_file', source_file, DataType.String), ArgSingle('destination_file', destination_file, DataType.String))
	...
	def delete_directory(self, directory: str) -> None:
		...
		specified name is deleted in the default directory. To remove a directory with contents, use command method RsAreg800.
		MassMemory.deleteDirectoryRecursive. \n
			:param directory: String parameter to specify the directory to be deleted.
		"""
		param = Conversions.value_to_quoted_str(directory)
