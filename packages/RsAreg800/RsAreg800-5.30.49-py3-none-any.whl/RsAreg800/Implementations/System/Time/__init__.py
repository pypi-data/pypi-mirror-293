...
class TimeCls:
	...
	# noinspection PyTypeChecker
	def get_protocol(self) -> enums.TimeProtocolWithGptp:
		"""SCPI: SYSTem:TIME:PROTocol \n
		Snippet: value: enums.TimeProtocolWithGptp = driver.system.time.get_protocol() \n
		...
		return Conversions.str_to_scalar_enum(response, enums.TimeProtocolWithGptp)

	def set_protocol(self, time_protocol: enums.TimeProtocolWithGptp) -> None:
		"""SCPI: SYSTem:TIME:PROTocol \n
		Snippet: driver.system.time.set_protocol(time_protocol = enums.TimeProtocolWithGptp._0) \n
		Sets the date and time of the operating system. \n
			:param time_protocol:
				- NONE: Sets the date and time according to the selected timezone, see :SYSTem:TIME:ZONE:CATalog? and :SYSTem:TIME:ZONE.
				- NTP: Sets the date and time derived from the network time protocol. To select the NTP time server, use the commands :SYSTem:NTP:HOSTname and :SYSTem:NTP:STATe.
				- GPTP: Sets the date and time derived from the generic precision time protocol (gPTP) ."""
		param = Conversions.enum_scalar_to_str(time_protocol, enums.TimeProtocolWithGptp)
