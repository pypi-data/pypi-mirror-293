...
class RestartCls:
	...
	def set(self) -> None:
		...
		Snippet: driver.system.communicate.syst.network.restart.set() \n
		Restarts the network. \n
		"""
		self._core.io.write(f'SYSTem:COMMunicate:SYST:NETWork:RESTart')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: SYSTem:COMMunicate:SYST:NETWork:RESTart \n
		Snippet: driver.system.communicate.syst.network.restart.set_with_opc() \n
		Restarts the network. \n
		...
		self._core.io.write_with_opc(f'SYSTem:COMMunicate:SYST:NETWork:RESTart', opc_timeout_ms)
