...
class IdentificationCls:
	...
	def get_value(self) -> enums.IecDevId:
		...
		RsAreg800.System.language. Note: While working in an emulation mode, the R&S AREG800A specific command set is disabled,
		that is, the SCPI command method RsAreg800.System.Identification.value is discarded. \n
