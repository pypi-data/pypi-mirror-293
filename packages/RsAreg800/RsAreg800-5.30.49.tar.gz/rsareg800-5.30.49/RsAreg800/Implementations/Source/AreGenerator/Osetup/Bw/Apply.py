...
class ApplyCls:
	...
	def set(self) -> None:
		...
		Snippet: driver.source.areGenerator.osetup.bw.apply.set() \n
		Assigns and confirms the settings. \n
		"""
		self._core.io.write(f'SOURce<HwInstance>:AREGenerator:OSETup:BW:APPLy')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: [SOURce<HW>]:AREGenerator:OSETup:BW:APPLy \n
		Snippet: driver.source.areGenerator.osetup.bw.apply.set_with_opc() \n
		Assigns and confirms the settings. \n
		...
		self._core.io.write_with_opc(f'SOURce<HwInstance>:AREGenerator:OSETup:BW:APPLy', opc_timeout_ms)
