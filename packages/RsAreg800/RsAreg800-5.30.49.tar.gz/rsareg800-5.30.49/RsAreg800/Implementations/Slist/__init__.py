...
class SlistCls:
	...
	def get_list_py(self) -> List[str]:
		...
		Returns a list of all detected sensors in a comma-separated string. \n
			:return: sensor_list: Each entry contains information on the sensor type, serial number and interface. The order of the entries does not correspond to the order the sensors are displayed in the NRP Sensor Mapping dialog.
		"""
