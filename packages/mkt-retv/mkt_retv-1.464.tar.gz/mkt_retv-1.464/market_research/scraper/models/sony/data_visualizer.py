...
class DataVisualizer(BaseVisualizer):
    def __init__(self, data_frame=None, output_folder_path="results", style="whitegrid"):
        ...
        self.dc = DataCleaner(data_frame)
    ...
    def generate_heatmap(self, display_types:str=None, save_plot_name=None, title="SONY Spec", cmap="Blues", figsize=(8, 8),
                     cbar=False,
