...
class ArtConverter:
    def __init__(self, input_filename = 'C:/Users/dania/Downloads/Ela Taubert - ¿Cómo Pasó_ (Official Video).mp4', output_filename = 'tmp_pixelart.png', pixel_size = 7, color_lvl = 8):
        pg.init()
...
def to_pixelart(input_filename, output_filename):
    app = ArtConverter(input_filename, output_filename)
    app.run()
