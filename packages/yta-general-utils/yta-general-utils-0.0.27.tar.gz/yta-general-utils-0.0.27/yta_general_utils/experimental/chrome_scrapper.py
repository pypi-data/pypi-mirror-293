...
class ChromeScrapper:
    gui = True
    ad_blocker = True
    disable_popup_and_cookies = True
    additional_options = []
    max_page_load_waiting_time = 10

    def __init__(self, gui: bool = False, ad_blocker: bool = True, disable_popup_and_cookies: bool = True, additional_options = [], max_page_load_waiting_time: float = 10):
        # TODO: Make more customizable accepting ad_blocker extension name
        # and stuff like that
        self.gui = gui
        self.ad_blocker = ad_blocker
        self.disable_popup_and_cookies = disable_popup_and_cookies
    ...
    def __init_driver(self):
        ...
        """
        if not self.driver:
            self.driver = webdriver.Chrome(options = self.__init_options())
    ...
    def find_element_by_text(self, element_type: str, text: str):
        """
        ...
        """
        elements = self.find_elements_by_text(element_type, text)
    ...
    def find_elements_by_text(self, element_type: str, text: str):
        """
        This method uses the 'By.XPATH' finding elements method
        with the '//element_type[contains(text(), 'text')]' 
        structure to find the element, useful for buttons that 
    ...
    def find_element_by_class(self, element_type: str, class_str: str):
        """
        This method uses the 'By.XPATH' finding elements method
        ...
        existing or None if not found.
        """
        elements = self.find_elements_by_class(element_type, class_str)
    ...
    def find_elements_by_class(self, element_type: str, class_str: str):
        """
        This method uses the 'By.XPATH' finding elements method
        with the '//element_type[contains(@class, 'class_str')]' 
        structure to find the element, useful for divs with a
    ...
    def find_element_by_custom_tag(self, element_type: str, custom_tag: str, custom_tag_value: str):
        """
        This method uses the 'By.XPATH' finding elements method
        ...
        existing or None if not found.
        """
        elements = self.find_elements_by_custom_tag(element_type, custom_tag, custom_tag_value)
    ...
    def find_elements_by_custom_tag(self, element_type: str, custom_tag: str, custom_tag_value: str):
        """
        This method uses the 'By.XPATH' finding elements method
        with the '//element_type[@custom-tag='custom_value')]' 
        structure to find the element, useful for divs with a
        ...
        # driver.find_elements_by_xpath('//*[@data-testid="number-input"]')
    ...
    def scroll_down(self, pixels: int):
        ...
        self.driver.execute_script('window.scrollTo(0, ' + pixels + ')')
