...
class ChromeScrapper:
    ...
    def find_element_by_id_waiting(self, id: str):
        """
        ...
        return self.__find_element_by_waiting(By.ID, id)
    ...
    def find_element_by_text_waiting(self, element_type: str, text: str):
        """
        Waits until the WebElement corresponding to the provided 
    ...
    def find_element_by_element_type(self, element_type: str):
        # TODO: Document
        elements = self.find_elements_by_element_type(element_type)
    ...
    def find_elements_by_element_type(self, element_type: str):
        # TODO: Document
        if not element_type:
            raise Exception('No "element_type" provided.')
