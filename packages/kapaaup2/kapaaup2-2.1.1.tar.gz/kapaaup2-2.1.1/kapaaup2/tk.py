...
# 设置远程服务器地址为 ('127.0.0.1', 2003)
remote_server_address = ('192.168.2.12', 2003)
#remote_server_address = ('127.0.0.1', 2003)
...
def open_new_window():
    ...
    sort_button.config(command=lambda: send_command_to_server("an_plc_fafang"))
