...
class SGFinetuneParams(BaseModel):
    ...
    job_name: str = Field("", title="ScaleGen job name")
...
class LLMTrainingParams(SGFinetuneParams):
    ...
    resume_from_checkpoint: Optional[str] | None = Field(None, title="Checkpoint dir")
    ...
    use_deepspeed: Optional[str] = Field("stage_2", title="stage_2, stage_3, or None")
    ...
    # dpo
    model_ref: str | None = Field(None, title="Reference, for DPO trainer")
