    ...
    while True:
        ...
        if method.lower() == "w":
            ...
            if upload_choice.lower() == "y":
                ...
                remote_file_path = f'/{filename}'  # Устанавливаем путь для сохранения в корневом каталоге
                data = input("Введите текст. Для окончания ввода нажмите Ctrl + D или Ctrl + Z на Windows (на новой строке после Enter и затем опять Enter)")
                ftp.storbinary(f'STOR {remote_file_path}', data)
