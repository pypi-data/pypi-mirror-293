import re
from alphabets import extract_alphabets as get_alphabet_info
from verb_to_be import verb_to_be_info as verb_to_be_info
# print("breakers:",verb_to_be_info.breakers())
import locale
from verbs import verb_info as verb
from nouns import noun_info as noun_info
from code_decode import code_decode_info as code_decode
from adjectives import adjective_info as adjective
from data_process import data_management_info
locale.setlocale(locale.LC_COLLATE, 'ti_ER.UTF-8')
# print("get_alphabet_info.alphabets_info['tigrina_with_crosponding_english_aphabets']:",get_alphabet_info.alphabets_info['tigrina_with_crosponding_english_aphabets'],)
alphabet_info = {
...
class TigrinaInfo:
    @staticmethod
    def code_translation(text, action, details_on_decoding):
        try:
    ...
    class verb:
        ...
        @staticmethod
        def create_verb_from_stem(text, situation, person, third_person, negativitiesOrFrontAdditions, usingLeyLetter):
            try:
    ...
    class adjective:
        @staticmethod
        def make_adjective_from_stem(text, degree, toWhome, negativity, in_comparison_to, additions):
            try:
