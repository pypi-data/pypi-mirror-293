...
setup(
    ...
    python_requires=">=3.9, <3.13", # The version cannot be increased until the problem with scikit-learn is not fixed
    ...
    install_requires=["biopython>=1.83", "cython>=3.0.5", "filetype>=1.2.0", "gensim>=4.3.0", "gdown>=5.2.0", "mypy>=1.10.0", "numpy>=1.26.0, <2.0", "pandas>=2.2.0", "pip>=24.0", "psutil>=6.0.0", "scikit-learn>=1.5.0", "scipy<1.13", "smart-open>=7.0.1", "setuptools>=70.0.0", "tqdm>=4.66.0", "wheel>=0.43.0"], # specify minimum version
