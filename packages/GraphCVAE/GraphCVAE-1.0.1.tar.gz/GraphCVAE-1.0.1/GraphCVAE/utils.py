...
def mclust_R(adata, num_cluster, modelNames='EEE', used_obsm='emb_pca', random_seed=2020):
    ...
    try:
        ...
        print("Error: Mclust did not return expected results. Please check your inputs and parameters.")
    return adata
def clustering(adata, n_clusters=7, radius=50, key='emb', method='mclust', start=0.1, end=3.0, increment=0.01, refinement=False,n_components=30):
    """\
