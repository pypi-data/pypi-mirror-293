...
class MediaInsightsCompute12(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class MediaInsightsCompute13(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class MediaInsightsCompute7(
    RootModel[
        Union[
            ...
            MediaInsightsCompute12,
            MediaInsightsCompute13,
        ]
    ]
):
    root: Union[
...
class MediaInsightsComputeOrUnknown(RootModel[Optional[MediaInsightsCompute7]]):
    root: Optional[MediaInsightsCompute7]
