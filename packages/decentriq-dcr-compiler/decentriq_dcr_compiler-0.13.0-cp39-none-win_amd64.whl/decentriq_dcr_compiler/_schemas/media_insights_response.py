...
class MediaInsightsCompute19(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class MediaInsightsCompute20(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class MediaInsightsCompute14(
    RootModel[
        Union[
            ...
            MediaInsightsCompute19,
            MediaInsightsCompute20,
        ]
    ]
):
    root: Union[
...
class MediaInsightsComputeOrUnknown(RootModel[Optional[MediaInsightsCompute14]]):
    root: Optional[MediaInsightsCompute14]
