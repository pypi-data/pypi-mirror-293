...
def get_argument_from_kwargs(argument_name, kwargs, type_: Type, default="", is_required=False):
    """Get argument from kwargs with a type check, default value, and required condition."""
