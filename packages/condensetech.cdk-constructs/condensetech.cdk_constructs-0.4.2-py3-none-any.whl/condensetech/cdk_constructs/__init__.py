...
class EntrypointFromAttributes:
    def __init__(
        ...
        *,
        ...
        priority_allocator_service_token: builtins.str,
        ...
        :param priority_allocator_service_token: 
    ...
    @builtins.property
    def priority_allocator_service_token(self) -> builtins.str:
        '''
        :stability: experimental
        '''
        result = self._values.get("priority_allocator_service_token")
        assert result is not None, "Required property 'priority_allocator_service_token' is missing"
        return typing.cast(builtins.str, result)
