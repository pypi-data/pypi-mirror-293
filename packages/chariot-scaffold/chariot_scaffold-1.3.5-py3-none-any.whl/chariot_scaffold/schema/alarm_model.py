...
class AlarmModel(BaseModel):
    uid: Annotated[str, "告警唯一id"] = str(uuid.uuid4())
    ...
    # todo 这里的时间不会因为重新实例化而生成新的值
    created_at: Annotated[str, "告警发生的时间"] = timestamp_to_utc_format_date_string()
    updated_at: Annotated[str, "告警入库的时间"] = timestamp_to_utc_format_date_string()
