...
** [[elisp:(org-cycle)][| *CmndDesc:* | ]]  Basic example command.
        ...
        cmnd('desktopBackgroundColor', args='get', comment=" # As list of strings")
        cmnd('desktopBackgroundColor', args='\'#77767B\'', comment=" # As list of strings")
...
gsettings set org.gnome.desktop.background primary-color 'rgb(255, 255, 255)'
        ...
        self.captureRunStr(""" #+begin_org
#+begin_src sh :results output :session shared
  gnomeCustomize.cs -i desktopBackgroundColor get
#+end_src
#+RESULTS:
: #77767B
#+begin_src sh :results output :session shared
  gnomeCustomize.cs -i desktopBackgroundColor 'blue'
#+end_src
#+RESULTS:
: blue
        #+end_org """)
        ...
        if backgroundColor == "get":
            ...
            gschema.set_value('primary-color', GLib.Variant('s', backgroundColor))
