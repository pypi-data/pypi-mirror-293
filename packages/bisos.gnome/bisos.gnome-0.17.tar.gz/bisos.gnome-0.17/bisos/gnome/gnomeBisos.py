...
#+end_org """
    ...
    if bcb == "commonBcb":
        results = gnomeApi.desktopBackgroundColor().pyCmnd(
            argsList=['get'],
        ).results
        print(f"desktopBackgroundColor -- get (Pre)-- results={results}")

        results = gnomeApi.desktopBackgroundColor().pyCmnd(
            argsList=['#77767B'],
        ).results
        print(f"desktopBackgroundColor -- set -- results={results}")
...
#+end_src
#+RESULTS:
: desktopBackgroundColor -- get (Pre)-- results=#77767B
: desktopBackgroundColor -- set -- results=#77767B
: []
        #+end_org """)
