...
class ApplicationApi(BaseApi):
    ...
    def create(
        ...
        **kwargs
        ...
        Args:
            ...
            tools (Sequence[ToolDef]): The tools connected to the application.
        ...
        payload = {
            ...
            "model": llm_model.dict() if llm_model else None,
            "prompt": prompt,
    ...
    def put(
        ...
        **kwargs
        ...
        """
        if not any([name, tools, llm_model, prompt, show_cites]):
