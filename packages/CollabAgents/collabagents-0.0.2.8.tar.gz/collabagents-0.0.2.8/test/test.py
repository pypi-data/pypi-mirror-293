...
model = OpenaiChatModel(model_name="gpt-4o-mini",api_key=openai_api_key,verbose=False)
...
agent = StructuredAgent(model,"AI Assistant",description,instruction,tools,max_allowed_attempts=5,memory=memory)
