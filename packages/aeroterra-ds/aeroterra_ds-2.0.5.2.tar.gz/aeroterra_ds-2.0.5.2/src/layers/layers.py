...
from .common import ordinal, get_fields_aux, set_display_field_aux, add_field_aux, delete_field_aux, field_present_layer, get_objectid_field_aux
...
def rename_fields_aux(layer: FeatureLayer,
    ...
    for old_name, new_name in change_names.items():
        ...
        alias.append(new_name)
    add_field_aux(layer, new_names, data_types, alias)
