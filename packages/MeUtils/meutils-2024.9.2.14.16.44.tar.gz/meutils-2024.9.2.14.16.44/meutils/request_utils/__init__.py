...
async def create_request(url, request, token, headers: Optional[dict] = None, post_params: Optional[dict] = None):
    ...
    async with httpx.AsyncClient(headers=headers, timeout=60) as client:
        response = await client.post(url=url, json=payload, **(post_params or {}))
