...
def plot_lift(
    ...
    # Set x-axis ticks and labels
    ax.xaxis.set_major_locator(mpl.ticker.MultipleLocator( round(ax.get_xlim()[1] / 10, 2) ))
    ax.xaxis.set_major_formatter(mpl.ticker.FormatStrFormatter('%.1f'))
    ax.yaxis.set_major_locator(mpl.ticker.MultipleLocator( round(ax.get_ylim()[1] / 10, 2) ))
    ax.yaxis.set_major_formatter(mpl.ticker.FormatStrFormatter('%.1f'))
