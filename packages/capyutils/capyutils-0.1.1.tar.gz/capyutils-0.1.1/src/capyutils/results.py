...
class Result(_t.Generic[T]):
    ...
    def __init__(self, value: _t.Union[T, BaseException]):
        self._value = value
    ...
    def try_unwrap(self) -> _t.Union[T, None]:
        """
        Returns the wrapped value if this `Result` is `Ok`, else, if this
    ...
    @staticmethod
    def Err(error: _t.Union[BaseException, str]) -> "Result[T]":
        """
