...
class FootprintsManager(object):
    def __init__(self, config_data, backend_proxy, agent_events_manager):
        ...
        self.watchdog.add_job(self.send_footprints_task,
                              self.config_data.intervalSeconds)
        self.watchdog.add_job(self.send_current_partial_footprints,
                              self.config_data.intervalSeconds)
        self.watchdog.add_job(self.get_active_execution, constants.ACTIVE_EXECUTION_INTERVAL_IN_MILLISECONDS / 1000)
