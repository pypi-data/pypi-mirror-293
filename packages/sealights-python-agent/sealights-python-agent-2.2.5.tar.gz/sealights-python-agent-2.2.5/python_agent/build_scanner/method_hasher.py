...
from python_agent.packages import astor
...
class MethodHasher(object):
    ...
    def build_method(self, file_data, name, node, lines):
        ...
        method = MethodData(unique_id, name, position, end_position, meta, method_hash, sig_hash, lines)
        return method
