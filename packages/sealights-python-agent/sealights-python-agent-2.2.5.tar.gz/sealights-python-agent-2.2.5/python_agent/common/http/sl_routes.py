...
class SLRoutes(object):
    ...
    @staticmethod
    def footprints_v6(execution_build_session_id: str, test_stage: str, build_session_id: str):
        return "/v6/agents/%s/footprints/%s/%s" % (execution_build_session_id, test_stage, build_session_id)
