...
class SolversApi(object):
    ...
    def start_job(self, solver_key, version, job_id, **kwargs):  # noqa: E501
        ...
        Starts job job_id created with the solver solver_key:version  New in *version 0.4.3*: cluster_id New in *version 0.6.0*: This endpoint responds with a 202 when successfully starting a computation  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
