...
class DataExchangeClient(AioBaseClient):
    ...
    async def cancel_job(self, *, JobId: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    async def delete_data_set(self, *, DataSetId: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    async def delete_event_action(self, *, EventActionId: str) -> EmptyResponseMetadataTypeDef:
        """
