...
class Builtinex:
	...
	def IsType(obj : object) -> bool:
		if not builtins.isinstance(obj, type):
			return False
		return True
	...
	def SetAttribute(obj : object, attributeName : str, value : Any, allowCreation : bool = True) -> bool:
		realAttributeName = Builtinex.GetRealAttributeName(obj, attributeName)
	...
	def GetAttribute(obj : object, attributeName : str, defaultValue : Any = None) -> Any:
		...
		if not attributeName:
			return defaultValue
		realAttributeName : str = Builtinex.GetRealAttributeName(obj, attributeName)
		if not realAttributeName:
			return defaultValue
