...
import aioredis3.sentinel
from aioredis3 import exceptions
from aioredis3.sentinel import (
    MasterNotFoundError,
    Sentinel,
...
async def cluster(master_ip):
    ...
    saved_Redis = aioredis3.sentinel.Redis
    aioredis3.sentinel.Redis = cluster.client
    yield cluster
    aioredis3.sentinel.Redis = saved_Redis
