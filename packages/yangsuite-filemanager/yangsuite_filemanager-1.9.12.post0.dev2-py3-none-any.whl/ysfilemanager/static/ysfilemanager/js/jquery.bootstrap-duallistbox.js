  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        '   </span>' +
        '   <input class="form-control filter" type="text">' +
        '   <div class="btn-group buttons" style="margin-bottom: 2px;">' +
    ...
    setBtnClass: function(value, refresh) {
       ...
       */
      this.elements.moveButton.attr('class', 'btn btn--small move').addClass(value);
      this.elements.removeButton.attr('class', 'btn btn--small remove').addClass(value);
      this.elements.moveAllButton.attr('class', 'btn btn--small moveall').addClass(value);
      this.elements.removeAllButton.attr('class', 'btn btn--small removeall').addClass(value);
      if (refresh) {
        refreshSelects(this);
      }
      return this.element;
