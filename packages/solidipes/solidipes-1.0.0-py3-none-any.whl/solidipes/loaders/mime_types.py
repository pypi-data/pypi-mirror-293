...
_mime_types = """
application/avs-ucd                             avs
application/x-latex/tikz                        tikz
application/gnuplot                             gp gpi gih
application/libmultiscale/config                config
application/lammps/log                          log.lammps
...
for line in _mime_types.split("\n"):
    ...
    for ext in s[1:]:
        ext = ext.strip()
        if ext not in extension2mime_type:
            extension2mime_type[ext] = []
        extension2mime_type[ext].append(_type)
    for ext in extension2mime_type.keys():
        extension2mime_type[ext] = list(set(extension2mime_type[ext]))
...
def get_mime_type(path):
    ...
    if ext in extension2mime_type:
        return extension2mime_type[ext][0], ""
