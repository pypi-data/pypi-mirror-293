...
class SmpmUlDeviceEnergy16BRetrospectiveEnergyData(Packet):
    ...
    def to_integration_data(self, received_at: datetime, device_tz: tzinfo, **kwargs: Any) -> List[IntegrationV0MessageData]:
        ...
        if self.is_valid:
            ...
            # adding value_previous_1_delta with checking validity
            if self.value_previous_1_delta != 0 or any((self.value_previous_2_delta != 0, self.value_previous_3_delta != 0)):
                integration_message_data.append(
                    IntegrationV0MessageData(
                        is_valid=self.is_valid,
            ...
            # adding value_previous_2_delta with checking validity
            if self.value_previous_2_delta != 0 or self.value_previous_3_delta != 0:
                integration_message_data.append(
                    IntegrationV0MessageData(
                        is_valid=self.is_valid,
            ...
            # adding value_previous_3_delta with checking validity
            if self.value_previous_3_delta != 0:
                integration_message_data.append(
                    IntegrationV0MessageData(
                        is_valid=self.is_valid,
