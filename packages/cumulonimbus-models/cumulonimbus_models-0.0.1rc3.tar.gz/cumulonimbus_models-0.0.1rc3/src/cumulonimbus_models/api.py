import re
from typing import cast, ClassVar, Optional, Pattern, Set
...
class APIRequest(Base):
    ...
    arg_regex: ClassVar[str] = r'{[a-z][a-z_]*[a-z]}'
    arg_pattern: ClassVar[Pattern[str]] = re.compile(arg_regex)

    @classmethod
    def format_args(cls) -> Set[str]:
        arg_matches = cast(list[str], cls.arg_pattern.findall(cls.route_format))
